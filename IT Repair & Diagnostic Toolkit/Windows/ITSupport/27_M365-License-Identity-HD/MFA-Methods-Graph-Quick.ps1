...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: MFA Methods Graph Quick
.DESCRIPTION
...
.EXAMPLE
    .\MFA-Methods-Graph-Quick.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\MFA-Methods-Graph-Quick.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'MFA Methods Graph Quick'; $totalSteps = 8; $Name = 'MFA-Methods-Graph-Quick'; $Folder = '27_M365-License-Identity-HD'
...
try {
    ...
    Export-HtmlReport -Title 'MFA Methods Graph Quick' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'MFA Methods Graph Quick' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
