...
<#
.SYNOPSIS
    Common problem fix: Font Language Region Quick Repair
.DESCRIPTION
...
.EXAMPLE
    .\Font-Language-Region-Quick-Repair.ps1
.EXAMPLE
    .\Font-Language-Region-Quick-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Font Language Region Quick Repair'; $totalSteps = 8; $Name = 'Font-Language-Region-Quick-Repair'
try {
    ...
    Export-HtmlReport -Title 'Font Language Region Quick Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Font Language Region Quick Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
