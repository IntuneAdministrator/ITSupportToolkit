...
<#
.SYNOPSIS
    Common problem fix: Dock Dual Monitor Not Detected
.DESCRIPTION
...
.EXAMPLE
    .\Dock-Dual-Monitor-Not-Detected.ps1
.EXAMPLE
    .\Dock-Dual-Monitor-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Dock Dual Monitor Not Detected'; $totalSteps = 8; $Name = 'Dock-Dual-Monitor-Not-Detected'
try {
    ...
    Export-HtmlReport -Title 'Dock Dual Monitor Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Dock Dual Monitor Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
