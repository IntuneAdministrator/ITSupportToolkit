...
<#
.SYNOPSIS
    Common problem fix: RDP Credentials Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\RDP-Credentials-Not-Working-Fix
.EXAMPLE
    .\RDP-Credentials-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'RDP Credentials Not Working Fix'; $totalSteps = 8; $Name = 'RDP-Credentials-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'RDP Credentials Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'RDP Credentials Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
