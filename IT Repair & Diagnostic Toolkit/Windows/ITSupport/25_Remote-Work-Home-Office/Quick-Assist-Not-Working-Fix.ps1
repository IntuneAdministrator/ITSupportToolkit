...
<#
.SYNOPSIS
    Common problem fix: Quick Assist Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Quick-Assist-Not-Working-Fix
.EXAMPLE
    .\Quick-Assist-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Quick Assist Not Working Fix'; $totalSteps = 8; $Name = 'Quick-Assist-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Quick Assist Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Quick Assist Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
