...
<#
.SYNOPSIS
    Common problem fix: RFID Reader Not Detected
.DESCRIPTION
...
.EXAMPLE
    .\RFID-Reader-Not-Detected.ps1
.EXAMPLE
    .\RFID-Reader-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'RFID Reader Not Detected'; $totalSteps = 8; $Name = 'RFID-Reader-Not-Detected'
try {
    ...
    Export-HtmlReport -Title 'RFID Reader Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'RFID Reader Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
