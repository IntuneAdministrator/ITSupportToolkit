...
<#
.SYNOPSIS
    Common problem fix: Nuance PowerMic Not Detected
.DESCRIPTION
...
.EXAMPLE
    .\Nuance-PowerMic-Not-Detected.ps1
.EXAMPLE
    .\Nuance-PowerMic-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Nuance PowerMic Not Detected'; $totalSteps = 8; $Name = 'Nuance-PowerMic-Not-Detected'
try {
    ...
    Export-HtmlReport -Title 'Nuance PowerMic Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Nuance PowerMic Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
