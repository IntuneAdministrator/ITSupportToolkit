...
<#
.SYNOPSIS
    Common problem fix: Elgato Stream Deck Not Detected
.DESCRIPTION
...
.EXAMPLE
    .\Elgato-Stream-Deck-Not-Detected.ps1
.EXAMPLE
    .\Elgato-Stream-Deck-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Elgato Stream Deck Not Detected'; $totalSteps = 8; $Name = 'Elgato-Stream-Deck-Not-Detected'
try {
    ...
    Export-HtmlReport -Title 'Elgato Stream Deck Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Elgato Stream Deck Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
