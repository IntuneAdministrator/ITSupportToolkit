...
<#
.SYNOPSIS
    Common problem fix: Signature Pad Not Detected
.DESCRIPTION
...
.EXAMPLE
    .\Signature-Pad-Not-Detected.ps1
.EXAMPLE
    .\Signature-Pad-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Signature Pad Not Detected'; $totalSteps = 8; $Name = 'Signature-Pad-Not-Detected'
try {
    ...
    Export-HtmlReport -Title 'Signature Pad Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Signature Pad Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
