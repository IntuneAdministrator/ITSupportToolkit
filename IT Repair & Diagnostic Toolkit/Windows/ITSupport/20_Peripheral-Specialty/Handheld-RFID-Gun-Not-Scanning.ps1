...
<#
.SYNOPSIS
    Common problem fix: Handheld RFID Gun Not Scanning
.DESCRIPTION
...
.EXAMPLE
    .\Handheld-RFID-Gun-Not-Scanning.ps1
.EXAMPLE
    .\Handheld-RFID-Gun-Not-Scanning.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Handheld RFID Gun Not Scanning'; $totalSteps = 8; $Name = 'Handheld-RFID-Gun-Not-Scanning'
try {
    ...
    Export-HtmlReport -Title 'Handheld RFID Gun Not Scanning' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Handheld RFID Gun Not Scanning' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
