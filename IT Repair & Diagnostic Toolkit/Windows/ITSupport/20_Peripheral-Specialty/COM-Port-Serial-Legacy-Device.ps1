...
<#
.SYNOPSIS
    Common problem fix: COM Port Serial Legacy Device
.DESCRIPTION
...
.EXAMPLE
    .\COM-Port-Serial-Legacy-Device.ps1
.EXAMPLE
    .\COM-Port-Serial-Legacy-Device.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'COM Port Serial Legacy Device'; $totalSteps = 8; $Name = 'COM-Port-Serial-Legacy-Device'
try {
    ...
    Export-HtmlReport -Title 'COM Port Serial Legacy Device' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'COM Port Serial Legacy Device' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
