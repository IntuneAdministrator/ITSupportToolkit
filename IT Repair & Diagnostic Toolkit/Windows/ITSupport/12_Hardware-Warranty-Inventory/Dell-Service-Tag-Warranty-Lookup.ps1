...
<#
.SYNOPSIS
    Common problem fix: Dell Service Tag Warranty Lookup
.DESCRIPTION
...
.EXAMPLE
    .\Dell-Service-Tag-Warranty-Lookup.ps1
.EXAMPLE
    .\Dell-Service-Tag-Warranty-Lookup.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Dell Service Tag Warranty Lookup'; $totalSteps = 8; $Name = 'Dell-Service-Tag-Warranty-Lookup'
try {
    ...
    Export-HtmlReport -Title 'Dell Service Tag Warranty Lookup' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Dell Service Tag Warranty Lookup' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
