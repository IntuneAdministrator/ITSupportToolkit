...
<#
.SYNOPSIS
    Common problem fix: Lenovo MTM Warranty Report
.DESCRIPTION
...
.EXAMPLE
    .\Lenovo-MTM-Warranty-Report.ps1
.EXAMPLE
    .\Lenovo-MTM-Warranty-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Lenovo MTM Warranty Report'; $totalSteps = 8; $Name = 'Lenovo-MTM-Warranty-Report'
try {
    ...
    Export-HtmlReport -Title 'Lenovo MTM Warranty Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Lenovo MTM Warranty Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
