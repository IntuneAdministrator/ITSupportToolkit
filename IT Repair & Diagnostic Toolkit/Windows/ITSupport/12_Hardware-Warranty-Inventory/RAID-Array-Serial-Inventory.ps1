...
<#
.SYNOPSIS
    Common problem fix: RAID Array Serial Inventory
.DESCRIPTION
...
.EXAMPLE
    .\RAID-Array-Serial-Inventory.ps1
.EXAMPLE
    .\RAID-Array-Serial-Inventory.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'RAID Array Serial Inventory'; $totalSteps = 8; $Name = 'RAID-Array-Serial-Inventory'
try {
    ...
    Export-HtmlReport -Title 'RAID Array Serial Inventory' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'RAID Array Serial Inventory' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
