...
<#
.SYNOPSIS
    Common problem fix: Account Unlock Quick Quick Repair
.DESCRIPTION
...
.EXAMPLE
    .\Account-Unlock-Quick-Quick-Repair.ps1
.EXAMPLE
    .\Account-Unlock-Quick-Quick-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Account Unlock Quick Quick Repair'; $totalSteps = 8; $Name = 'Account-Unlock-Quick-Quick-Repair'
try {
    ...
    Export-HtmlReport -Title 'Account Unlock Quick Quick Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Account Unlock Quick Quick Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
