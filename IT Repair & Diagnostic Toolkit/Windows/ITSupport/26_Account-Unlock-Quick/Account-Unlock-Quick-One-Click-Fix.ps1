...
<#
.SYNOPSIS
    Common problem fix: Account Unlock Quick One Click Fix
.DESCRIPTION
...
.EXAMPLE
    .\Account-Unlock-Quick-One-Click-Fix.ps1
.EXAMPLE
    .\Account-Unlock-Quick-One-Click-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Account Unlock Quick One Click Fix'; $totalSteps = 8; $Name = 'Account-Unlock-Quick-One-Click-Fix'
try {
    ...
    Export-HtmlReport -Title 'Account Unlock Quick One Click Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Account Unlock Quick One Click Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
