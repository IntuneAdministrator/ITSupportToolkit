...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Teams External Chat Blocked HD
.DESCRIPTION
...
.EXAMPLE
    .\Teams-External-Chat-Blocked-HD.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Teams-External-Chat-Blocked-HD.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Teams External Chat Blocked HD'; $totalSteps = 8; $Name = 'Teams-External-Chat-Blocked-HD'; $Folder = '29_M365-Teams-OneDrive-HD'
...
try {
    ...
    Export-HtmlReport -Title 'Teams External Chat Blocked HD' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Teams External Chat Blocked HD' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
