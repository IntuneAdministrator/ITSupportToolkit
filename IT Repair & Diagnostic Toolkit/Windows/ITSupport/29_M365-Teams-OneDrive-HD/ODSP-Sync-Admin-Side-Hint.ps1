...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: ODSP Sync Admin Side Hint
.DESCRIPTION
...
.EXAMPLE
    .\ODSP-Sync-Admin-Side-Hint.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\ODSP-Sync-Admin-Side-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'ODSP Sync Admin Side Hint'; $totalSteps = 8; $Name = 'ODSP-Sync-Admin-Side-Hint'; $Folder = '29_M365-Teams-OneDrive-HD'
...
try {
    ...
    Export-HtmlReport -Title 'ODSP Sync Admin Side Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'ODSP Sync Admin Side Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
