...
<#
.SYNOPSIS
    Common problem fix: M365 Teams OneDrive HD Helpdesk Report
.DESCRIPTION
    Phase 13 common-problems module (ITSupport / 29_M365-Teams-OneDrive-HD). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\M365-Teams-OneDrive-HD-Helpdesk-Report.ps1
.EXAMPLE
    .\M365-Teams-OneDrive-HD-Helpdesk-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'M365 Teams OneDrive HD Helpdesk Report'; $totalSteps = 8; $Name = 'M365-Teams-OneDrive-HD-Helpdesk-Report'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '29_M365-Teams-OneDrive-HD' -Status 'INFO' -Detail 'ITSupport'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '29_M365-Teams-OneDrive-HD'
    ...
    Export-HtmlReport -Title 'M365 Teams OneDrive HD Helpdesk Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'M365 Teams OneDrive HD Helpdesk Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
