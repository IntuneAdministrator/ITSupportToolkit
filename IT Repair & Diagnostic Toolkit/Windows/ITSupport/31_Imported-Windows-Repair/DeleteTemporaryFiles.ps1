<#
.SYNOPSIS
    Cleans user temp files, Windows temp files, prefetch data, and recycle bin contents on Windows 24H2.

.DESCRIPTION
    This PowerShell script provides a graphical interface (WPF) for cleaning up temporary files, prefetch data, 
    and recycle bin contents from a Windows system. It allows users to free up disk space and improve performance by:
...
<Window xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'
        ...
        Title='Temp Cleaner - Windows 24H2'
