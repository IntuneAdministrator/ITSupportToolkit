...
.DESCRIPTION
    This PowerShell script retrieves the current version, build, and installation date of the Windows OS from the system. It then compares the OS version with predefined EOL dates for various Windows 10 and Windows builds. 
...
.NOTES
    ...
    Date         : July 23, 2025
    Version      : 1.0
    Tested On    : Windows 24H2 and Windows 10 22H2
    ...
    Compatibility: Windows 10 (Build 19045) and above, including Windows (Build 22621 and 25365).

    The script checks the OS version against a predefined list of EOL dates for several Windows 10 and Windows versions:
        - Windows 10 22H2 (Build 19045) – EOL: 2025-10-14
        - Windows 22H2 (Build 22621) – EOL: 2027-10-14
        - Windows 24H2 (Build 25365) – EOL: 2029-10-08
