...
<#
.SYNOPSIS
    Common problem fix: Scan To Email Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Scan-To-Email-Not-Working-Fix
.EXAMPLE
    .\Scan-To-Email-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Scan To Email Not Working Fix'; $totalSteps = 8; $Name = 'Scan-To-Email-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Scan To Email Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Scan To Email Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
