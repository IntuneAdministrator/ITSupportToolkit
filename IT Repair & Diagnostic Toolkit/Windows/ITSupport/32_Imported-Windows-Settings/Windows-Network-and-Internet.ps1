<#
.SYNOPSIS
    WPF GUI with a single button for Network & Internet settings on Windows.

.DESCRIPTION
    This script creates a simple WPF-based graphical user interface (GUI) that contains a single button. 
    When clicked, the button opens the "Network & Internet" settings page on Windows using the ms-settings URI.
