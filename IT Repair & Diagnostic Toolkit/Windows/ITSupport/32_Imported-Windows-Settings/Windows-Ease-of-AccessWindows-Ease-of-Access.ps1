<#
.SYNOPSIS
    WPF GUI with two columns of buttons for various Windows Ease of Access settings.

.DESCRIPTION
    This script creates a WPF-based graphical user interface (GUI) with two columns of buttons.
    Each button opens a specific Windows Ease of Access settings URI when clicked.
...
$window.Title = "Windows Ease of Access Settings"
