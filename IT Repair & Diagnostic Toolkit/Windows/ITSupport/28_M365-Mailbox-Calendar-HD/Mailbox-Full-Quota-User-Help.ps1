...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Mailbox Full Quota User Help
.DESCRIPTION
...
.EXAMPLE
    .\Mailbox-Full-Quota-User-Help.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Mailbox-Full-Quota-User-Help.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Mailbox Full Quota User Help'; $totalSteps = 8; $Name = 'Mailbox-Full-Quota-User-Help'; $Folder = '28_M365-Mailbox-Calendar-HD'
...
try {
    ...
    Export-HtmlReport -Title 'Mailbox Full Quota User Help' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Mailbox Full Quota User Help' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
