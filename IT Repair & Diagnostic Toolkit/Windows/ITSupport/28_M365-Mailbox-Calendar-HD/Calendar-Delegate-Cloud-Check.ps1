...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Calendar Delegate Cloud Check
.DESCRIPTION
...
.EXAMPLE
    .\Calendar-Delegate-Cloud-Check.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Calendar-Delegate-Cloud-Check.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Calendar Delegate Cloud Check'; $totalSteps = 8; $Name = 'Calendar-Delegate-Cloud-Check'; $Folder = '28_M365-Mailbox-Calendar-HD'
...
try {
    ...
    Export-HtmlReport -Title 'Calendar Delegate Cloud Check' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Calendar Delegate Cloud Check' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
