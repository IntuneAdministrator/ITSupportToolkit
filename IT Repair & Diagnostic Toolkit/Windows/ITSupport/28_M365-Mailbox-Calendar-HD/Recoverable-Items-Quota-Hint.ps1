...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Recoverable Items Quota Hint
.DESCRIPTION
...
.EXAMPLE
    .\Recoverable-Items-Quota-Hint.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Recoverable-Items-Quota-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Recoverable Items Quota Hint'; $totalSteps = 8; $Name = 'Recoverable-Items-Quota-Hint'; $Folder = '28_M365-Mailbox-Calendar-HD'
...
try {
    ...
    Export-HtmlReport -Title 'Recoverable Items Quota Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Recoverable Items Quota Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
