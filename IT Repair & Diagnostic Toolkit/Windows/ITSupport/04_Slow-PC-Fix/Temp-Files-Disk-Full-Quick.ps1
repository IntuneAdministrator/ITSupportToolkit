...
<#
.SYNOPSIS
    Common problem fix: Temp Files Disk Full Quick
.DESCRIPTION
...
.EXAMPLE
    .\Temp-Files-Disk-Full-Quick.ps1
.EXAMPLE
    .\Temp-Files-Disk-Full-Quick.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Temp Files Disk Full Quick'; $totalSteps = 8; $Name = 'Temp-Files-Disk-Full-Quick'
try {
    ...
    Export-HtmlReport -Title 'Temp Files Disk Full Quick' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Temp Files Disk Full Quick' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
