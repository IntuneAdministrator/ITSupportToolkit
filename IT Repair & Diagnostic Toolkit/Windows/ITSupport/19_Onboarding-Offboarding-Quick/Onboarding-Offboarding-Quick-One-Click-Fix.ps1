...
<#
.SYNOPSIS
    Common problem fix: Onboarding Offboarding Quick One Click Fix
.DESCRIPTION
...
.EXAMPLE
    .\Onboarding-Offboarding-Quick-One-Click-Fix.ps1
.EXAMPLE
    .\Onboarding-Offboarding-Quick-One-Click-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Onboarding Offboarding Quick One Click Fix'; $totalSteps = 8; $Name = 'Onboarding-Offboarding-Quick-One-Click-Fix'
try {
    ...
    Export-HtmlReport -Title 'Onboarding Offboarding Quick One Click Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Onboarding Offboarding Quick One Click Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
