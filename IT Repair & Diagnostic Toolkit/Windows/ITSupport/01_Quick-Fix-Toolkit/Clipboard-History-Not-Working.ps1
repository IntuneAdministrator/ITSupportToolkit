...
<#
.SYNOPSIS
    Common problem fix: Clipboard History Not Working
.DESCRIPTION
...
.EXAMPLE
    .\Clipboard-History-Not-Working.ps1
.EXAMPLE
    .\Clipboard-History-Not-Working.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Clipboard History Not Working'; $totalSteps = 8; $Name = 'Clipboard-History-Not-Working'
try {
    ...
    Export-HtmlReport -Title 'Clipboard History Not Working' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Clipboard History Not Working' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
