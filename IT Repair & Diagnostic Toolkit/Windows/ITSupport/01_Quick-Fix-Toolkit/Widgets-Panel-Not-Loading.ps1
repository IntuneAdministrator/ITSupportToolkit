...
<#
.SYNOPSIS
    Common problem fix: Widgets Panel Not Loading
.DESCRIPTION
...
.EXAMPLE
    .\Widgets-Panel-Not-Loading.ps1
.EXAMPLE
    .\Widgets-Panel-Not-Loading.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Widgets Panel Not Loading'; $totalSteps = 8; $Name = 'Widgets-Panel-Not-Loading'
try {
    ...
    Export-HtmlReport -Title 'Widgets Panel Not Loading' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Widgets Panel Not Loading' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
