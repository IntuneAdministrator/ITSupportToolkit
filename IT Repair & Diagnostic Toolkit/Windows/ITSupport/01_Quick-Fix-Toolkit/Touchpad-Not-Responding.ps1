...
<#
.SYNOPSIS
    Common problem fix: Touchpad Not Responding
.DESCRIPTION
...
.EXAMPLE
    .\Touchpad-Not-Responding.ps1
.EXAMPLE
    .\Touchpad-Not-Responding.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Touchpad Not Responding'; $totalSteps = 8; $Name = 'Touchpad-Not-Responding'
try {
    ...
    Export-HtmlReport -Title 'Touchpad Not Responding' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Touchpad Not Responding' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
