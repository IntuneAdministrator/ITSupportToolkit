...
<#
.SYNOPSIS
    Common problem fix: Night Light Not Working
.DESCRIPTION
...
.EXAMPLE
    .\Night-Light-Not-Working.ps1
.EXAMPLE
    .\Night-Light-Not-Working.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Night Light Not Working'; $totalSteps = 8; $Name = 'Night-Light-Not-Working'
try {
    ...
    Export-HtmlReport -Title 'Night Light Not Working' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Night Light Not Working' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
