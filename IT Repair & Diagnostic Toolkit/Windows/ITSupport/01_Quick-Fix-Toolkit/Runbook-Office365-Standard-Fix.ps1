...
<#
.SYNOPSIS
    Common problem fix: Runbook Office365 Standard Fix
.DESCRIPTION
...
.EXAMPLE
    .\Runbook-Office365-Standard-Fix.ps1
.EXAMPLE
    .\Runbook-Office365-Standard-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Runbook Office365 Standard Fix'; $totalSteps = 8; $Name = 'Runbook-Office365-Standard-Fix'
try {
    ...
    Export-HtmlReport -Title 'Runbook Office365 Standard Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Runbook Office365 Standard Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
