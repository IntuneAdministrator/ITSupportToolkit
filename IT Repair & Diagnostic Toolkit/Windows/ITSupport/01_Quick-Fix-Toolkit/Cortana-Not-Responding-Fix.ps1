...
<#
.SYNOPSIS
    Common problem fix: Cortana Not Responding Fix
.DESCRIPTION
...
.EXAMPLE
    .\Cortana-Not-Responding-Fix
.EXAMPLE
    .\Cortana-Not-Responding-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Cortana Not Responding Fix'; $totalSteps = 8; $Name = 'Cortana-Not-Responding-Fix'
try {
    ...
    Export-HtmlReport -Title 'Cortana Not Responding Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Cortana Not Responding Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
