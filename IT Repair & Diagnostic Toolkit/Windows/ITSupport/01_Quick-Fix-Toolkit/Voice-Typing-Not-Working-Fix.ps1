...
<#
.SYNOPSIS
    Common problem fix: Voice Typing Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Voice-Typing-Not-Working-Fix
.EXAMPLE
    .\Voice-Typing-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Voice Typing Not Working Fix'; $totalSteps = 8; $Name = 'Voice-Typing-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Voice Typing Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Voice Typing Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
