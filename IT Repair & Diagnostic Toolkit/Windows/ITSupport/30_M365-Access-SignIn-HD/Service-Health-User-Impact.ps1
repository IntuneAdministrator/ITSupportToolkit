...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Service Health User Impact
.DESCRIPTION
...
.EXAMPLE
    .\Service-Health-User-Impact.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Service-Health-User-Impact.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Service Health User Impact'; $totalSteps = 8; $Name = 'Service-Health-User-Impact'; $Folder = '30_M365-Access-SignIn-HD'
...
try {
    ...
    Export-HtmlReport -Title 'Service Health User Impact' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Service Health User Impact' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
