...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: CA Block SignIn Explain
.DESCRIPTION
...
.EXAMPLE
    .\CA-Block-SignIn-Explain.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\CA-Block-SignIn-Explain.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'CA Block SignIn Explain'; $totalSteps = 8; $Name = 'CA-Block-SignIn-Explain'; $Folder = '30_M365-Access-SignIn-HD'
$DefaultScopes = @('Policy.Read.All','Directory.Read.All')
try {
    ...
    Export-HtmlReport -Title 'CA Block SignIn Explain' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'CA Block SignIn Explain' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
