...
<#
.SYNOPSIS
    Common problem fix: Ctrl Alt Del Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Ctrl-Alt-Del-Not-Working-Fix
.EXAMPLE
    .\Ctrl-Alt-Del-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Ctrl Alt Del Not Working Fix'; $totalSteps = 8; $Name = 'Ctrl-Alt-Del-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Ctrl Alt Del Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Ctrl Alt Del Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
