...
<#
.SYNOPSIS
    Common problem fix: Hello Face Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Hello-Face-Not-Working-Fix
.EXAMPLE
    .\Hello-Face-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Hello Face Not Working Fix'; $totalSteps = 8; $Name = 'Hello-Face-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Hello Face Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Hello Face Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
