...
<#
.SYNOPSIS
    Common problem fix: Chrome Not Loading Pages Fix
.DESCRIPTION
...
.EXAMPLE
    .\Chrome-Not-Loading-Pages-Fix
.EXAMPLE
    .\Chrome-Not-Loading-Pages-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Chrome Not Loading Pages Fix'; $totalSteps = 8; $Name = 'Chrome-Not-Loading-Pages-Fix'
try {
    ...
    Export-HtmlReport -Title 'Chrome Not Loading Pages Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Chrome Not Loading Pages Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
