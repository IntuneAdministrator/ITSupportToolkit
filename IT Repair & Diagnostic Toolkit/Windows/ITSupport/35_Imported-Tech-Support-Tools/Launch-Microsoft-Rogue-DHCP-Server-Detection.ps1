...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Rogue DHCP Server Detection
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Rogue DHCP Server Detection'
