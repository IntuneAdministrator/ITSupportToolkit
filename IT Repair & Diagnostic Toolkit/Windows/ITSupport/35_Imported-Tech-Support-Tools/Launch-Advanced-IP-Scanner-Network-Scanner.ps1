...
<#
.SYNOPSIS
    Launch imported tech support tool: Advanced IP Scanner - Network Scanner
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Advanced IP Scanner - Network Scanner'
