...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Process Explorer Tool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Process Explorer Tool'
