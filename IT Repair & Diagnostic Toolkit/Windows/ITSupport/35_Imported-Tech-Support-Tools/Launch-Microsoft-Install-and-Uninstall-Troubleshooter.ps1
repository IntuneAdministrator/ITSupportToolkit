...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Install and Uninstall Troubleshooter
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Install and Uninstall Troubleshooter'
