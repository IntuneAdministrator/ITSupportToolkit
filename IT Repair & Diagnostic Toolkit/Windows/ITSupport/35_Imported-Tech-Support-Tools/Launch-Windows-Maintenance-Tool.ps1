...
<#
.SYNOPSIS
    Launch imported tech support tool: Windows Maintenance Tool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Windows Maintenance Tool'
