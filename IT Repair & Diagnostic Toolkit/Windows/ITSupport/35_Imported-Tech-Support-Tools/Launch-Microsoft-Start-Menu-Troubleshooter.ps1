...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Start Menu Troubleshooter
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Start Menu Troubleshooter'
