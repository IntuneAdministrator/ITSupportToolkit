...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Windows Firewall Troubleshooter
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Windows Firewall Troubleshooter'
