...
<#
.SYNOPSIS
    Launch imported tech support tool: Other Software Clean Uninstaller Tool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Other Software Clean Uninstaller Tool'
