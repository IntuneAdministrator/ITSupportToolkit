...
<#
.SYNOPSIS
    Launch imported tech support tool: AdwCleaner Removal Tool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\AdwCleaner Removal Tool'
