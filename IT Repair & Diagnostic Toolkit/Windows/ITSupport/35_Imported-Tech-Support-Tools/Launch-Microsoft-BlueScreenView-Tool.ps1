...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft BlueScreenView Tool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft BlueScreenView Tool'
