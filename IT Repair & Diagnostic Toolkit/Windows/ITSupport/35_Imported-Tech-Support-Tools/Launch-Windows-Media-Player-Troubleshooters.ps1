...
<#
.SYNOPSIS
    Launch imported tech support tool: Windows Media Player Troubleshooters
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Windows Media Player Troubleshooters'
