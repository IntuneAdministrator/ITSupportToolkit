...
<#
.SYNOPSIS
    Launch imported tech support tool: Norton Power Eraser
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Norton Power Eraser'
