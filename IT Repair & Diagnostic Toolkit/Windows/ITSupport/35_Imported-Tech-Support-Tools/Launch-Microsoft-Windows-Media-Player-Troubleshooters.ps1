...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft Windows Media Player Troubleshooters
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft Windows Media Player Troubleshooters'
