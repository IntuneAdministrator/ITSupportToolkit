...
<#
.SYNOPSIS
    Launch imported tech support tool: Microsoft File and Folder Troubleshooter
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Microsoft File and Folder Troubleshooter'
