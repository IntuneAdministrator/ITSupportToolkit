...
<#
.SYNOPSIS
    Launch imported tech support tool: Windows Update MiniTool
.DESCRIPTION
...
$toolRoot = Join-Path $PSScriptRoot '..\..\SysAdmin\65_Imported-Tech-Support-Tools\_Tools\Windows Update MiniTool'
