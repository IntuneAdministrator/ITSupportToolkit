...
<#
.SYNOPSIS
    Common problem fix: PowerPoint Media Not Playing Fix
.DESCRIPTION
...
.EXAMPLE
    .\PowerPoint-Media-Not-Playing-Fix
.EXAMPLE
    .\PowerPoint-Media-Not-Playing-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'PowerPoint Media Not Playing Fix'; $totalSteps = 8; $Name = 'PowerPoint-Media-Not-Playing-Fix'
try {
    ...
    Export-HtmlReport -Title 'PowerPoint Media Not Playing Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'PowerPoint Media Not Playing Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
