...
<#
.SYNOPSIS
    Common problem fix: Outlook Search Not Working
.DESCRIPTION
...
.EXAMPLE
    .\Outlook-Search-Not-Working.ps1
.EXAMPLE
    .\Outlook-Search-Not-Working.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Outlook Search Not Working'; $totalSteps = 8; $Name = 'Outlook-Search-Not-Working'
try {
    ...
    Export-HtmlReport -Title 'Outlook Search Not Working' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Outlook Search Not Working' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
