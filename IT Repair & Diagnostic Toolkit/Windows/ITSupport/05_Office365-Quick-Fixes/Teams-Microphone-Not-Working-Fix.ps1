...
<#
.SYNOPSIS
    Common problem fix: Teams Microphone Not Working Fix
.DESCRIPTION
...
.EXAMPLE
    .\Teams-Microphone-Not-Working-Fix
.EXAMPLE
    .\Teams-Microphone-Not-Working-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Teams Microphone Not Working Fix'; $totalSteps = 8; $Name = 'Teams-Microphone-Not-Working-Fix'
try {
    ...
    Export-HtmlReport -Title 'Teams Microphone Not Working Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Teams Microphone Not Working Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
