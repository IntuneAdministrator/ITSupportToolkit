...
<#
.SYNOPSIS
    Common problem fix: Office365 Quick Fixes Helpdesk Report
.DESCRIPTION
    Phase 13 common-problems module (ITSupport / 05_Office365-Quick-Fixes). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\Office365-Quick-Fixes-Helpdesk-Report.ps1
.EXAMPLE
    .\Office365-Quick-Fixes-Helpdesk-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Office365 Quick Fixes Helpdesk Report'; $totalSteps = 8; $Name = 'Office365-Quick-Fixes-Helpdesk-Report'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '05_Office365-Quick-Fixes' -Status 'INFO' -Detail 'ITSupport'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '05_Office365-Quick-Fixes'
    ...
    Export-HtmlReport -Title 'Office365 Quick Fixes Helpdesk Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Office365 Quick Fixes Helpdesk Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
