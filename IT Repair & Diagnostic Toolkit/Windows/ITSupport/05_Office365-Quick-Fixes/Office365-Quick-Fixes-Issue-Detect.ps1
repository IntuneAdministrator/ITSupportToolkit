...
<#
.SYNOPSIS
    Common problem fix: Office365 Quick Fixes Issue Detect
.DESCRIPTION
...
.EXAMPLE
    .\Office365-Quick-Fixes-Issue-Detect.ps1
.EXAMPLE
    .\Office365-Quick-Fixes-Issue-Detect.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Office365 Quick Fixes Issue Detect'; $totalSteps = 8; $Name = 'Office365-Quick-Fixes-Issue-Detect'
try {
    ...
    Export-HtmlReport -Title 'Office365 Quick Fixes Issue Detect' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Office365 Quick Fixes Issue Detect' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
