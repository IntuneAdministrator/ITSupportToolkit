...
<#
.SYNOPSIS
    Common problem fix: Office365 Quick Fixes Policy Check
.DESCRIPTION
...
.EXAMPLE
    .\Office365-Quick-Fixes-Policy-Check.ps1
.EXAMPLE
    .\Office365-Quick-Fixes-Policy-Check.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Office365 Quick Fixes Policy Check'; $totalSteps = 8; $Name = 'Office365-Quick-Fixes-Policy-Check'
try {
    ...
    Export-HtmlReport -Title 'Office365 Quick Fixes Policy Check' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Office365 Quick Fixes Policy Check' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
