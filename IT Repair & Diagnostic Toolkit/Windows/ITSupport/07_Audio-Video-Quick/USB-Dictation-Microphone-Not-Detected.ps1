...
<#
.SYNOPSIS
    Common problem fix: USB Dictation Microphone Not Detected
.DESCRIPTION
    Phase 13 common-problems module (ITSupport / 07_Audio-Video-Quick). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\USB-Dictation-Microphone-Not-Detected.ps1
.EXAMPLE
    .\USB-Dictation-Microphone-Not-Detected.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'USB Dictation Microphone Not Detected'; $totalSteps = 8; $Name = 'USB-Dictation-Microphone-Not-Detected'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '07_Audio-Video-Quick' -Status 'INFO' -Detail 'ITSupport'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '07_Audio-Video-Quick'
    ...
    Export-HtmlReport -Title 'USB Dictation Microphone Not Detected' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'USB Dictation Microphone Not Detected' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
