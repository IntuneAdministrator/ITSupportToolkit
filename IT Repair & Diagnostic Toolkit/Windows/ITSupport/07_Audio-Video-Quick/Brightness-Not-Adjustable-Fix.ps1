...
<#
.SYNOPSIS
    Common problem fix: Brightness Not Adjustable Fix
.DESCRIPTION
...
.EXAMPLE
    .\Brightness-Not-Adjustable-Fix
.EXAMPLE
    .\Brightness-Not-Adjustable-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Brightness Not Adjustable Fix'; $totalSteps = 8; $Name = 'Brightness-Not-Adjustable-Fix'
try {
    ...
    Export-HtmlReport -Title 'Brightness Not Adjustable Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Brightness Not Adjustable Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
