...
<#
.SYNOPSIS
    Common problem fix: Audio Video Quick Helpdesk Report
.DESCRIPTION
...
.EXAMPLE
    .\Audio-Video-Quick-Helpdesk-Report.ps1
.EXAMPLE
    .\Audio-Video-Quick-Helpdesk-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Audio Video Quick Helpdesk Report'; $totalSteps = 8; $Name = 'Audio-Video-Quick-Helpdesk-Report'
try {
    ...
    Export-HtmlReport -Title 'Audio Video Quick Helpdesk Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Audio Video Quick Helpdesk Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
