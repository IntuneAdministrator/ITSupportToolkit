...
<#
.SYNOPSIS
    Common problem fix: USB Headset Not Default Device
.DESCRIPTION
...
.EXAMPLE
    .\USB-Headset-Not-Default-Device.ps1
.EXAMPLE
    .\USB-Headset-Not-Default-Device.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'USB Headset Not Default Device'; $totalSteps = 8; $Name = 'USB-Headset-Not-Default-Device'
try {
    ...
    Export-HtmlReport -Title 'USB Headset Not Default Device' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'USB Headset Not Default Device' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
