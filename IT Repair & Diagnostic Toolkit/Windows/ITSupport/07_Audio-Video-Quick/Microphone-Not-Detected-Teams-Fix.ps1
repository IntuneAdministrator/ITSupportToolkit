...
<#
.SYNOPSIS
    Common problem fix: Microphone Not Detected Teams Fix
.DESCRIPTION
...
.EXAMPLE
    .\Microphone-Not-Detected-Teams-Fix
.EXAMPLE
    .\Microphone-Not-Detected-Teams-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microphone Not Detected Teams Fix'; $totalSteps = 8; $Name = 'Microphone-Not-Detected-Teams-Fix'
try {
    ...
    Export-HtmlReport -Title 'Microphone Not Detected Teams Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microphone Not Detected Teams Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
