...
<#
.SYNOPSIS
    Common problem fix: Hotspot Tethering Not Working
.DESCRIPTION
...
.EXAMPLE
    .\Hotspot-Tethering-Not-Working.ps1
.EXAMPLE
    .\Hotspot-Tethering-Not-Working.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Hotspot Tethering Not Working'; $totalSteps = 8; $Name = 'Hotspot-Tethering-Not-Working'
try {
    ...
    Export-HtmlReport -Title 'Hotspot Tethering Not Working' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Hotspot Tethering Not Working' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
