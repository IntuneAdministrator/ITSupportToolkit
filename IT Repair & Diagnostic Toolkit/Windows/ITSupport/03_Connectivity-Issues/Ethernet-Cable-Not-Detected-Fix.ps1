...
<#
.SYNOPSIS
    Common problem fix: Ethernet Cable Not Detected Fix
.DESCRIPTION
...
.EXAMPLE
    .\Ethernet-Cable-Not-Detected-Fix
.EXAMPLE
    .\Ethernet-Cable-Not-Detected-Fix -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Ethernet Cable Not Detected Fix'; $totalSteps = 8; $Name = 'Ethernet-Cable-Not-Detected-Fix'
try {
    ...
    Export-HtmlReport -Title 'Ethernet Cable Not Detected Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Ethernet Cable Not Detected Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
