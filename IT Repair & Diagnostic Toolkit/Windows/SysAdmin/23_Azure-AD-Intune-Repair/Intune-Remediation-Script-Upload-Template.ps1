...
<#
.SYNOPSIS
    Common problem fix: Intune Remediation Script Upload Template
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Remediation-Script-Upload-Template.ps1
.EXAMPLE
    .\Intune-Remediation-Script-Upload-Template.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Remediation Script Upload Template'; $totalSteps = 8; $Name = 'Intune-Remediation-Script-Upload-Template'
try {
    ...
    Export-HtmlReport -Title 'Intune Remediation Script Upload Template' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Remediation Script Upload Template' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
