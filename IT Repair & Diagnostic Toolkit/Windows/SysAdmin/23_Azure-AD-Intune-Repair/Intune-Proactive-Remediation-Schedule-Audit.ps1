...
<#
.SYNOPSIS
    Common problem fix: Intune Proactive Remediation Schedule Audit
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Proactive-Remediation-Schedule-Audit.ps1
.EXAMPLE
    .\Intune-Proactive-Remediation-Schedule-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Proactive Remediation Schedule Audit'; $totalSteps = 8; $Name = 'Intune-Proactive-Remediation-Schedule-Audit'
try {
    ...
    Export-HtmlReport -Title 'Intune Proactive Remediation Schedule Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Proactive Remediation Schedule Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
