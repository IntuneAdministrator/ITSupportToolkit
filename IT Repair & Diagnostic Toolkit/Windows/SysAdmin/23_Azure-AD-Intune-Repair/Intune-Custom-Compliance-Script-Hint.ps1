...
<#
.SYNOPSIS
    Common problem fix: Intune Custom Compliance Script Hint
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Custom-Compliance-Script-Hint.ps1
.EXAMPLE
    .\Intune-Custom-Compliance-Script-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Custom Compliance Script Hint'; $totalSteps = 8; $Name = 'Intune-Custom-Compliance-Script-Hint'
try {
    ...
    Export-HtmlReport -Title 'Intune Custom Compliance Script Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Custom Compliance Script Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
