...
<#
.SYNOPSIS
    Common problem fix: Intune Script Deploy Package Hint
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Script-Deploy-Package-Hint.ps1
.EXAMPLE
    .\Intune-Script-Deploy-Package-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Script Deploy Package Hint'; $totalSteps = 8; $Name = 'Intune-Script-Deploy-Package-Hint'
try {
    ...
    Export-HtmlReport -Title 'Intune Script Deploy Package Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Script Deploy Package Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
