...
<#
.SYNOPSIS
    Common problem fix: Intune Platform Script Run As System Hint
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Platform-Script-Run-As-System-Hint.ps1
.EXAMPLE
    .\Intune-Platform-Script-Run-As-System-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Platform Script Run As System Hint'; $totalSteps = 8; $Name = 'Intune-Platform-Script-Run-As-System-Hint'
try {
    ...
    Export-HtmlReport -Title 'Intune Platform Script Run As System Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Platform Script Run As System Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
