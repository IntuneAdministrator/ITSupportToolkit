...
<#
.SYNOPSIS
    Common problem fix: Intune Required Script Assignment Runbook
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Required-Script-Assignment-Runbook.ps1
.EXAMPLE
    .\Intune-Required-Script-Assignment-Runbook.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Required Script Assignment Runbook'; $totalSteps = 8; $Name = 'Intune-Required-Script-Assignment-Runbook'
try {
    ...
    Export-HtmlReport -Title 'Intune Required Script Assignment Runbook' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Required Script Assignment Runbook' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
