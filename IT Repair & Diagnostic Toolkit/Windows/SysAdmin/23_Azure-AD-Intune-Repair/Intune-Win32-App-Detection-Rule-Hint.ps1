...
<#
.SYNOPSIS
    Common problem fix: Intune Win32 App Detection Rule Hint
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Win32-App-Detection-Rule-Hint.ps1
.EXAMPLE
    .\Intune-Win32-App-Detection-Rule-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Win32 App Detection Rule Hint'; $totalSteps = 8; $Name = 'Intune-Win32-App-Detection-Rule-Hint'
try {
    ...
    Export-HtmlReport -Title 'Intune Win32 App Detection Rule Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Win32 App Detection Rule Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
