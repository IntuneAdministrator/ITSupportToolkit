...
<#
.SYNOPSIS
    Common problem fix: IntuneWin Detection Script Template
.DESCRIPTION
...
.EXAMPLE
    .\IntuneWin-Detection-Script-Template.ps1
.EXAMPLE
    .\IntuneWin-Detection-Script-Template.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'IntuneWin Detection Script Template'; $totalSteps = 8; $Name = 'IntuneWin-Detection-Script-Template'
try {
    ...
    Export-HtmlReport -Title 'IntuneWin Detection Script Template' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'IntuneWin Detection Script Template' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
