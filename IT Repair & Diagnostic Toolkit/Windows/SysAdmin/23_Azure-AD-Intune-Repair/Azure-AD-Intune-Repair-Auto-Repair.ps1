...
<#
.SYNOPSIS
    Common problem fix: Azure AD Intune Repair Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Azure-AD-Intune-Repair-Auto-Repair.ps1
.EXAMPLE
    .\Azure-AD-Intune-Repair-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Azure AD Intune Repair Auto Repair'; $totalSteps = 8; $Name = 'Azure-AD-Intune-Repair-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Azure AD Intune Repair Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Azure AD Intune Repair Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
