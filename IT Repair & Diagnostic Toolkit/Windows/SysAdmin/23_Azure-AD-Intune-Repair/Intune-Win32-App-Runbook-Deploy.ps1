...
<#
.SYNOPSIS
    Common problem fix: Intune Win32 App Runbook Deploy
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Win32-App-Runbook-Deploy.ps1
.EXAMPLE
    .\Intune-Win32-App-Runbook-Deploy.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Win32 App Runbook Deploy'; $totalSteps = 8; $Name = 'Intune-Win32-App-Runbook-Deploy'
try {
    ...
    Export-HtmlReport -Title 'Intune Win32 App Runbook Deploy' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Win32 App Runbook Deploy' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
