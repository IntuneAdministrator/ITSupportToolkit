...
<#
.SYNOPSIS
    Common problem fix: IntuneWin Install Command Template
.DESCRIPTION
...
.EXAMPLE
    .\IntuneWin-Install-Command-Template.ps1
.EXAMPLE
    .\IntuneWin-Install-Command-Template.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'IntuneWin Install Command Template'; $totalSteps = 8; $Name = 'IntuneWin-Install-Command-Template'
try {
    ...
    Export-HtmlReport -Title 'IntuneWin Install Command Template' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'IntuneWin Install Command Template' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
