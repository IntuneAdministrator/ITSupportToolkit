...
<#
.SYNOPSIS
    Common problem fix: Intune Filter Assignment Hardware Hint
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Filter-Assignment-Hardware-Hint.ps1
.EXAMPLE
    .\Intune-Filter-Assignment-Hardware-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Filter Assignment Hardware Hint'; $totalSteps = 8; $Name = 'Intune-Filter-Assignment-Hardware-Hint'
try {
    ...
    Export-HtmlReport -Title 'Intune Filter Assignment Hardware Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Filter Assignment Hardware Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
