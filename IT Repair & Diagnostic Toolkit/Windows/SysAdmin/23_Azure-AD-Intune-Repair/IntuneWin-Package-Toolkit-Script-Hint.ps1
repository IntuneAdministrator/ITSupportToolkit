...
<#
.SYNOPSIS
    Common problem fix: IntuneWin Package Toolkit Script Hint
.DESCRIPTION
...
.EXAMPLE
    .\IntuneWin-Package-Toolkit-Script-Hint.ps1
.EXAMPLE
    .\IntuneWin-Package-Toolkit-Script-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'IntuneWin Package Toolkit Script Hint'; $totalSteps = 8; $Name = 'IntuneWin-Package-Toolkit-Script-Hint'
try {
    ...
    Export-HtmlReport -Title 'IntuneWin Package Toolkit Script Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'IntuneWin Package Toolkit Script Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
