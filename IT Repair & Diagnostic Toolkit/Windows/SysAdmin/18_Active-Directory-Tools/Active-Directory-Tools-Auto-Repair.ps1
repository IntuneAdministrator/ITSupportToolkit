...
<#
.SYNOPSIS
    Common problem fix: Active Directory Tools Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Active-Directory-Tools-Auto-Repair.ps1
.EXAMPLE
    .\Active-Directory-Tools-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Active Directory Tools Auto Repair'; $totalSteps = 8; $Name = 'Active-Directory-Tools-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Active Directory Tools Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Active Directory Tools Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
