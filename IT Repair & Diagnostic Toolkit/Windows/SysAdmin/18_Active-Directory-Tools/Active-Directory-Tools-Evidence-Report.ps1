...
<#
.SYNOPSIS
    Common problem fix: Active Directory Tools Evidence Report
.DESCRIPTION
...
.EXAMPLE
    .\Active-Directory-Tools-Evidence-Report.ps1
.EXAMPLE
    .\Active-Directory-Tools-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Active Directory Tools Evidence Report'; $totalSteps = 8; $Name = 'Active-Directory-Tools-Evidence-Report'
try {
    ...
    Export-HtmlReport -Title 'Active Directory Tools Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Active Directory Tools Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
