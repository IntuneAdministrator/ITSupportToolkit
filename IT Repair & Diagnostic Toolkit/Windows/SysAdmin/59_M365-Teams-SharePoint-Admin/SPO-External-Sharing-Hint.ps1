...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: SPO External Sharing Hint
.DESCRIPTION
...
.EXAMPLE
    .\SPO-External-Sharing-Hint.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\SPO-External-Sharing-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'SPO External Sharing Hint'; $totalSteps = 8; $Name = 'SPO-External-Sharing-Hint'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'SPO External Sharing Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'SPO External Sharing Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
