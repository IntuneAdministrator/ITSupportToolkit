...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Teams Devices Rooms Hint
.DESCRIPTION
...
.EXAMPLE
    .\Teams-Devices-Rooms-Hint.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Teams-Devices-Rooms-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Teams Devices Rooms Hint'; $totalSteps = 8; $Name = 'Teams-Devices-Rooms-Hint'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Teams Devices Rooms Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Teams Devices Rooms Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
