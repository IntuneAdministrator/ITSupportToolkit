...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Teams Meeting Policy Check
.DESCRIPTION
...
.EXAMPLE
    .\Teams-Meeting-Policy-Check.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Teams-Meeting-Policy-Check.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Teams Meeting Policy Check'; $totalSteps = 8; $Name = 'Teams-Meeting-Policy-Check'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Teams Meeting Policy Check' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Teams Meeting Policy Check' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
