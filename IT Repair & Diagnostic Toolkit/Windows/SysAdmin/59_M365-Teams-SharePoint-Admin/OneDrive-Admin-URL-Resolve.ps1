...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: OneDrive Admin URL Resolve
.DESCRIPTION
...
.EXAMPLE
    .\OneDrive-Admin-URL-Resolve.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\OneDrive-Admin-URL-Resolve.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'OneDrive Admin URL Resolve'; $totalSteps = 8; $Name = 'OneDrive-Admin-URL-Resolve'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'OneDrive Admin URL Resolve' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'OneDrive Admin URL Resolve' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
