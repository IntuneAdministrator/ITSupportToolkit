...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Teams User Policy Assignment
.DESCRIPTION
...
.EXAMPLE
    .\Teams-User-Policy-Assignment.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Teams-User-Policy-Assignment.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Teams User Policy Assignment'; $totalSteps = 8; $Name = 'Teams-User-Policy-Assignment'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Teams User Policy Assignment' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Teams User Policy Assignment' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
