...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: SPO Site Lookup Prep
.DESCRIPTION
...
.EXAMPLE
    .\SPO-Site-Lookup-Prep.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\SPO-Site-Lookup-Prep.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'SPO Site Lookup Prep'; $totalSteps = 8; $Name = 'SPO-Site-Lookup-Prep'; $Folder = '59_M365-Teams-SharePoint-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'SPO Site Lookup Prep' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'SPO Site Lookup Prep' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
