...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Mailbox Quota Report
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Mailbox-Quota-Report.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Mailbox-Quota-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Mailbox Quota Report'; $totalSteps = 8; $Name = 'EXO-Mailbox-Quota-Report'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Mailbox Quota Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Mailbox Quota Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
