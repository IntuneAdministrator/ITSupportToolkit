...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Forwarding Audit
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Forwarding-Audit.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Forwarding-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Forwarding Audit'; $totalSteps = 8; $Name = 'EXO-Forwarding-Audit'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Forwarding Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Forwarding Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
