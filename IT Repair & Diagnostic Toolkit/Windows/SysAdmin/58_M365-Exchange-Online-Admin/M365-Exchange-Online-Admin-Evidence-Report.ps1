...
<#
.SYNOPSIS
    Common problem fix: M365 Exchange Online Admin Evidence Report
.DESCRIPTION
    Phase 13 common-problems module (SysAdmin / 58_M365-Exchange-Online-Admin). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\M365-Exchange-Online-Admin-Evidence-Report.ps1
.EXAMPLE
    .\M365-Exchange-Online-Admin-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'M365 Exchange Online Admin Evidence Report'; $totalSteps = 8; $Name = 'M365-Exchange-Online-Admin-Evidence-Report'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '58_M365-Exchange-Online-Admin' -Status 'INFO' -Detail 'SysAdmin'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '58_M365-Exchange-Online-Admin'
    ...
    Export-HtmlReport -Title 'M365 Exchange Online Admin Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'M365 Exchange Online Admin Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
