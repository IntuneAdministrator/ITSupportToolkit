...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Mailbox Lookup
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Mailbox-Lookup.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Mailbox-Lookup.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Mailbox Lookup'; $totalSteps = 8; $Name = 'EXO-Mailbox-Lookup'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Mailbox Lookup' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Mailbox Lookup' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
