...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Connect Prep
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Connect-Prep.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Connect-Prep.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Connect Prep'; $totalSteps = 8; $Name = 'EXO-Connect-Prep'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Connect Prep' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Connect Prep' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
