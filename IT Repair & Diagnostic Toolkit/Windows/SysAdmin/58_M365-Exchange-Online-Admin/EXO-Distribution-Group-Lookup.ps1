...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Distribution Group Lookup
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Distribution-Group-Lookup.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Distribution-Group-Lookup.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Distribution Group Lookup'; $totalSteps = 8; $Name = 'EXO-Distribution-Group-Lookup'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Distribution Group Lookup' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Distribution Group Lookup' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
