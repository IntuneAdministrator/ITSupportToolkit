...
<#
.SYNOPSIS
    Common problem fix: M365 Exchange Online Admin Quick Fix
.DESCRIPTION
...
.EXAMPLE
    .\M365-Exchange-Online-Admin-Quick-Fix.ps1
.EXAMPLE
    .\M365-Exchange-Online-Admin-Quick-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'M365 Exchange Online Admin Quick Fix'; $totalSteps = 8; $Name = 'M365-Exchange-Online-Admin-Quick-Fix'
try {
    ...
    Export-HtmlReport -Title 'M365 Exchange Online Admin Quick Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'M365 Exchange Online Admin Quick Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
