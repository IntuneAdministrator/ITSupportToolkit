...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: EXO Litigation Hold Status
.DESCRIPTION
...
.EXAMPLE
    .\EXO-Litigation-Hold-Status.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\EXO-Litigation-Hold-Status.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'EXO Litigation Hold Status'; $totalSteps = 8; $Name = 'EXO-Litigation-Hold-Status'; $Folder = '58_M365-Exchange-Online-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'EXO Litigation Hold Status' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'EXO Litigation Hold Status' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
