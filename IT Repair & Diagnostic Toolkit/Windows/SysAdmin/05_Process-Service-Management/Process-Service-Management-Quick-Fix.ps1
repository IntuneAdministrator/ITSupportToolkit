...
<#
.SYNOPSIS
    Common problem fix: Process Service Management Quick Fix
.DESCRIPTION
...
.EXAMPLE
    .\Process-Service-Management-Quick-Fix.ps1
.EXAMPLE
    .\Process-Service-Management-Quick-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Process Service Management Quick Fix'; $totalSteps = 8; $Name = 'Process-Service-Management-Quick-Fix'
try {
    ...
    Export-HtmlReport -Title 'Process Service Management Quick Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Process Service Management Quick Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
