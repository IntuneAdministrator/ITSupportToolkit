...
<#
.SYNOPSIS
    Common problem fix: Process Service Management Evidence Report
.DESCRIPTION
...
.EXAMPLE
    .\Process-Service-Management-Evidence-Report.ps1
.EXAMPLE
    .\Process-Service-Management-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Process Service Management Evidence Report'; $totalSteps = 8; $Name = 'Process-Service-Management-Evidence-Report'
try {
    ...
    Export-HtmlReport -Title 'Process Service Management Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Process Service Management Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
