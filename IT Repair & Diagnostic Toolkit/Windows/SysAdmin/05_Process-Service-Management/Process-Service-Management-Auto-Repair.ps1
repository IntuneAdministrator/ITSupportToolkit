...
<#
.SYNOPSIS
    Common problem fix: Process Service Management Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Process-Service-Management-Auto-Repair.ps1
.EXAMPLE
    .\Process-Service-Management-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Process Service Management Auto Repair'; $totalSteps = 8; $Name = 'Process-Service-Management-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Process Service Management Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Process Service Management Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
