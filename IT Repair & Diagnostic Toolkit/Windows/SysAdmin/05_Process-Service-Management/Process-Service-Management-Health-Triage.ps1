...
<#
.SYNOPSIS
    Common problem fix: Process Service Management Health Triage
.DESCRIPTION
...
.EXAMPLE
    .\Process-Service-Management-Health-Triage.ps1
.EXAMPLE
    .\Process-Service-Management-Health-Triage.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Process Service Management Health Triage'; $totalSteps = 8; $Name = 'Process-Service-Management-Health-Triage'
try {
    ...
    Export-HtmlReport -Title 'Process Service Management Health Triage' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Process Service Management Health Triage' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
