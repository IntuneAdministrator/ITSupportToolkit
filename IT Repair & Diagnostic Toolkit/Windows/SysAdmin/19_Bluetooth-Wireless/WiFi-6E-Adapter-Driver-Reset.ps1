...
<#
.SYNOPSIS
    Common problem fix: WiFi 6E Adapter Driver Reset
.DESCRIPTION
...
.EXAMPLE
    .\WiFi-6E-Adapter-Driver-Reset.ps1
.EXAMPLE
    .\WiFi-6E-Adapter-Driver-Reset.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'WiFi 6E Adapter Driver Reset'; $totalSteps = 8; $Name = 'WiFi-6E-Adapter-Driver-Reset'
try {
    ...
    Export-HtmlReport -Title 'WiFi 6E Adapter Driver Reset' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'WiFi 6E Adapter Driver Reset' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
