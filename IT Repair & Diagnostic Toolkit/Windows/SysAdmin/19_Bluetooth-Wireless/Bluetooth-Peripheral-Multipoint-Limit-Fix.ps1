...
<#
.SYNOPSIS
    Common problem fix: Bluetooth Peripheral Multipoint Limit Fix
.DESCRIPTION
    Phase 13 common-problems module (SysAdmin / 19_Bluetooth-Wireless). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\Bluetooth-Peripheral-Multipoint-Limit-Fix.ps1
.EXAMPLE
    .\Bluetooth-Peripheral-Multipoint-Limit-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Bluetooth Peripheral Multipoint Limit Fix'; $totalSteps = 8; $Name = 'Bluetooth-Peripheral-Multipoint-Limit-Fix'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '19_Bluetooth-Wireless' -Status 'INFO' -Detail 'SysAdmin'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '19_Bluetooth-Wireless'
    ...
    Export-HtmlReport -Title 'Bluetooth Peripheral Multipoint Limit Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Bluetooth Peripheral Multipoint Limit Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
