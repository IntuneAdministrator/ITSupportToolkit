...
<#
.SYNOPSIS
    Enterprise IT repair/diagnostic: UWP App Data Migration
.DESCRIPTION
    Production-grade Windows SysAdmin tool for UWP-App-Data-Migration.
...
$exitCode = 0
$Activity = 'UWP App Data Migration'
$totalSteps = 8
...
try {
    ...
    Add-ReportRow -Check 'PowerShell' -Result $PSVersionTable.PSVersion.ToString() -Status 'INFO' -Detail $PSVersionTable.PSEdition
        ...
        $Name = 'UWP-App-Data-Migration'
        Add-ReportRow -Check 'Tool' -Result 'UWP-App-Data-Migration' -Status 'INFO' -Detail '28_Store-AppX-UWP-Repair'
    ...
    Export-HtmlReport -Title 'UWP App Data Migration' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try {
        ...
        Export-HtmlReport -Title 'UWP App Data Migration' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    } catch { }
    $exitCode = 2
}
finally {
