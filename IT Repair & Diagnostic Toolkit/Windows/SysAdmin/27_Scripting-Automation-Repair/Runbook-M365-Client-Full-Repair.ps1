...
<#
.SYNOPSIS
    Common problem fix: Runbook M365 Client Full Repair
.DESCRIPTION
...
.EXAMPLE
    .\Runbook-M365-Client-Full-Repair.ps1
.EXAMPLE
    .\Runbook-M365-Client-Full-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Runbook M365 Client Full Repair'; $totalSteps = 8; $Name = 'Runbook-M365-Client-Full-Repair'
try {
    ...
    Export-HtmlReport -Title 'Runbook M365 Client Full Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Runbook M365 Client Full Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
