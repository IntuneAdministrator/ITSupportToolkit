...
<#
.SYNOPSIS
    Common problem fix: Always On VPN DirectAccess Quick Fix
.DESCRIPTION
...
.EXAMPLE
    .\Always-On-VPN-DirectAccess-Quick-Fix.ps1
.EXAMPLE
    .\Always-On-VPN-DirectAccess-Quick-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Always On VPN DirectAccess Quick Fix'; $totalSteps = 8; $Name = 'Always-On-VPN-DirectAccess-Quick-Fix'
try {
    ...
    Export-HtmlReport -Title 'Always On VPN DirectAccess Quick Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Always On VPN DirectAccess Quick Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
