...
<#
.SYNOPSIS
    Common problem fix: M365 Graph Tenant Admin Evidence Report
.DESCRIPTION
...
.EXAMPLE
    .\M365-Graph-Tenant-Admin-Evidence-Report.ps1
.EXAMPLE
    .\M365-Graph-Tenant-Admin-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'M365 Graph Tenant Admin Evidence Report'; $totalSteps = 8; $Name = 'M365-Graph-Tenant-Admin-Evidence-Report'
try {
    ...
    Export-HtmlReport -Title 'M365 Graph Tenant Admin Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'M365 Graph Tenant Admin Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
