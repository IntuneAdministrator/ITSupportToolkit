...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Graph Service Health Snapshot
.DESCRIPTION
...
.EXAMPLE
    .\Graph-Service-Health-Snapshot.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Graph-Service-Health-Snapshot.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Graph Service Health Snapshot'; $totalSteps = 8; $Name = 'Graph-Service-Health-Snapshot'; $Folder = '57_M365-Graph-Tenant-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Graph Service Health Snapshot' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Graph Service Health Snapshot' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
