...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Graph User Lookup By UPN
.DESCRIPTION
...
.EXAMPLE
    .\Graph-User-Lookup-By-UPN.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Graph-User-Lookup-By-UPN.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Graph User Lookup By UPN'; $totalSteps = 8; $Name = 'Graph-User-Lookup-By-UPN'; $Folder = '57_M365-Graph-Tenant-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Graph User Lookup By UPN' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Graph User Lookup By UPN' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
