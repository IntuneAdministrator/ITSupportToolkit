...
<#
.SYNOPSIS
    Common problem fix: Tenant Device Inventory Bulk Export
.DESCRIPTION
...
.EXAMPLE
    .\Tenant-Device-Inventory-Bulk-Export.ps1
.EXAMPLE
    .\Tenant-Device-Inventory-Bulk-Export.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Tenant Device Inventory Bulk Export'; $totalSteps = 8; $Name = 'Tenant-Device-Inventory-Bulk-Export'
try {
    ...
    Export-HtmlReport -Title 'Tenant Device Inventory Bulk Export' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Tenant Device Inventory Bulk Export' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
