...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Graph Group Membership Audit
.DESCRIPTION
...
.EXAMPLE
    .\Graph-Group-Membership-Audit.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Graph-Group-Membership-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Graph Group Membership Audit'; $totalSteps = 8; $Name = 'Graph-Group-Membership-Audit'; $Folder = '57_M365-Graph-Tenant-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Graph Group Membership Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Graph Group Membership Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
