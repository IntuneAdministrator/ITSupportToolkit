...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Graph App Consent Audit
.DESCRIPTION
...
.EXAMPLE
    .\Graph-App-Consent-Audit.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Graph-App-Consent-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Graph App Consent Audit'; $totalSteps = 8; $Name = 'Graph-App-Consent-Audit'; $Folder = '57_M365-Graph-Tenant-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Graph App Consent Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Graph App Consent Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
