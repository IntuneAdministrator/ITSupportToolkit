...
<#
.SYNOPSIS
    Common problem fix: Tenant Autopilot Profile Assignment Audit
.DESCRIPTION
...
.EXAMPLE
    .\Tenant-Autopilot-Profile-Assignment-Audit.ps1
.EXAMPLE
    .\Tenant-Autopilot-Profile-Assignment-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Tenant Autopilot Profile Assignment Audit'; $totalSteps = 8; $Name = 'Tenant-Autopilot-Profile-Assignment-Audit'
try {
    ...
    Export-HtmlReport -Title 'Tenant Autopilot Profile Assignment Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Tenant Autopilot Profile Assignment Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
