...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Graph License SKU Assignment
.DESCRIPTION
...
.EXAMPLE
    .\Graph-License-SKU-Assignment.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Graph-License-SKU-Assignment.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Graph License SKU Assignment'; $totalSteps = 8; $Name = 'Graph-License-SKU-Assignment'; $Folder = '57_M365-Graph-Tenant-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Graph License SKU Assignment' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Graph License SKU Assignment' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
