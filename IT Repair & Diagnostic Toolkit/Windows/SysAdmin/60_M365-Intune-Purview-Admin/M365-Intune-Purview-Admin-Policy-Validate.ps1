...
<#
.SYNOPSIS
    Common problem fix: M365 Intune Purview Admin Policy Validate
.DESCRIPTION
...
.EXAMPLE
    .\M365-Intune-Purview-Admin-Policy-Validate.ps1
.EXAMPLE
    .\M365-Intune-Purview-Admin-Policy-Validate.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'M365 Intune Purview Admin Policy Validate'; $totalSteps = 8; $Name = 'M365-Intune-Purview-Admin-Policy-Validate'
try {
    ...
    Export-HtmlReport -Title 'M365 Intune Purview Admin Policy Validate' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'M365 Intune Purview Admin Policy Validate' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
