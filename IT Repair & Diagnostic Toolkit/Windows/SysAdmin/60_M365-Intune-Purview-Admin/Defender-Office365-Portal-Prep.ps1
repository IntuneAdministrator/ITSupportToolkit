...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Defender Office365 Portal Prep
.DESCRIPTION
...
.EXAMPLE
    .\Defender-Office365-Portal-Prep.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Defender-Office365-Portal-Prep.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Defender Office365 Portal Prep'; $totalSteps = 8; $Name = 'Defender-Office365-Portal-Prep'; $Folder = '60_M365-Intune-Purview-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Defender Office365 Portal Prep' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Defender Office365 Portal Prep' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
