...
<#
.SYNOPSIS
    Microsoft 365 cloud admin tool: Autopilot Device Hash Cloud Hint
.DESCRIPTION
...
.EXAMPLE
    .\Autopilot-Device-Hash-Cloud-Hint.ps1 -UserPrincipalName user@contoso.com
.EXAMPLE
    .\Autopilot-Device-Hash-Cloud-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Autopilot Device Hash Cloud Hint'; $totalSteps = 8; $Name = 'Autopilot-Device-Hash-Cloud-Hint'; $Folder = '60_M365-Intune-Purview-Admin'
...
try {
    ...
    Export-HtmlReport -Title 'Autopilot Device Hash Cloud Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Autopilot Device Hash Cloud Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
