...
<#
.SYNOPSIS
    Common problem fix: Intune Device Health Attestation Export
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Device-Health-Attestation-Export.ps1
.EXAMPLE
    .\Intune-Device-Health-Attestation-Export.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Device Health Attestation Export'; $totalSteps = 8; $Name = 'Intune-Device-Health-Attestation-Export'
try {
    ...
    Export-HtmlReport -Title 'Intune Device Health Attestation Export' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Device Health Attestation Export' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
