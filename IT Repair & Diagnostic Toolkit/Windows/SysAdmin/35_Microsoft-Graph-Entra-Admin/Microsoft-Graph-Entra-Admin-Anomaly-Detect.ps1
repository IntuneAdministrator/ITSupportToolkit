...
<#
.SYNOPSIS
    Common problem fix: Microsoft Graph Entra Admin Anomaly Detect
.DESCRIPTION
...
.EXAMPLE
    .\Microsoft-Graph-Entra-Admin-Anomaly-Detect.ps1
.EXAMPLE
    .\Microsoft-Graph-Entra-Admin-Anomaly-Detect.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microsoft Graph Entra Admin Anomaly Detect'; $totalSteps = 8; $Name = 'Microsoft-Graph-Entra-Admin-Anomaly-Detect'
try {
    ...
    Export-HtmlReport -Title 'Microsoft Graph Entra Admin Anomaly Detect' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microsoft Graph Entra Admin Anomaly Detect' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
