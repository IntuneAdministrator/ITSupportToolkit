...
<#
.SYNOPSIS
    Enterprise IT tool: Entra Device Object Audit
.DESCRIPTION
...
.EXAMPLE
    .\Entra-Device-Object-Audit.ps1
.EXAMPLE
    .\Entra-Device-Object-Audit.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Entra Device Object Audit'; $totalSteps = 8; $Name = 'Entra-Device-Object-Audit'
try {
    ...
    Export-HtmlReport -Title 'Entra Device Object Audit' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Entra Device Object Audit' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
