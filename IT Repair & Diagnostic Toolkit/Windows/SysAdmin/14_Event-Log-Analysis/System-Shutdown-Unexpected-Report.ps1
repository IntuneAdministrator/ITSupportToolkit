...
<#
.SYNOPSIS
    Common problem fix: System Shutdown Unexpected Report
.DESCRIPTION
...
.EXAMPLE
    .\System-Shutdown-Unexpected-Report
.EXAMPLE
    .\System-Shutdown-Unexpected-Report -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Shutdown Unexpected Report'; $totalSteps = 8; $Name = 'System-Shutdown-Unexpected-Report'
try {
    ...
    Export-HtmlReport -Title 'System Shutdown Unexpected Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Shutdown Unexpected Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
