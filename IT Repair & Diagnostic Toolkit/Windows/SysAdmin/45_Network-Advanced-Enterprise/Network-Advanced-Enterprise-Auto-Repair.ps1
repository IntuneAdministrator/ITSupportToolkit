...
<#
.SYNOPSIS
    Common problem fix: Network Advanced Enterprise Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Network-Advanced-Enterprise-Auto-Repair.ps1
.EXAMPLE
    .\Network-Advanced-Enterprise-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Network Advanced Enterprise Auto Repair'; $totalSteps = 8; $Name = 'Network-Advanced-Enterprise-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Network Advanced Enterprise Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Network Advanced Enterprise Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
