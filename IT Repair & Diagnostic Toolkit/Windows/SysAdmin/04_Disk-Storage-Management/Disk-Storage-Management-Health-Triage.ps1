...
<#
.SYNOPSIS
    Common problem fix: Disk Storage Management Health Triage
.DESCRIPTION
...
.EXAMPLE
    .\Disk-Storage-Management-Health-Triage.ps1
.EXAMPLE
    .\Disk-Storage-Management-Health-Triage.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Disk Storage Management Health Triage'; $totalSteps = 8; $Name = 'Disk-Storage-Management-Health-Triage'
try {
    ...
    Export-HtmlReport -Title 'Disk Storage Management Health Triage' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Disk Storage Management Health Triage' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
