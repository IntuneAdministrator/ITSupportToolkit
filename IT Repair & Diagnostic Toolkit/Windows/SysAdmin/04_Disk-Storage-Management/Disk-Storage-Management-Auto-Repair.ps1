...
<#
.SYNOPSIS
    Common problem fix: Disk Storage Management Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Disk-Storage-Management-Auto-Repair.ps1
.EXAMPLE
    .\Disk-Storage-Management-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Disk Storage Management Auto Repair'; $totalSteps = 8; $Name = 'Disk-Storage-Management-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Disk Storage Management Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Disk Storage Management Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
