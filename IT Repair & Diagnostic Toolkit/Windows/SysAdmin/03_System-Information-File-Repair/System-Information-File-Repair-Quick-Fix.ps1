...
<#
.SYNOPSIS
    Common problem fix: System Information File Repair Quick Fix
.DESCRIPTION
...
.EXAMPLE
    .\System-Information-File-Repair-Quick-Fix.ps1
.EXAMPLE
    .\System-Information-File-Repair-Quick-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Information File Repair Quick Fix'; $totalSteps = 8; $Name = 'System-Information-File-Repair-Quick-Fix'
try {
    ...
    Export-HtmlReport -Title 'System Information File Repair Quick Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Information File Repair Quick Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
