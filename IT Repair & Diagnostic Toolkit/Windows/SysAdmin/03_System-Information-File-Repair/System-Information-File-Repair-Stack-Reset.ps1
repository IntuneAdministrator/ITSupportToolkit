...
<#
.SYNOPSIS
    Common problem fix: System Information File Repair Stack Reset
.DESCRIPTION
...
.EXAMPLE
    .\System-Information-File-Repair-Stack-Reset.ps1
.EXAMPLE
    .\System-Information-File-Repair-Stack-Reset.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Information File Repair Stack Reset'; $totalSteps = 8; $Name = 'System-Information-File-Repair-Stack-Reset'
try {
    ...
    Export-HtmlReport -Title 'System Information File Repair Stack Reset' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Information File Repair Stack Reset' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
