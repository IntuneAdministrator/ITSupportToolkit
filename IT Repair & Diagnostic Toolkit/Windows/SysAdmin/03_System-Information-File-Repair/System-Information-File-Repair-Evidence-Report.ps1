...
<#
.SYNOPSIS
    Common problem fix: System Information File Repair Evidence Report
.DESCRIPTION
    Phase 13 common-problems module (SysAdmin / 03_System-Information-File-Repair). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\System-Information-File-Repair-Evidence-Report.ps1
.EXAMPLE
    .\System-Information-File-Repair-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Information File Repair Evidence Report'; $totalSteps = 8; $Name = 'System-Information-File-Repair-Evidence-Report'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '03_System-Information-File-Repair' -Status 'INFO' -Detail 'SysAdmin'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '03_System-Information-File-Repair'
    ...
    Export-HtmlReport -Title 'System Information File Repair Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Information File Repair Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
