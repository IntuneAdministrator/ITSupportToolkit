...
<#
.SYNOPSIS
    Common problem fix: System Information File Repair Policy Validate
.DESCRIPTION
...
.EXAMPLE
    .\System-Information-File-Repair-Policy-Validate.ps1
.EXAMPLE
    .\System-Information-File-Repair-Policy-Validate.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Information File Repair Policy Validate'; $totalSteps = 8; $Name = 'System-Information-File-Repair-Policy-Validate'
try {
    ...
    Export-HtmlReport -Title 'System Information File Repair Policy Validate' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Information File Repair Policy Validate' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
