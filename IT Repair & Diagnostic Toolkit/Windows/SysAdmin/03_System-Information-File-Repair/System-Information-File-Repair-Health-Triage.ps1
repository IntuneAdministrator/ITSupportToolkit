...
<#
.SYNOPSIS
    Common problem fix: System Information File Repair Health Triage
.DESCRIPTION
...
.EXAMPLE
    .\System-Information-File-Repair-Health-Triage.ps1
.EXAMPLE
    .\System-Information-File-Repair-Health-Triage.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'System Information File Repair Health Triage'; $totalSteps = 8; $Name = 'System-Information-File-Repair-Health-Triage'
try {
    ...
    Export-HtmlReport -Title 'System Information File Repair Health Triage' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'System Information File Repair Health Triage' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
