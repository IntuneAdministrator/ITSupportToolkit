...
<#
.SYNOPSIS
    Common problem fix: Intune Compliance Policy Gap Report
.DESCRIPTION
...
.EXAMPLE
    .\Intune-Compliance-Policy-Gap-Report.ps1
.EXAMPLE
    .\Intune-Compliance-Policy-Gap-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Intune Compliance Policy Gap Report'; $totalSteps = 8; $Name = 'Intune-Compliance-Policy-Gap-Report'
try {
    ...
    Export-HtmlReport -Title 'Intune Compliance Policy Gap Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Intune Compliance Policy Gap Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
