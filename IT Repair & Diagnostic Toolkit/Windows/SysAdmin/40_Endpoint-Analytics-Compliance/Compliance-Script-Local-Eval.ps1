...
<#
.SYNOPSIS
    Enterprise IT tool: Compliance Script Local Eval
.DESCRIPTION
...
.EXAMPLE
    .\Compliance-Script-Local-Eval.ps1
.EXAMPLE
    .\Compliance-Script-Local-Eval.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Compliance Script Local Eval'; $totalSteps = 8; $Name = 'Compliance-Script-Local-Eval'
try {
    ...
    Export-HtmlReport -Title 'Compliance Script Local Eval' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Compliance Script Local Eval' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
