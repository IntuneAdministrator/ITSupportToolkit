<#
.SYNOPSIS
    GUI-based PowerShell dashboard for accessing Windows personalization settings.

.DESCRIPTION
    This script launches a WPF-based graphical interface that displays a two-column layout of buttons, 
    each linked to a specific Windows personalization setting. The interface includes options such as 
