<#
.SYNOPSIS
    GUI-based PowerShell dashboard for accessing Windows sound settings.

.DESCRIPTION
    This script launches a WPF-based graphical interface that presents individual buttons for various
    sound-related settings in Windows. Options include Volume Mixer, Sound, Sound Devices, Default
