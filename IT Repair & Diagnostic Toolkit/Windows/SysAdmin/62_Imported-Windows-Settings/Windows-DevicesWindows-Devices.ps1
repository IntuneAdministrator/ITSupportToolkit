<#
.SYNOPSIS
    GUI-based PowerShell dashboard for accessing Windows device and input settings.

.DESCRIPTION
    This script creates a WPF-based graphical interface with a two-column layout of buttons, 
    each linked to a specific Windows device or input setting. These buttons cover settings 
    ...
    and input-related configuration pages in Windows. The layout is designed for efficiency and ease of use.
...
$window.Title = "Windows Device & Input Settings"
