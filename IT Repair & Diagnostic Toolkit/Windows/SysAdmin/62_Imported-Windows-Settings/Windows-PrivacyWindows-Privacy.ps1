<#
.SYNOPSIS
    Interactive WPF-based PowerShell GUI to manage privacy settings on Windows 24H2.

.DESCRIPTION
    This script uses Windows Presentation Foundation (WPF) to create a simple vertical layout GUI
    that provides buttons for managing various privacy settings in Windows 24H2. Each button is 
...
.NOTES
    ...
    Requirements : PowerShell 5.1+, admin rights for event log creation, and Windows 24H2+
