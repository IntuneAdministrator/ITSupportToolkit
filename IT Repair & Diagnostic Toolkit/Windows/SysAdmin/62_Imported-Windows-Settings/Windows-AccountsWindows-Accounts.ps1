<#
.SYNOPSIS
    Windows Work & Account Settings Launcher GUI with fixed-width buttons.

.DESCRIPTION
    This script creates a WPF-based graphical user interface (GUI) with two columns of buttons, 
    each having a fixed width of 320 pixels. Each button launches a specific Windows ms-settings page 
...
.NOTES
    ...
    Requirements : PowerShell 5.1+, Windows 24H2
    Usage        : Run the script, click any button to open the corresponding Windows Work & Account settings.
#>
