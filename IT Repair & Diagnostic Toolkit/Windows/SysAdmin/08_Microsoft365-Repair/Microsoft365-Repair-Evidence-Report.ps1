...
<#
.SYNOPSIS
    Common problem fix: Microsoft365 Repair Evidence Report
.DESCRIPTION
...
.EXAMPLE
    .\Microsoft365-Repair-Evidence-Report.ps1
.EXAMPLE
    .\Microsoft365-Repair-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microsoft365 Repair Evidence Report'; $totalSteps = 8; $Name = 'Microsoft365-Repair-Evidence-Report'
try {
    ...
    Export-HtmlReport -Title 'Microsoft365 Repair Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microsoft365 Repair Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
