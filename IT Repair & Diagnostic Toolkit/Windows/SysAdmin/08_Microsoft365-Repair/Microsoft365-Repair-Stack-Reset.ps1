...
<#
.SYNOPSIS
    Common problem fix: Microsoft365 Repair Stack Reset
.DESCRIPTION
...
.EXAMPLE
    .\Microsoft365-Repair-Stack-Reset.ps1
.EXAMPLE
    .\Microsoft365-Repair-Stack-Reset.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microsoft365 Repair Stack Reset'; $totalSteps = 8; $Name = 'Microsoft365-Repair-Stack-Reset'
try {
    ...
    Export-HtmlReport -Title 'Microsoft365 Repair Stack Reset' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microsoft365 Repair Stack Reset' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
