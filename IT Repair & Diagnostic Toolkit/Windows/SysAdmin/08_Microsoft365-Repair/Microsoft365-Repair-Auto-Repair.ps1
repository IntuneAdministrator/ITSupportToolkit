...
<#
.SYNOPSIS
    Common problem fix: Microsoft365 Repair Auto Repair
.DESCRIPTION
...
.EXAMPLE
    .\Microsoft365-Repair-Auto-Repair.ps1
.EXAMPLE
    .\Microsoft365-Repair-Auto-Repair.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microsoft365 Repair Auto Repair'; $totalSteps = 8; $Name = 'Microsoft365-Repair-Auto-Repair'
try {
    ...
    Export-HtmlReport -Title 'Microsoft365 Repair Auto Repair' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microsoft365 Repair Auto Repair' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
