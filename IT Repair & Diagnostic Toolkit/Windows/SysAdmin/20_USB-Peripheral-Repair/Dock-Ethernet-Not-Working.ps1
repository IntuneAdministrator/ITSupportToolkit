...
<#
.SYNOPSIS
    Common problem fix: Dock Ethernet Not Working
.DESCRIPTION
...
.EXAMPLE
    .\Dock-Ethernet-Not-Working.ps1
.EXAMPLE
    .\Dock-Ethernet-Not-Working.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Dock Ethernet Not Working'; $totalSteps = 8; $Name = 'Dock-Ethernet-Not-Working'
try {
    ...
    Export-HtmlReport -Title 'Dock Ethernet Not Working' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Dock Ethernet Not Working' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
