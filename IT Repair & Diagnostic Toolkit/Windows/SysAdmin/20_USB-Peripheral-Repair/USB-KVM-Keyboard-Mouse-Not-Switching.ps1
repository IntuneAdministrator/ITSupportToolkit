...
<#
.SYNOPSIS
    Common problem fix: USB KVM Keyboard Mouse Not Switching
.DESCRIPTION
    Phase 13 common-problems module (SysAdmin / 20_USB-Peripheral-Repair). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\USB-KVM-Keyboard-Mouse-Not-Switching.ps1
.EXAMPLE
    .\USB-KVM-Keyboard-Mouse-Not-Switching.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'USB KVM Keyboard Mouse Not Switching'; $totalSteps = 8; $Name = 'USB-KVM-Keyboard-Mouse-Not-Switching'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '20_USB-Peripheral-Repair' -Status 'INFO' -Detail 'SysAdmin'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '20_USB-Peripheral-Repair'
    ...
    Export-HtmlReport -Title 'USB KVM Keyboard Mouse Not Switching' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'USB KVM Keyboard Mouse Not Switching' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
