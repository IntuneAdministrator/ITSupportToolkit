<#
.SYNOPSIS
    Removes default Microsoft Store apps on Windows via a GUI tool.

.DESCRIPTION
    This script provides a user interface for removing a list of default Microsoft Store apps on a Windows machine.
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <StackPanel Margin="20" HorizontalAlignment="Center">
        <TextBlock Text="Remove Default Microsoft Store Apps (Windows 25H2)" 
