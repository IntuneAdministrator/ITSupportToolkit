<#
.SYNOPSIS
    WPF GUI for restarting audio services on Windows.

.DESCRIPTION
    This script provides a graphical user interface (GUI) to restart the audio-related services (`AudioEndpointBuilder` and `Audiosrv`) on a Windows system.
