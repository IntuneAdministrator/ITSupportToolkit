<#
.SYNOPSIS
    This script runs a set of system repair tasks (MBR, CHKDSK, SFC, DISM) on a Windows system, with a graphical user interface (GUI) built using XAML and WPF.

.DESCRIPTION
    This script automates several system repair tasks to help fix common system issues in Windows. The script provides a user-friendly GUI for initiating the repair process, which includes:
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Run System Repair Tasks (Loop) (Windows)"
    ...
    <StackPanel Margin="20" HorizontalAlignment="Center">
        <TextBlock Text="Run System Repair Tasks (Loop) (Windows)" 
