...
<#
.SYNOPSIS
    Common problem fix: End of Life Migration Policy Validate
.DESCRIPTION
    Phase 13 common-problems module (SysAdmin / 33_End-of-Life-Migration). Join-state aware, Intune-compatible,
    transcript log + dark HTML report. Use -WhatIf to preview changes.
.EXAMPLE
    .\End-of-Life-Migration-Policy-Validate.ps1
.EXAMPLE
    .\End-of-Life-Migration-Policy-Validate.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'End of Life Migration Policy Validate'; $totalSteps = 8; $Name = 'End-of-Life-Migration-Policy-Validate'
try {
    ...
    Add-ReportRow -Check 'Module' -Result '33_End-of-Life-Migration' -Status 'INFO' -Detail 'SysAdmin'
        ...
        Add-ReportRow -Check 'Script' -Result $Name -Status 'INFO' -Detail '33_End-of-Life-Migration'
    ...
    Export-HtmlReport -Title 'End of Life Migration Policy Validate' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'End of Life Migration Policy Validate' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
