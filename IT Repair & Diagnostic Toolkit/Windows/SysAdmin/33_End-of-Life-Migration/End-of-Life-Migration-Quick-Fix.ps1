...
<#
.SYNOPSIS
    Common problem fix: End of Life Migration Quick Fix
.DESCRIPTION
...
.EXAMPLE
    .\End-of-Life-Migration-Quick-Fix.ps1
.EXAMPLE
    .\End-of-Life-Migration-Quick-Fix.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'End of Life Migration Quick Fix'; $totalSteps = 8; $Name = 'End-of-Life-Migration-Quick-Fix'
try {
    ...
    Export-HtmlReport -Title 'End of Life Migration Quick Fix' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'End of Life Migration Quick Fix' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
