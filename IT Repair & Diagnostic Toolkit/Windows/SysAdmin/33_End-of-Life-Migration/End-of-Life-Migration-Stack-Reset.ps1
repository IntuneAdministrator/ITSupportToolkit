...
<#
.SYNOPSIS
    Common problem fix: End of Life Migration Stack Reset
.DESCRIPTION
...
.EXAMPLE
    .\End-of-Life-Migration-Stack-Reset.ps1
.EXAMPLE
    .\End-of-Life-Migration-Stack-Reset.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'End of Life Migration Stack Reset'; $totalSteps = 8; $Name = 'End-of-Life-Migration-Stack-Reset'
try {
    ...
    Export-HtmlReport -Title 'End of Life Migration Stack Reset' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'End of Life Migration Stack Reset' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
