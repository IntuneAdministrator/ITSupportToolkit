...
<#
.SYNOPSIS
    Common problem fix: End of Life Migration Evidence Report
.DESCRIPTION
...
.EXAMPLE
    .\End-of-Life-Migration-Evidence-Report.ps1
.EXAMPLE
    .\End-of-Life-Migration-Evidence-Report.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'End of Life Migration Evidence Report'; $totalSteps = 8; $Name = 'End-of-Life-Migration-Evidence-Report'
try {
    ...
    Export-HtmlReport -Title 'End of Life Migration Evidence Report' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'End of Life Migration Evidence Report' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
