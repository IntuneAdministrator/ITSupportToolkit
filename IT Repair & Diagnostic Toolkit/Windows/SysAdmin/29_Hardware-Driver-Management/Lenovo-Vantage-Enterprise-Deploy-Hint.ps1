...
<#
.SYNOPSIS
    Common problem fix: Lenovo Vantage Enterprise Deploy Hint
.DESCRIPTION
...
.EXAMPLE
    .\Lenovo-Vantage-Enterprise-Deploy-Hint.ps1
.EXAMPLE
    .\Lenovo-Vantage-Enterprise-Deploy-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Lenovo Vantage Enterprise Deploy Hint'; $totalSteps = 8; $Name = 'Lenovo-Vantage-Enterprise-Deploy-Hint'
try {
    ...
    Export-HtmlReport -Title 'Lenovo Vantage Enterprise Deploy Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Lenovo Vantage Enterprise Deploy Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
