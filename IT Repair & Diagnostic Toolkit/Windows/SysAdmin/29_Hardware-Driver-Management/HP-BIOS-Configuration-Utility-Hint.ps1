...
<#
.SYNOPSIS
    Common problem fix: HP BIOS Configuration Utility Hint
.DESCRIPTION
...
.EXAMPLE
    .\HP-BIOS-Configuration-Utility-Hint.ps1
.EXAMPLE
    .\HP-BIOS-Configuration-Utility-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'HP BIOS Configuration Utility Hint'; $totalSteps = 8; $Name = 'HP-BIOS-Configuration-Utility-Hint'
try {
    ...
    Export-HtmlReport -Title 'HP BIOS Configuration Utility Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'HP BIOS Configuration Utility Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
