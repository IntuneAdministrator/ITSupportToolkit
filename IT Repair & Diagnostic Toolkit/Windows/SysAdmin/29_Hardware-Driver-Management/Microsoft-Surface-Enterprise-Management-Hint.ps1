...
<#
.SYNOPSIS
    Common problem fix: Microsoft Surface Enterprise Management Hint
.DESCRIPTION
...
.EXAMPLE
    .\Microsoft-Surface-Enterprise-Management-Hint.ps1
.EXAMPLE
    .\Microsoft-Surface-Enterprise-Management-Hint.ps1 -WhatIf
.NOTES
...
$exitCode = 0; $Activity = 'Microsoft Surface Enterprise Management Hint'; $totalSteps = 8; $Name = 'Microsoft-Surface-Enterprise-Management-Hint'
try {
    ...
    Export-HtmlReport -Title 'Microsoft Surface Enterprise Management Hint' -JoinState $Join.Label -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null
    ...
    try { Add-ReportRow -Check 'Fatal' -Result 'Exception' -Status 'FAIL' -Detail $_.Exception.Message; Export-HtmlReport -Title 'Microsoft Surface Enterprise Management Hint' -JoinState 'Unknown' -ComputerName $env:COMPUTERNAME -LogPath $LogPath -ScriptFileName $ScriptName -ReportPath $ReportPath | Out-Null } catch {}
    $exitCode = 2
