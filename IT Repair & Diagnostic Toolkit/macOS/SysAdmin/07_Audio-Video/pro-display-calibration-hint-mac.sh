...
# ============================================================
# Script: pro-display-calibration-hint-mac.sh | Phase 13 common problems | SysAdmin/07_Audio-Video
# Requires: sudo | Usage: sudo zsh pro-display-calibration-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "pro display calibration hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive