#!/bin/zsh
# ============================================================
# Script:      multiple-display-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for multiple display reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh multiple-display-reset.sh
...
export_html_report "multiple display reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
