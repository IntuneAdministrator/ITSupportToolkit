#!/bin/zsh
# ============================================================
# Script:      webcam-tcc-permission-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for webcam tcc permission reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh webcam-tcc-permission-reset.sh
...
export_html_report "webcam tcc permission reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
