#!/bin/zsh
# ============================================================
# Script:      continuity-camera-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for continuity camera repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh continuity-camera-repair.sh
...
export_html_report "continuity camera repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
