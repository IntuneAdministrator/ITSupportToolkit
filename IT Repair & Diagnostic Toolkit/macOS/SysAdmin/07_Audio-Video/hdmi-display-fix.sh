#!/bin/zsh
# ============================================================
# Script:      hdmi-display-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for hdmi display fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh hdmi-display-fix.sh
...
export_html_report "hdmi display fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
