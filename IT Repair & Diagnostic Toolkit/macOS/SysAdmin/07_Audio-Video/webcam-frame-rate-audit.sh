#!/bin/zsh
# ============================================================
# Script:      webcam-frame-rate-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for webcam frame rate audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh webcam-frame-rate-audit.sh
...
export_html_report "webcam frame rate audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
