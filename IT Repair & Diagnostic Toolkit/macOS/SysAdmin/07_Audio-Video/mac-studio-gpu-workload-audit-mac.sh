...
# ============================================================
# Script: mac-studio-gpu-workload-audit-mac.sh | Phase 13 common problems | SysAdmin/07_Audio-Video
# Requires: sudo | Usage: sudo zsh mac-studio-gpu-workload-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mac studio gpu workload audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive