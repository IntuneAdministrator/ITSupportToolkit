#!/bin/zsh
# ============================================================
# Script:      bluetooth-audio-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for bluetooth audio repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh bluetooth-audio-repair.sh
...
export_html_report "bluetooth audio repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
