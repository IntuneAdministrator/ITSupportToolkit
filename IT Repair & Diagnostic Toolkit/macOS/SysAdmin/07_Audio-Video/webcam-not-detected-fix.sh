#!/bin/zsh
# ============================================================
# Script:      webcam-not-detected-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for webcam not detected fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh webcam-not-detected-fix.sh
...
export_html_report "webcam not detected fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
