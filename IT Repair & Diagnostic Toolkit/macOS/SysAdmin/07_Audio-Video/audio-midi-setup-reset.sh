#!/bin/zsh
# ============================================================
# Script:      audio-midi-setup-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for audio midi setup reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh audio-midi-setup-reset.sh
...
export_html_report "audio midi setup reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
