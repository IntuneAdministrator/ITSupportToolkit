#!/bin/zsh
# ============================================================
# Script:      hdmi-audio-output-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for hdmi audio output fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh hdmi-audio-output-fix.sh
...
export_html_report "hdmi audio output fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
