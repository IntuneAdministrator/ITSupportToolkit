#!/bin/zsh
# ============================================================
# Script:      microphone-permission-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for microphone permission reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh microphone-permission-reset.sh
...
export_html_report "microphone permission reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
