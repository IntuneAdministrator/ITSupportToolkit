...
# ============================================================
# Script: audio-video-health-triage-mac.sh | Phase 13 common problems | SysAdmin/07_Audio-Video
# Requires: sudo | Usage: sudo zsh audio-video-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "audio video health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive