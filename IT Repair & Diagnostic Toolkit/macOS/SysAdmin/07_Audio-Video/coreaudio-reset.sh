#!/bin/zsh
# ============================================================
# Script:      coreaudio-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for coreaudio reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh coreaudio-reset.sh
...
export_html_report "coreaudio reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
