#!/bin/zsh
# ============================================================
# Script:      facetime-camera-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for facetime camera repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh facetime-camera-repair.sh
...
export_html_report "facetime camera repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
