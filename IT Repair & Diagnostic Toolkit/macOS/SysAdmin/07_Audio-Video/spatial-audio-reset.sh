#!/bin/zsh
# ============================================================
# Script:      spatial-audio-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for spatial audio reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh spatial-audio-reset.sh
...
export_html_report "spatial audio reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
