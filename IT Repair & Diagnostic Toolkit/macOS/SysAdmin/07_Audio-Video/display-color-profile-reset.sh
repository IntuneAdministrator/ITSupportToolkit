#!/bin/zsh
# ============================================================
# Script:      display-color-profile-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for display color profile reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh display-color-profile-reset.sh
...
export_html_report "display color profile reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
