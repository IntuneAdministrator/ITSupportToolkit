#!/bin/zsh
# ============================================================
# Script:      audio-input-device-selector.sh
# Description: Production macOS SysAdmin repair/diagnostic for audio input device selector.
...
# Requires:    sudo / root
# Usage:       sudo zsh audio-input-device-selector.sh
...
export_html_report "audio input device selector" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
