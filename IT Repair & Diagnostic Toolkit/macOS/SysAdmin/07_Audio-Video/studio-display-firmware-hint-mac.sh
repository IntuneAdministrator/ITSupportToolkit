...
# ============================================================
# Script: studio-display-firmware-hint-mac.sh | Phase 13 common problems | SysAdmin/07_Audio-Video
# Requires: sudo | Usage: sudo zsh studio-display-firmware-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "studio display firmware hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive