#!/bin/zsh
# ============================================================
# Script:      camera-permission-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for camera permission reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh camera-permission-reset.sh
...
export_html_report "camera permission reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
