...
# ============================================================
# Script: m-series-thermal-throttle-audit-mac.sh | Phase 13 common problems | SysAdmin/07_Audio-Video
# Requires: sudo | Usage: sudo zsh m-series-thermal-throttle-audit-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='07_Audio-Video'
...
add_report_row "Module" "07_Audio-Video" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "07_Audio-Video"
...
export_html_report "m series thermal throttle audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive