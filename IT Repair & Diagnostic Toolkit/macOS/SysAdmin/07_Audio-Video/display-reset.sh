#!/bin/zsh
# ============================================================
# Script:      display-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for display reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh display-reset.sh
...
export_html_report "display reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
