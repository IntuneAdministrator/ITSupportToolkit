...
# ============================================================
# Script: exo-forwarding-audit-mac.sh | SysAdmin/32_M365-Exchange-Online-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh exo-forwarding-audit-mac.sh [user@domain.com]
...
export_html_report "exo forwarding audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive