...
# ============================================================
# Script: m365-exchange-online-admin-mac-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/32_M365-Exchange-Online-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-exchange-online-admin-mac-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 exchange online admin mac auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive