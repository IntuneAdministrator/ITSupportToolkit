...
# ============================================================
# Script: m365-exchange-online-admin-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/32_M365-Exchange-Online-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-exchange-online-admin-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='32_M365-Exchange-Online-Admin-Mac'
...
add_report_row "Module" "32_M365-Exchange-Online-Admin-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "32_M365-Exchange-Online-Admin-Mac"
...
export_html_report "m365 exchange online admin mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive