...
# ============================================================
# Script: transparency-consent-tcc-export.sh | SysAdmin/21_Endpoint-Security-Mac-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh transparency-consent-tcc-export.sh
# ============================================================
set -euo pipefail
...
export_html_report "transparency consent tcc export" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive