...
# ============================================================
# Script: full-disk-access-helper-list.sh | SysAdmin/21_Endpoint-Security-Mac-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh full-disk-access-helper-list.sh
# ============================================================
set -euo pipefail
...
export_html_report "full disk access helper list" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive