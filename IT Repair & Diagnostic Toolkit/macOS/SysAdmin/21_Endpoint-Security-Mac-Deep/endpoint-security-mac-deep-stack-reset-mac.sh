...
# ============================================================
# Script: endpoint-security-mac-deep-stack-reset-mac.sh | Phase 13 common problems | SysAdmin/21_Endpoint-Security-Mac-Deep
# Requires: sudo | Usage: sudo zsh endpoint-security-mac-deep-stack-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "endpoint security mac deep stack reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive