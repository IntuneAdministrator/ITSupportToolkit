...
# ============================================================
# Script: endpoint-security-mac-deep-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/21_Endpoint-Security-Mac-Deep
# Requires: sudo | Usage: sudo zsh endpoint-security-mac-deep-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='21_Endpoint-Security-Mac-Deep'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "21_Endpoint-Security-Mac-Deep"
...
export_html_report "endpoint security mac deep evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive