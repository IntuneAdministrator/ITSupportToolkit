...
# ============================================================
# Script: endpoint-security-system-extension.sh | SysAdmin/21_Endpoint-Security-Mac-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh endpoint-security-system-extension.sh
# ============================================================
set -euo pipefail
...
export_html_report "endpoint security system extension" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive