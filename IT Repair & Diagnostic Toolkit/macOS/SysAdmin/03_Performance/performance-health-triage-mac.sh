...
# ============================================================
# Script: performance-health-triage-mac.sh | Phase 13 common problems | SysAdmin/03_Performance
# Requires: sudo | Usage: sudo zsh performance-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "performance health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive