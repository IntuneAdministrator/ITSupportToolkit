#!/bin/zsh
# ============================================================
# Script:      thermal-throttle-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for thermal throttle check.
...
# Requires:    sudo / root
# Usage:       sudo zsh thermal-throttle-check.sh
...
export_html_report "thermal throttle check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
