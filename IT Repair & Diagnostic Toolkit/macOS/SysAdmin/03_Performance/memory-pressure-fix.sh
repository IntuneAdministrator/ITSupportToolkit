#!/bin/zsh
# ============================================================
# Script:      memory-pressure-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for memory pressure fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh memory-pressure-fix.sh
...
export_html_report "memory pressure fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
