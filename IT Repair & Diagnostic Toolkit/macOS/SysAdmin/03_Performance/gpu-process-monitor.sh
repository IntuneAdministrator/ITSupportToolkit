#!/bin/zsh
# ============================================================
# Script:      gpu-process-monitor.sh
# Description: Production macOS SysAdmin repair/diagnostic for gpu process monitor.
...
# Requires:    sudo / root
# Usage:       sudo zsh gpu-process-monitor.sh
...
export_html_report "gpu process monitor" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
