...
# ============================================================
# Script: memory-pressure-deep-audit.sh | Phase 13 common problems | SysAdmin/03_Performance
# Requires: sudo | Usage: sudo zsh memory-pressure-deep-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "memory pressure deep audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive