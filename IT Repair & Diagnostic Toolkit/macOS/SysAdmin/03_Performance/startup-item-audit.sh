#!/bin/zsh
# ============================================================
# Script:      startup-item-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for startup item audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh startup-item-audit.sh
...
export_html_report "startup item audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
