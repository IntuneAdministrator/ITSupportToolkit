#!/bin/zsh
# ============================================================
# Script:      loginwindow-optimization.sh
# Description: Production macOS SysAdmin repair/diagnostic for loginwindow optimization.
...
# Requires:    sudo / root
# Usage:       sudo zsh loginwindow-optimization.sh
...
export_html_report "loginwindow optimization" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
