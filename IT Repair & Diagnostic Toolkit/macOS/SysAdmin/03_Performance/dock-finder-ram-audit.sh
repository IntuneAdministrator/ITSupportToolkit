#!/bin/zsh
# ============================================================
# Script:      dock-finder-ram-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for dock finder ram audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh dock-finder-ram-audit.sh
...
export_html_report "dock finder ram audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
