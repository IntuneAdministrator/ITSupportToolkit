#!/bin/zsh
# ============================================================
# Script:      launch-services-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for launch services reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh launch-services-reset.sh
...
export_html_report "launch services reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
