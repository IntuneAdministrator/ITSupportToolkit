#!/bin/zsh
# ============================================================
# Script:      swap-pressure-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for swap pressure report.
...
# Requires:    sudo / root
# Usage:       sudo zsh swap-pressure-report.sh
...
export_html_report "swap pressure report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
