...
# ============================================================
# Script: kernel-task-high-cpu-audit.sh | Phase 13 common problems | SysAdmin/03_Performance
# Requires: sudo | Usage: sudo zsh kernel-task-high-cpu-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "kernel task high cpu audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive