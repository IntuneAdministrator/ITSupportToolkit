...
# ============================================================
# Script: swap-file-pressure-check.sh | Phase 13 common problems | SysAdmin/03_Performance
# Requires: sudo | Usage: sudo zsh swap-file-pressure-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "swap file pressure check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive