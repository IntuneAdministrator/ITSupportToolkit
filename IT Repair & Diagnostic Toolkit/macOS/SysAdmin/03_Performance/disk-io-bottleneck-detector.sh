#!/bin/zsh
# ============================================================
# Script:      disk-io-bottleneck-detector.sh
# Description: Production macOS SysAdmin repair/diagnostic for disk io bottleneck detector.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-io-bottleneck-detector.sh
...
export_html_report "disk io bottleneck detector" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
