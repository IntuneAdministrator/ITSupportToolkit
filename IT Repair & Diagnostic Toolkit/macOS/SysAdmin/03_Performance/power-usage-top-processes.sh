#!/bin/zsh
# ============================================================
# Script:      power-usage-top-processes.sh
# Description: Production macOS SysAdmin repair/diagnostic for power usage top processes.
...
# Requires:    sudo / root
# Usage:       sudo zsh power-usage-top-processes.sh
...
export_html_report "power usage top processes" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
