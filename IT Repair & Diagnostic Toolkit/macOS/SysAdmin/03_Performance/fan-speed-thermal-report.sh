#!/bin/zsh
# ============================================================
# Script:      fan-speed-thermal-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for fan speed thermal report.
...
# Requires:    sudo / root
# Usage:       sudo zsh fan-speed-thermal-report.sh
...
export_html_report "fan speed thermal report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
