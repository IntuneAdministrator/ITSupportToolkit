#!/bin/zsh
# ============================================================
# Script:      spotlight-reindex.sh
# Description: Production macOS SysAdmin repair/diagnostic for spotlight reindex.
...
# Requires:    sudo / root
# Usage:       sudo zsh spotlight-reindex.sh
...
export_html_report "spotlight reindex" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
