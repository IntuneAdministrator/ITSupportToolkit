#!/bin/zsh
# ============================================================
# Script:      kernel-extension-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for kernel extension audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh kernel-extension-audit.sh
...
export_html_report "kernel extension audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
