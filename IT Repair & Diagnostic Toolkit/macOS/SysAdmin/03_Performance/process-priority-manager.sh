#!/bin/zsh
# ============================================================
# Script:      process-priority-manager.sh
# Description: Production macOS SysAdmin repair/diagnostic for process priority manager.
...
# Requires:    sudo / root
# Usage:       sudo zsh process-priority-manager.sh
...
export_html_report "process priority manager" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
