...
# ============================================================
# Script: performance-quick-fix-mac.sh | Phase 13 common problems | SysAdmin/03_Performance
# Requires: sudo | Usage: sudo zsh performance-quick-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "performance quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive