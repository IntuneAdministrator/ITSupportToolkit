#!/bin/zsh
# ============================================================
# Script:      background-app-throttle.sh
# Description: Production macOS SysAdmin repair/diagnostic for background app throttle.
...
# Requires:    sudo / root
# Usage:       sudo zsh background-app-throttle.sh
...
export_html_report "background app throttle" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
