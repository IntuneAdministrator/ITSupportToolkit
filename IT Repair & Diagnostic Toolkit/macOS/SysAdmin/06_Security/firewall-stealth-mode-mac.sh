...
# ============================================================
# Script: firewall-stealth-mode-mac.sh | Phase 13 common problems | SysAdmin/06_Security
# Requires: sudo | Usage: sudo zsh firewall-stealth-mode-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "firewall stealth mode mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive