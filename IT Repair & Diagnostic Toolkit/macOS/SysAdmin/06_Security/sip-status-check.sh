#!/bin/zsh
# ============================================================
# Script:      sip-status-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for sip status check.
...
# Requires:    sudo / root
# Usage:       sudo zsh sip-status-check.sh
...
export_html_report "sip status check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
