#!/bin/zsh
# ============================================================
# Script:      remote-login-ssh-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for remote login ssh audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh remote-login-ssh-audit.sh
...
export_html_report "remote login ssh audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
