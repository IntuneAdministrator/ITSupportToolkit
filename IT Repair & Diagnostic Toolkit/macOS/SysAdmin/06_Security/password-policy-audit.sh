#!/bin/zsh
# ============================================================
# Script:      password-policy-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for password policy audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh password-policy-audit.sh
...
export_html_report "password policy audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
