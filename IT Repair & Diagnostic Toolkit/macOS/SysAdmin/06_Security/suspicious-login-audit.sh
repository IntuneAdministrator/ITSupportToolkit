#!/bin/zsh
# ============================================================
# Script:      suspicious-login-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for suspicious login audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh suspicious-login-audit.sh
...
export_html_report "suspicious login audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
