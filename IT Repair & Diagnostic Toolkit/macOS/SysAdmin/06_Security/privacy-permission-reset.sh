#!/bin/zsh
# ============================================================
# Script:      privacy-permission-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for privacy permission reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh privacy-permission-reset.sh
...
export_html_report "privacy permission reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
