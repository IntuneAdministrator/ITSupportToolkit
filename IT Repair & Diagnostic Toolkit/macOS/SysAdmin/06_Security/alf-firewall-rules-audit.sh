#!/bin/zsh
# ============================================================
# Script:      alf-firewall-rules-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for alf firewall rules audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh alf-firewall-rules-audit.sh
...
export_html_report "alf firewall rules audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
