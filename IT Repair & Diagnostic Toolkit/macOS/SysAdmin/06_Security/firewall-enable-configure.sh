#!/bin/zsh
# ============================================================
# Script:      firewall-enable-configure.sh
# Description: Production macOS SysAdmin repair/diagnostic for firewall enable configure.
...
# Requires:    sudo / root
# Usage:       sudo zsh firewall-enable-configure.sh
...
export_html_report "firewall enable configure" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
