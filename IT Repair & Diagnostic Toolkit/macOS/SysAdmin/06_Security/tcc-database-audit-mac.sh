...
# ============================================================
# Script: tcc-database-audit-mac.sh | Phase 13 common problems | SysAdmin/06_Security
# Requires: sudo | Usage: sudo zsh tcc-database-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "tcc database audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive