#!/bin/zsh
# ============================================================
# Script:      secure-boot-mac-status.sh
# Description: Production macOS SysAdmin repair/diagnostic for secure boot mac status.
...
# Requires:    sudo / root
# Usage:       sudo zsh secure-boot-mac-status.sh
...
export_html_report "secure boot mac status" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
