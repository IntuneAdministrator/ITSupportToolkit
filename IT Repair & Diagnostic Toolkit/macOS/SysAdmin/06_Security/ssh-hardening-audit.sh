#!/bin/zsh
# ============================================================
# Script:      ssh-hardening-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for ssh hardening audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh ssh-hardening-audit.sh
...
export_html_report "ssh hardening audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
