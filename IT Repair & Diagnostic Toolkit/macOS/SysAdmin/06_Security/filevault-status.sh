#!/bin/zsh
# ============================================================
# Script:      filevault-status.sh
# Description: Production macOS SysAdmin repair/diagnostic for filevault status.
...
# Requires:    sudo / root
# Usage:       sudo zsh filevault-status.sh
...
export_html_report "filevault status" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
