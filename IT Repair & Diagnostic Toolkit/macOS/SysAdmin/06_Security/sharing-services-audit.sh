#!/bin/zsh
# ============================================================
# Script:      sharing-services-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for sharing services audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh sharing-services-audit.sh
...
export_html_report "sharing services audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
