#!/bin/zsh
# ============================================================
# Script:      sudoers-integrity-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for sudoers integrity check.
...
# Requires:    sudo / root
# Usage:       sudo zsh sudoers-integrity-check.sh
...
export_html_report "sudoers integrity check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
