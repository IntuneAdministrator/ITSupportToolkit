#!/bin/zsh
# ============================================================
# Script:      xprotect-update-force.sh
# Description: Production macOS SysAdmin repair/diagnostic for xprotect update force.
...
# Requires:    sudo / root
# Usage:       sudo zsh xprotect-update-force.sh
...
export_html_report "xprotect update force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
