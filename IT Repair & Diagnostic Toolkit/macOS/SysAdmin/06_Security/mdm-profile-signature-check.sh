#!/bin/zsh
# ============================================================
# Script:      mdm-profile-signature-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm profile signature check.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-profile-signature-check.sh
...
export_html_report "mdm profile signature check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
