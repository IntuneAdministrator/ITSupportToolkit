#!/bin/zsh
# ============================================================
# Script:      gatekeeper-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for gatekeeper audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh gatekeeper-audit.sh
...
export_html_report "gatekeeper audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
