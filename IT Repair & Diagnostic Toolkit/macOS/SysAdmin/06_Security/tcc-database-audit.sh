#!/bin/zsh
# ============================================================
# Script:      tcc-database-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for tcc database audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh tcc-database-audit.sh
...
export_html_report "tcc database audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
