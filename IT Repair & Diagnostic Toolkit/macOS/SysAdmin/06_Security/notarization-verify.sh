#!/bin/zsh
# ============================================================
# Script:      notarization-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for notarization verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh notarization-verify.sh
...
export_html_report "notarization verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
