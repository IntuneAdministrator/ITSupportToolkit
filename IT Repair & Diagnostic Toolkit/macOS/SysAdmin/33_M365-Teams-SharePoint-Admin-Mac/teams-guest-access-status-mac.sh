...
# ============================================================
# Script: teams-guest-access-status-mac.sh | SysAdmin/33_M365-Teams-SharePoint-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh teams-guest-access-status-mac.sh [user@domain.com]
...
export_html_report "teams guest access status mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive