...
# ============================================================
# Script: m365-teams-sharepoint-admin-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/33_M365-Teams-SharePoint-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-teams-sharepoint-admin-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='33_M365-Teams-SharePoint-Admin-Mac'
...
add_report_row "Module" "33_M365-Teams-SharePoint-Admin-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "33_M365-Teams-SharePoint-Admin-Mac"
...
export_html_report "m365 teams sharepoint admin mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive