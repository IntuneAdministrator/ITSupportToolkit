...
# ============================================================
# Script: spo-site-lookup-prep-mac.sh | SysAdmin/33_M365-Teams-SharePoint-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh spo-site-lookup-prep-mac.sh [user@domain.com]
...
export_html_report "spo site lookup prep mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive