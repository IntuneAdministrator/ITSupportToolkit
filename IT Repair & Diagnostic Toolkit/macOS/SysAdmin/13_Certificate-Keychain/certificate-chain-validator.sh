#!/bin/zsh
# ============================================================
# Script:      certificate-chain-validator.sh
# Description: Production macOS SysAdmin repair/diagnostic for certificate chain validator.
...
# Requires:    sudo / root
# Usage:       sudo zsh certificate-chain-validator.sh
...
export_html_report "certificate chain validator" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
