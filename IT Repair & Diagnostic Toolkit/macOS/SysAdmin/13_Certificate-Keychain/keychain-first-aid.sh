#!/bin/zsh
# ============================================================
# Script:      keychain-first-aid.sh
# Description: Production macOS SysAdmin repair/diagnostic for keychain first aid.
...
# Requires:    sudo / root
# Usage:       sudo zsh keychain-first-aid.sh
...
export_html_report "keychain first aid" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
