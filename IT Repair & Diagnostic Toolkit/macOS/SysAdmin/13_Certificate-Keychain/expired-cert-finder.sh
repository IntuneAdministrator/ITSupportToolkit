#!/bin/zsh
# ============================================================
# Script:      expired-cert-finder.sh
# Description: Production macOS SysAdmin repair/diagnostic for expired cert finder.
...
# Requires:    sudo / root
# Usage:       sudo zsh expired-cert-finder.sh
...
export_html_report "expired cert finder" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
