...
# ============================================================
# Script: certificate-keychain-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/13_Certificate-Keychain
# Requires: sudo | Usage: sudo zsh certificate-keychain-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='13_Certificate-Keychain'
...
add_report_row "Module" "13_Certificate-Keychain" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "13_Certificate-Keychain"
...
export_html_report "certificate keychain policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive