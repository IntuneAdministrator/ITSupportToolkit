...
# ============================================================
# Script: certificate-keychain-stack-reset-mac.sh | Phase 13 common problems | SysAdmin/13_Certificate-Keychain
# Requires: sudo | Usage: sudo zsh certificate-keychain-stack-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "certificate keychain stack reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive