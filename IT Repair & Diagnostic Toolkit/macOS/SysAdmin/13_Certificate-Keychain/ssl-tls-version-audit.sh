#!/bin/zsh
# ============================================================
# Script:      ssl-tls-version-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for ssl tls version audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh ssl-tls-version-audit.sh
...
export_html_report "ssl tls version audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
