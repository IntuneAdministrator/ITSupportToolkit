...
# ============================================================
# Script: smartcard-piv-reader-mac.sh | Phase 13 common problems | SysAdmin/13_Certificate-Keychain
# Requires: sudo | Usage: sudo zsh smartcard-piv-reader-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "smartcard piv reader mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive