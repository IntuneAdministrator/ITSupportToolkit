#!/bin/zsh
# ============================================================
# Script:      mdm-pushed-cert-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm pushed cert verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-pushed-cert-verify.sh
...
export_html_report "mdm pushed cert verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
