#!/bin/zsh
# ============================================================
# Script:      keychain-integrity-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for keychain integrity check.
...
# Requires:    sudo / root
# Usage:       sudo zsh keychain-integrity-check.sh
...
export_html_report "keychain integrity check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
