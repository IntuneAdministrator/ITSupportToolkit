#!/bin/zsh
# ============================================================
# Script:      p12-import-validator.sh
# Description: Production macOS SysAdmin repair/diagnostic for p12 import validator.
...
# Requires:    sudo / root
# Usage:       sudo zsh p12-import-validator.sh
...
export_html_report "p12 import validator" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
