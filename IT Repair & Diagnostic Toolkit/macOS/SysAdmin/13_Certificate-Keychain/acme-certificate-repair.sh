#!/bin/zsh
# ============================================================
# Script:      acme-certificate-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for acme certificate repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh acme-certificate-repair.sh
...
export_html_report "acme certificate repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
