...
# ============================================================
# Script: yubikey-piv-slot-reset-mac.sh | Phase 13 common problems | SysAdmin/13_Certificate-Keychain
# Requires: sudo | Usage: sudo zsh yubikey-piv-slot-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "yubikey piv slot reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive