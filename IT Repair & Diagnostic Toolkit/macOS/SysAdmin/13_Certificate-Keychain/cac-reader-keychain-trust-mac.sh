...
# ============================================================
# Script: cac-reader-keychain-trust-mac.sh | Phase 13 common problems | SysAdmin/13_Certificate-Keychain
# Requires: sudo | Usage: sudo zsh cac-reader-keychain-trust-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "cac reader keychain trust mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive