#!/bin/zsh
# ============================================================
# Script:      ips-file-batch-analyzer.sh
# Description: Production macOS SysAdmin repair/diagnostic for ips file batch analyzer.
...
# Requires:    sudo / root
# Usage:       sudo zsh ips-file-batch-analyzer.sh
...
export_html_report "ips file batch analyzer" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
