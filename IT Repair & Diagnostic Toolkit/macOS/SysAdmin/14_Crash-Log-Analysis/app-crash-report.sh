#!/bin/zsh
# ============================================================
# Script:      app-crash-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for app crash report.
...
# Requires:    sudo / root
# Usage:       sudo zsh app-crash-report.sh
...
export_html_report "app crash report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
