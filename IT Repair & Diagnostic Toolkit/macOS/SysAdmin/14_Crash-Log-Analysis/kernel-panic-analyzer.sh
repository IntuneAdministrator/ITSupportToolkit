#!/bin/zsh
# ============================================================
# Script:      kernel-panic-analyzer.sh
# Description: Production macOS SysAdmin repair/diagnostic for kernel panic analyzer.
...
# Requires:    sudo / root
# Usage:       sudo zsh kernel-panic-analyzer.sh
...
export_html_report "kernel panic analyzer" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
