#!/bin/zsh
# ============================================================
# Script:      crash-log-digest.sh
# Description: Production macOS SysAdmin repair/diagnostic for crash log digest.
...
# Requires:    sudo / root
# Usage:       sudo zsh crash-log-digest.sh
...
export_html_report "crash log digest" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
