...
# ============================================================
# Script: crash-log-analysis-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/14_Crash-Log-Analysis
# Requires: sudo | Usage: sudo zsh crash-log-analysis-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='14_Crash-Log-Analysis'
...
add_report_row "Module" "14_Crash-Log-Analysis" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "14_Crash-Log-Analysis"
...
export_html_report "crash log analysis policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive