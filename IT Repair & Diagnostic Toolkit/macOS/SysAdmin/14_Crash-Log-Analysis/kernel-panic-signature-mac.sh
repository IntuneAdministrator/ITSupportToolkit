...
# ============================================================
# Script: kernel-panic-signature-mac.sh | Phase 13 common problems | SysAdmin/14_Crash-Log-Analysis
# Requires: sudo | Usage: sudo zsh kernel-panic-signature-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "kernel panic signature mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive