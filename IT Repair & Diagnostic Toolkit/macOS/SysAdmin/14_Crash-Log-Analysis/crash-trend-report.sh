#!/bin/zsh
# ============================================================
# Script:      crash-trend-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for crash trend report.
...
# Requires:    sudo / root
# Usage:       sudo zsh crash-trend-report.sh
...
export_html_report "crash trend report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
