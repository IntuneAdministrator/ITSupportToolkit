#!/bin/zsh
# ============================================================
# Script:      hang-report-digest.sh
# Description: Production macOS SysAdmin repair/diagnostic for hang report digest.
...
# Requires:    sudo / root
# Usage:       sudo zsh hang-report-digest.sh
...
export_html_report "hang report digest" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
