#!/bin/zsh
# ============================================================
# Script:      wakeup-failure-analyzer.sh
# Description: Production macOS SysAdmin repair/diagnostic for wakeup failure analyzer.
...
# Requires:    sudo / root
# Usage:       sudo zsh wakeup-failure-analyzer.sh
...
export_html_report "wakeup failure analyzer" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
