#!/bin/zsh
# ============================================================
# Script:      gpu-panic-detector.sh
# Description: Production macOS SysAdmin repair/diagnostic for gpu panic detector.
...
# Requires:    sudo / root
# Usage:       sudo zsh gpu-panic-detector.sh
...
export_html_report "gpu panic detector" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
