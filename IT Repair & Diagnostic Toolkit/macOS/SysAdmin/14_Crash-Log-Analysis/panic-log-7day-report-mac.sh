...
# ============================================================
# Script: panic-log-7day-report-mac.sh | Phase 13 common problems | SysAdmin/14_Crash-Log-Analysis
# Requires: sudo | Usage: sudo zsh panic-log-7day-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "panic log 7day report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive