...
# ============================================================
# Script: webview-helper-repair-mac.sh | Role: SysAdmin/18_Enterprise-Browser-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh webview-helper-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "webview helper repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive