...
# ============================================================
# Script: enterprise-browser-mac-health-triage-mac.sh | Phase 13 common problems | SysAdmin/18_Enterprise-Browser-Mac
# Requires: sudo | Usage: sudo zsh enterprise-browser-mac-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "enterprise browser mac health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive