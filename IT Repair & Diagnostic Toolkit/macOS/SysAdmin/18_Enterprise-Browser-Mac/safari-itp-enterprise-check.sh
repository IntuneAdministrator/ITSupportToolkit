...
# ============================================================
# Script: safari-itp-enterprise-check.sh | Role: SysAdmin/18_Enterprise-Browser-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh safari-itp-enterprise-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "safari itp enterprise check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive