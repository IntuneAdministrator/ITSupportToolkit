...
# ============================================================
# Script: chrome-mac-enterprise-audit.sh | Role: SysAdmin/18_Enterprise-Browser-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh chrome-mac-enterprise-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "chrome mac enterprise audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive