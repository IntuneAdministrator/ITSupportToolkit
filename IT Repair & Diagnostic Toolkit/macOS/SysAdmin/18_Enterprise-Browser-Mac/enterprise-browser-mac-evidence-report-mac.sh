...
# ============================================================
# Script: enterprise-browser-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/18_Enterprise-Browser-Mac
# Requires: sudo | Usage: sudo zsh enterprise-browser-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "18_Enterprise-Browser-Mac"
...
export_html_report "enterprise browser mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive