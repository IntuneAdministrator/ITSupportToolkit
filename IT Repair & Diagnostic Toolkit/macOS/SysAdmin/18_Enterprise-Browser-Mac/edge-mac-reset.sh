...
# ============================================================
# Script: edge-mac-reset.sh | Role: SysAdmin/18_Enterprise-Browser-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh edge-mac-reset.sh
# ============================================================
set -euo pipefail
...
export_html_report "edge mac reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive