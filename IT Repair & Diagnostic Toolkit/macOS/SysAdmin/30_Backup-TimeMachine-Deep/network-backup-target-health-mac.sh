...
# ============================================================
# Script: network-backup-target-health-mac.sh | Phase 13 common problems | SysAdmin/30_Backup-TimeMachine-Deep
# Requires: sudo | Usage: sudo zsh network-backup-target-health-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "network backup target health mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive