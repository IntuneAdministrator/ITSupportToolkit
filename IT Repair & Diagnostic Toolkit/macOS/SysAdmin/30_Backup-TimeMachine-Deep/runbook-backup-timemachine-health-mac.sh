...
# ============================================================
# Script: runbook-backup-timemachine-health-mac.sh | Phase 13 common problems | SysAdmin/30_Backup-TimeMachine-Deep
# Requires: sudo | Usage: sudo zsh runbook-backup-timemachine-health-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='30_Backup-TimeMachine-Deep'
...
add_report_row "Module" "30_Backup-TimeMachine-Deep" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "30_Backup-TimeMachine-Deep"
...
export_html_report "runbook backup timemachine health mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive