...
# ============================================================
# Script: local-snapshot-thin-force-mac.sh | SysAdmin/30_Backup-TimeMachine-Deep | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh local-snapshot-thin-force-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "local snapshot thin force mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive