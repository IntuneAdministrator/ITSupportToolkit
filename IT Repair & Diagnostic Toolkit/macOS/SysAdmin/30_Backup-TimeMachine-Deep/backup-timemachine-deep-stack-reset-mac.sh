...
# ============================================================
# Script: backup-timemachine-deep-stack-reset-mac.sh | Phase 13 common problems | SysAdmin/30_Backup-TimeMachine-Deep
# Requires: sudo | Usage: sudo zsh backup-timemachine-deep-stack-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "backup timemachine deep stack reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive