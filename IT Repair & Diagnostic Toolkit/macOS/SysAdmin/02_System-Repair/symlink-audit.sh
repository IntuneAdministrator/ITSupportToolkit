#!/bin/zsh
# ============================================================
# Script:      symlink-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for symlink audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh symlink-audit.sh
...
export_html_report "symlink audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
