#!/bin/zsh
# ============================================================
# Script:      system-file-hash-validator.sh
# Description: Production macOS SysAdmin repair/diagnostic for system file hash validator.
...
# Requires:    sudo / root
# Usage:       sudo zsh system-file-hash-validator.sh
...
export_html_report "system file hash validator" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
