#!/bin/zsh
# ============================================================
# Script:      apfs-snapshot-manage.sh
# Description: Production macOS SysAdmin repair/diagnostic for apfs snapshot manage.
...
# Requires:    sudo / root
# Usage:       sudo zsh apfs-snapshot-manage.sh
...
export_html_report "apfs snapshot manage" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
