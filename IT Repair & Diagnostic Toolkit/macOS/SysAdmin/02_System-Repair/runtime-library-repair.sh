#!/bin/zsh
# ============================================================
# Script:      runtime-library-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for runtime library repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh runtime-library-repair.sh
...
export_html_report "runtime library repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
