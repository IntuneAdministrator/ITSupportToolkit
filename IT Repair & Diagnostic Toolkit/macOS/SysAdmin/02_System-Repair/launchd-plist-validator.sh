#!/bin/zsh
# ============================================================
# Script:      launchd-plist-validator.sh
# Description: Production macOS SysAdmin repair/diagnostic for launchd plist validator.
...
# Requires:    sudo / root
# Usage:       sudo zsh launchd-plist-validator.sh
...
export_html_report "launchd plist validator" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
