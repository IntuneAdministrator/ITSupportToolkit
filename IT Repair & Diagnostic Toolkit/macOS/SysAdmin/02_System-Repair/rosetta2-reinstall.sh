#!/bin/zsh
# ============================================================
# Script:      rosetta2-reinstall.sh
# Description: Production macOS SysAdmin repair/diagnostic for rosetta2 reinstall.
...
# Requires:    sudo / root
# Usage:       sudo zsh rosetta2-reinstall.sh
...
export_html_report "rosetta2 reinstall" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
