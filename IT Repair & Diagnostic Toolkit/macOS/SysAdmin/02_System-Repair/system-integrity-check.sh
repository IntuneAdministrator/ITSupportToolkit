#!/bin/zsh
# ============================================================
# Script:      system-integrity-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for system integrity check.
...
# Requires:    sudo / root
# Usage:       sudo zsh system-integrity-check.sh
...
export_html_report "system integrity check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
