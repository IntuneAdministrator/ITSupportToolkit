...
# ============================================================
# Script: launchservices-database-reset.sh | Phase 13 common problems | SysAdmin/02_System-Repair
# Requires: sudo | Usage: sudo zsh launchservices-database-reset.sh
# ============================================================
set -euo pipefail
...
export_html_report "launchservices database reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive