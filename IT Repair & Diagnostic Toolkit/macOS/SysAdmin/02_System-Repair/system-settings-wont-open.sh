...
# ============================================================
# Script: system-settings-wont-open.sh | Phase 13 common problems | SysAdmin/02_System-Repair
# Requires: sudo | Usage: sudo zsh system-settings-wont-open.sh
# ============================================================
set -euo pipefail
...
export_html_report "system settings wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive