#!/bin/zsh
# ============================================================
# Script:      system-info-full-export.sh
# Description: Production macOS SysAdmin repair/diagnostic for system info full export.
...
# Requires:    sudo / root
# Usage:       sudo zsh system-info-full-export.sh
...
export_html_report "system info full export" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
