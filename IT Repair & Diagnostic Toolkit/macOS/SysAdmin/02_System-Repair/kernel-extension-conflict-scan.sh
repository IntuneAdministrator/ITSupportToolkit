#!/bin/zsh
# ============================================================
# Script:      kernel-extension-conflict-scan.sh
# Description: Production macOS SysAdmin repair/diagnostic for kernel extension conflict scan.
...
# Requires:    sudo / root
# Usage:       sudo zsh kernel-extension-conflict-scan.sh
...
export_html_report "kernel extension conflict scan" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
