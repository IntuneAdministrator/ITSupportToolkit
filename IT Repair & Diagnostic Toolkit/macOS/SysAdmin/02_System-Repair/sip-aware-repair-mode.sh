#!/bin/zsh
# ============================================================
# Script:      sip-aware-repair-mode.sh
# Description: Production macOS SysAdmin repair/diagnostic for sip aware repair mode.
...
# Requires:    sudo / root
# Usage:       sudo zsh sip-aware-repair-mode.sh
...
export_html_report "sip aware repair mode" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
