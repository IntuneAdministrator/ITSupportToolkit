#!/bin/zsh
# ============================================================
# Script:      macos-version-build-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for macos version build report.
...
# Requires:    sudo / root
# Usage:       sudo zsh macos-version-build-report.sh
...
export_html_report "macos version build report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
