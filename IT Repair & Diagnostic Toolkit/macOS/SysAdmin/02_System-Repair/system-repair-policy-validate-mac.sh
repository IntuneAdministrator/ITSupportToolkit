...
# ============================================================
# Script: system-repair-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/02_System-Repair
# Requires: sudo | Usage: sudo zsh system-repair-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "system repair policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive