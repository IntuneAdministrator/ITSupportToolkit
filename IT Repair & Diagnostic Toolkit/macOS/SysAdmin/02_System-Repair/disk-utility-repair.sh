#!/bin/zsh
# ============================================================
# Script:      disk-utility-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for disk utility repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-utility-repair.sh
...
export_html_report "disk utility repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
