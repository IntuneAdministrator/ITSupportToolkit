#!/bin/zsh
# ============================================================
# Script:      permissions-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for permissions repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh permissions-repair.sh
...
export_html_report "permissions repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
