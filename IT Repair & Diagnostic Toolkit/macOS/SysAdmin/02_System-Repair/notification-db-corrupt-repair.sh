...
# ============================================================
# Script: notification-db-corrupt-repair.sh | Phase 13 common problems | SysAdmin/02_System-Repair
# Requires: sudo | Usage: sudo zsh notification-db-corrupt-repair.sh
# ============================================================
set -euo pipefail
...
export_html_report "notification db corrupt repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive