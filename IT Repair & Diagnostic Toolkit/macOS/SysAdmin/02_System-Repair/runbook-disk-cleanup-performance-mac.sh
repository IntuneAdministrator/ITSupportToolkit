...
# ============================================================
# Script: runbook-disk-cleanup-performance-mac.sh | Phase 13 common problems | SysAdmin/02_System-Repair
# Requires: sudo | Usage: sudo zsh runbook-disk-cleanup-performance-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='02_System-Repair'
...
add_report_row "Module" "02_System-Repair" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "02_System-Repair"
...
export_html_report "runbook disk cleanup performance mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive