#!/bin/zsh
# ============================================================
# Script:      temp-file-deep-clean.sh
# Description: Production macOS SysAdmin repair/diagnostic for temp file deep clean.
...
# Requires:    sudo / root
# Usage:       sudo zsh temp-file-deep-clean.sh
...
export_html_report "temp file deep clean" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
