#!/bin/zsh
# ============================================================
# Script:      dyld-cache-rebuild.sh
# Description: Production macOS SysAdmin repair/diagnostic for dyld cache rebuild.
...
# Requires:    sudo / root
# Usage:       sudo zsh dyld-cache-rebuild.sh
...
export_html_report "dyld cache rebuild" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
