#!/bin/zsh
# ============================================================
# Script:      fsck-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for fsck repair.
...
export_html_report "fsck repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
