#!/bin/zsh
# ============================================================
# Script:      macos-reinstall-prep.sh
# Description: Production macOS SysAdmin repair/diagnostic for macos reinstall prep.
...
# Requires:    sudo / root
# Usage:       sudo zsh macos-reinstall-prep.sh
...
export_html_report "macos reinstall prep" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
