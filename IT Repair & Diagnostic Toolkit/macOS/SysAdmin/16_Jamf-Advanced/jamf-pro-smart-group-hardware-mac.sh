...
# ============================================================
# Script: jamf-pro-smart-group-hardware-mac.sh | Phase 13 common problems | SysAdmin/16_Jamf-Advanced
# Requires: sudo | Usage: sudo zsh jamf-pro-smart-group-hardware-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "jamf pro smart group hardware mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive