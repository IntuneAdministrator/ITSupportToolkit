...
# ============================================================
# Script: jamf-log-collector.sh | Role: SysAdmin/16_Jamf-Advanced | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh jamf-log-collector.sh
# ============================================================
set -euo pipefail
...
export_html_report "jamf log collector" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive