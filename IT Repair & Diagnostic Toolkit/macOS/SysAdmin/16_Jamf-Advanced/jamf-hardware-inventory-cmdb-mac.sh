...
# ============================================================
# Script: jamf-hardware-inventory-cmdb-mac.sh | Phase 13 common problems | SysAdmin/16_Jamf-Advanced
# Requires: sudo | Usage: sudo zsh jamf-hardware-inventory-cmdb-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "jamf hardware inventory cmdb mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive