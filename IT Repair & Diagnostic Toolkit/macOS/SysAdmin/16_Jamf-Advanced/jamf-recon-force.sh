...
# ============================================================
# Script: jamf-recon-force.sh | Role: SysAdmin/16_Jamf-Advanced | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh jamf-recon-force.sh
# ============================================================
set -euo pipefail
...
export_html_report "jamf recon force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive