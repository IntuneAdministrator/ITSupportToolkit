...
# ============================================================
# Script: virtualization-framework-audit-mac.sh | SysAdmin/26_Virtualization-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh virtualization-framework-audit-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='26_Virtualization-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "26_Virtualization-Mac" "INFO" "SysAdmin"
...
show_progress 5 "$TOTAL_STEPS" "Virt done"
show_progress "$TOTAL_STEPS" "$TOTAL_STEPS" "Report"
export_html_report "virtualization framework audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive