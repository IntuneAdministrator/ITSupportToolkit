...
# ============================================================
# Script: vmware-fusion-disk-health-mac.sh | Phase 13 common problems | SysAdmin/26_Virtualization-Mac
# Requires: sudo | Usage: sudo zsh vmware-fusion-disk-health-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "vmware fusion disk health mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive