...
# ============================================================
# Script: virtualization-mac-anomaly-detect-mac.sh | Phase 13 common problems | SysAdmin/26_Virtualization-Mac
# Requires: sudo | Usage: sudo zsh virtualization-mac-anomaly-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "virtualization mac anomaly detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive