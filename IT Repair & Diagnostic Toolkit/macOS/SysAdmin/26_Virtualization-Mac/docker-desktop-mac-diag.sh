...
# ============================================================
# Script: docker-desktop-mac-diag.sh | SysAdmin/26_Virtualization-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh docker-desktop-mac-diag.sh
# ============================================================
set -euo pipefail
...
export_html_report "docker desktop mac diag" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive