...
# ============================================================
# Script: parallels-vm-health-hint-mac.sh | SysAdmin/26_Virtualization-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh parallels-vm-health-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "parallels vm health hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive