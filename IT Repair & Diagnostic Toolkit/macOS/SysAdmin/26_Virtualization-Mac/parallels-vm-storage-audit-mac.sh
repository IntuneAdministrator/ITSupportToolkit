...
# ============================================================
# Script: parallels-vm-storage-audit-mac.sh | Phase 13 common problems | SysAdmin/26_Virtualization-Mac
# Requires: sudo | Usage: sudo zsh parallels-vm-storage-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "parallels vm storage audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive