...
# ============================================================
# Script: identity-platform-sso-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/20_Identity-Platform-SSO
# Requires: sudo | Usage: sudo zsh identity-platform-sso-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='20_Identity-Platform-SSO'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "20_Identity-Platform-SSO"
...
export_html_report "identity platform sso evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive