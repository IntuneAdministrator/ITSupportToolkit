...
# ============================================================
# Script: bind-ad-mobile-account-deep.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh bind-ad-mobile-account-deep.sh
# ============================================================
set -euo pipefail
...
export_html_report "bind ad mobile account deep" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive