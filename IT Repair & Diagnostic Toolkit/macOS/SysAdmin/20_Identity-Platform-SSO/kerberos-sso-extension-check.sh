...
# ============================================================
# Script: kerberos-sso-extension-check.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh kerberos-sso-extension-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "kerberos sso extension check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive