...
# ============================================================
# Script: extensible-sso-profile-audit.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh extensible-sso-profile-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "extensible sso profile audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive