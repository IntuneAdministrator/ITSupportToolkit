...
# ============================================================
# Script: identity-platform-sso-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/20_Identity-Platform-SSO
# Requires: sudo | Usage: sudo zsh identity-platform-sso-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "identity platform sso auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive