...
# ============================================================
# Script: secure-token-admin-list.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh secure-token-admin-list.sh
# ============================================================
set -euo pipefail
...
export_html_report "secure token admin list" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive