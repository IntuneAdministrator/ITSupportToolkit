...
# ============================================================
# Script: bootstrap-token-status-deep.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh bootstrap-token-status-deep.sh
# ============================================================
set -euo pipefail
...
export_html_report "bootstrap token status deep" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive