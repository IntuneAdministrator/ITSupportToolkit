...
# ============================================================
# Script: platform-sso-deep-status.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh platform-sso-deep-status.sh
# ============================================================
set -euo pipefail
...
export_html_report "platform sso deep status" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive