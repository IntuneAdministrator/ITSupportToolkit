...
# ============================================================
# Script: filevault-prk-escrow-verify.sh | SysAdmin/20_Identity-Platform-SSO | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh filevault-prk-escrow-verify.sh
# ============================================================
set -euo pipefail
...
export_html_report "filevault prk escrow verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive