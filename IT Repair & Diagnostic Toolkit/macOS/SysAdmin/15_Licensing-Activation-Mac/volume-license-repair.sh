#!/bin/zsh
# ============================================================
# Script:      volume-license-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for volume license repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh volume-license-repair.sh
...
export_html_report "volume license repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
