#!/bin/zsh
# ============================================================
# Script:      app-store-receipt-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for app store receipt repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh app-store-receipt-repair.sh
...
export_html_report "app store receipt repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
