#!/bin/zsh
# ============================================================
# Script:      license-audit-full-report-mac.sh
# Description: Production macOS SysAdmin repair/diagnostic for license audit full report mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh license-audit-full-report-mac.sh
...
export_html_report "license audit full report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
