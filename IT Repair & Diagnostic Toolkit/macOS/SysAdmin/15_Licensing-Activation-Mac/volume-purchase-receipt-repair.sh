#!/bin/zsh
# ============================================================
# Script:      volume-purchase-receipt-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for volume purchase receipt repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh volume-purchase-receipt-repair.sh
...
export_html_report "volume purchase receipt repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
