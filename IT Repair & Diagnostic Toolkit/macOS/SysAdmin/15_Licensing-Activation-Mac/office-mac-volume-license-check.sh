#!/bin/zsh
# ============================================================
# Script:      office-mac-volume-license-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for office mac volume license check.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-mac-volume-license-check.sh
...
export_html_report "office mac volume license check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
