#!/bin/zsh
# ============================================================
# Script:      apple-id-session-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for apple id session repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh apple-id-session-repair.sh
...
export_html_report "apple id session repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
