...
# ============================================================
# Script: licensing-activation-mac-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/15_Licensing-Activation-Mac
# Requires: sudo | Usage: sudo zsh licensing-activation-mac-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='15_Licensing-Activation-Mac'
...
add_report_row "Module" "15_Licensing-Activation-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "15_Licensing-Activation-Mac"
...
export_html_report "licensing activation mac policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive