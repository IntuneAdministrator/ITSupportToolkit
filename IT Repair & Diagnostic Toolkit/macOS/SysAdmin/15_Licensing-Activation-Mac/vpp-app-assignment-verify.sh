#!/bin/zsh
# ============================================================
# Script:      vpp-app-assignment-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for vpp app assignment verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh vpp-app-assignment-verify.sh
...
export_html_report "vpp app assignment verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
