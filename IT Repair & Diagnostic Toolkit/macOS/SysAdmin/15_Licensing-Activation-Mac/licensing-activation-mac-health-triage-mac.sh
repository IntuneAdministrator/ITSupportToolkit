...
# ============================================================
# Script: licensing-activation-mac-health-triage-mac.sh | Phase 13 common problems | SysAdmin/15_Licensing-Activation-Mac
# Requires: sudo | Usage: sudo zsh licensing-activation-mac-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "licensing activation mac health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive