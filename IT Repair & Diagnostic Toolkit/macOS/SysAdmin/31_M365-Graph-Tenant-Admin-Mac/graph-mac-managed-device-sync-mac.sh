...
# ============================================================
# Script: graph-mac-managed-device-sync-mac.sh | Phase 13 common problems | SysAdmin/31_M365-Graph-Tenant-Admin-Mac
# Requires: sudo | Usage: sudo zsh graph-mac-managed-device-sync-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "graph mac managed device sync mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive