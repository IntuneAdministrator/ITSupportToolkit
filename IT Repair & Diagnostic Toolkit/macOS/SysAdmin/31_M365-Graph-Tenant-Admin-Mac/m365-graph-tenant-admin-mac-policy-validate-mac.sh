...
# ============================================================
# Script: m365-graph-tenant-admin-mac-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/31_M365-Graph-Tenant-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-graph-tenant-admin-mac-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='31_M365-Graph-Tenant-Admin-Mac'
...
add_report_row "Module" "31_M365-Graph-Tenant-Admin-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "31_M365-Graph-Tenant-Admin-Mac"
...
export_html_report "m365 graph tenant admin mac policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive