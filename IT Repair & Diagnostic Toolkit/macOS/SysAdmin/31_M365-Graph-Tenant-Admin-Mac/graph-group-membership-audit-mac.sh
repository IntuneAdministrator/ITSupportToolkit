...
# ============================================================
# Script: graph-group-membership-audit-mac.sh | SysAdmin/31_M365-Graph-Tenant-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh graph-group-membership-audit-mac.sh [user@domain.com]
...
export_html_report "graph group membership audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive