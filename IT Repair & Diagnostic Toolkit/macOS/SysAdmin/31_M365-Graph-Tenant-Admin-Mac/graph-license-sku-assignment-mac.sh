...
# ============================================================
# Script: graph-license-sku-assignment-mac.sh | SysAdmin/31_M365-Graph-Tenant-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh graph-license-sku-assignment-mac.sh [user@domain.com]
...
export_html_report "graph license sku assignment mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive