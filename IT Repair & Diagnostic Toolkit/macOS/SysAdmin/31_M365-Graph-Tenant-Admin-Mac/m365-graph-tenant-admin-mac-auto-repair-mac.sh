...
# ============================================================
# Script: m365-graph-tenant-admin-mac-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/31_M365-Graph-Tenant-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-graph-tenant-admin-mac-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 graph tenant admin mac auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive