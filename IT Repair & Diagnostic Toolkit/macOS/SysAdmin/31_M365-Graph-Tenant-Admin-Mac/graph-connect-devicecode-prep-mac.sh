...
# ============================================================
# Script: graph-connect-devicecode-prep-mac.sh | SysAdmin/31_M365-Graph-Tenant-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh graph-connect-devicecode-prep-mac.sh [user@domain.com]
...
export_html_report "graph connect devicecode prep mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive