...
# ============================================================
# Script: runbook-macos-update-full-cycle-mac.sh | Phase 13 common problems | SysAdmin/27_Update-Catalog-Deep
# Requires: sudo | Usage: sudo zsh runbook-macos-update-full-cycle-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='27_Update-Catalog-Deep'
...
add_report_row "Module" "27_Update-Catalog-Deep" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "27_Update-Catalog-Deep"
...
export_html_report "runbook macos update full cycle mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive