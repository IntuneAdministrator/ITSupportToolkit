...
# ============================================================
# Script: mdm-update-command-hint-mac.sh | SysAdmin/27_Update-Catalog-Deep | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh mdm-update-command-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mdm update command hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive