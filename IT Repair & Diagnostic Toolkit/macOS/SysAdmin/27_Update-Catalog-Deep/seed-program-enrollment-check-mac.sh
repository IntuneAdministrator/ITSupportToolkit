...
# ============================================================
# Script: seed-program-enrollment-check-mac.sh | SysAdmin/27_Update-Catalog-Deep | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh seed-program-enrollment-check-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='27_Update-Catalog-Deep'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
show_progress 5 "$TOTAL_STEPS" "Update done"
show_progress "$TOTAL_STEPS" "$TOTAL_STEPS" "Report"
export_html_report "seed program enrollment check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive