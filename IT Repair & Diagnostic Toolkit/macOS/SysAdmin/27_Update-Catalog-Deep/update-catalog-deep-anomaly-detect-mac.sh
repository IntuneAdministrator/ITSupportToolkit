...
# ============================================================
# Script: update-catalog-deep-anomaly-detect-mac.sh | Phase 13 common problems | SysAdmin/27_Update-Catalog-Deep
# Requires: sudo | Usage: sudo zsh update-catalog-deep-anomaly-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "update catalog deep anomaly detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive