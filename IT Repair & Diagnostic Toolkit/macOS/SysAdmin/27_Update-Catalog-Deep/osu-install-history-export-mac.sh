...
# ============================================================
# Script: osu-install-history-export-mac.sh | SysAdmin/27_Update-Catalog-Deep | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh osu-install-history-export-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "osu install history export mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive