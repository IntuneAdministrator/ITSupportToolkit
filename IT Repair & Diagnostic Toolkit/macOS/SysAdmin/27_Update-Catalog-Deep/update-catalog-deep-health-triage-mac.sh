...
# ============================================================
# Script: update-catalog-deep-health-triage-mac.sh | Phase 13 common problems | SysAdmin/27_Update-Catalog-Deep
# Requires: sudo | Usage: sudo zsh update-catalog-deep-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "update catalog deep health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive