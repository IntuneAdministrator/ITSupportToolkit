#!/bin/zsh
# ============================================================
# Script:      keychain-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for keychain repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh keychain-repair.sh
...
export_html_report "keychain repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
