#!/bin/zsh
# ============================================================
# Script:      local-admin-account-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for local admin account audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh local-admin-account-audit.sh
...
export_html_report "local admin account audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
