#!/bin/zsh
# ============================================================
# Script:      bootstrap-token-escrow-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for bootstrap token escrow verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh bootstrap-token-escrow-verify.sh
...
export_html_report "bootstrap token escrow verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
