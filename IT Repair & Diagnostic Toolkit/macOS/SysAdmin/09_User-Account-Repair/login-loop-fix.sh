#!/bin/zsh
# ============================================================
# Script:      login-loop-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for login loop fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh login-loop-fix.sh
...
export_html_report "login loop fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
