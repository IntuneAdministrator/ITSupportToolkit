#!/bin/zsh
# ============================================================
# Script:      filevault-user-enable.sh
# Description: Production macOS SysAdmin repair/diagnostic for filevault user enable.
...
# Requires:    sudo / root
# Usage:       sudo zsh filevault-user-enable.sh
...
export_html_report "filevault user enable" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
