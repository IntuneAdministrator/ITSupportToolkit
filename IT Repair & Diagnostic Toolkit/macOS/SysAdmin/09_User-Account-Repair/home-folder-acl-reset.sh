#!/bin/zsh
# ============================================================
# Script:      home-folder-acl-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for home folder acl reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh home-folder-acl-reset.sh
...
export_html_report "home folder acl reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
