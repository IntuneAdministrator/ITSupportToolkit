#!/bin/zsh
# ============================================================
# Script:      mobile-account-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for mobile account repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh mobile-account-repair.sh
...
export_html_report "mobile account repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
