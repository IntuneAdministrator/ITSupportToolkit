...
# ============================================================
# Script: user-account-repair-quick-fix-mac.sh | Phase 13 common problems | SysAdmin/09_User-Account-Repair
# Requires: sudo | Usage: sudo zsh user-account-repair-quick-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "user account repair quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive