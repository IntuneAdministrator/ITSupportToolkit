#!/bin/zsh
# ============================================================
# Script:      secure-token-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for secure token repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh secure-token-repair.sh
...
export_html_report "secure token repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
