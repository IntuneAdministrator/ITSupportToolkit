#!/bin/zsh
# ============================================================
# Script:      user-profile-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for user profile repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh user-profile-repair.sh
...
export_html_report "user profile repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
