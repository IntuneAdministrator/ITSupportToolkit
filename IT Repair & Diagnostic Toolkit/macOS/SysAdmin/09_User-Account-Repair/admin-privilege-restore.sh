#!/bin/zsh
# ============================================================
# Script:      admin-privilege-restore.sh
# Description: Production macOS SysAdmin repair/diagnostic for admin privilege restore.
...
# Requires:    sudo / root
# Usage:       sudo zsh admin-privilege-restore.sh
...
export_html_report "admin privilege restore" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
