...
# ============================================================
# Script: user-account-repair-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/09_User-Account-Repair
# Requires: sudo | Usage: sudo zsh user-account-repair-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='09_User-Account-Repair'
...
add_report_row "Module" "09_User-Account-Repair" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "09_User-Account-Repair"
...
export_html_report "user account repair policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive