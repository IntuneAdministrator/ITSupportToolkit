#!/bin/zsh
# ============================================================
# Script:      home-folder-permissions.sh
# Description: Production macOS SysAdmin repair/diagnostic for home folder permissions.
...
# Requires:    sudo / root
# Usage:       sudo zsh home-folder-permissions.sh
...
export_html_report "home folder permissions" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
