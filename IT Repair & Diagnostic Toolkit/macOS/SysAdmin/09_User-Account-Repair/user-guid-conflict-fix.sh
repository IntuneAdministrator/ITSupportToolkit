#!/bin/zsh
# ============================================================
# Script:      user-guid-conflict-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for user guid conflict fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh user-guid-conflict-fix.sh
...
export_html_report "user guid conflict fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
