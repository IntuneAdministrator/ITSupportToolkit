#!/bin/zsh
# ============================================================
# Script:      password-hint-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for password hint reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh password-hint-reset.sh
...
export_html_report "password hint reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
