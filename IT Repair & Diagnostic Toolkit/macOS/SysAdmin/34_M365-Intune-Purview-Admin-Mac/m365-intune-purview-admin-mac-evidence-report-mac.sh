...
# ============================================================
# Script: m365-intune-purview-admin-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/34_M365-Intune-Purview-Admin-Mac
# Requires: sudo | Usage: sudo zsh m365-intune-purview-admin-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='34_M365-Intune-Purview-Admin-Mac'
...
add_report_row "Module" "34_M365-Intune-Purview-Admin-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "34_M365-Intune-Purview-Admin-Mac"
...
export_html_report "m365 intune purview admin mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive