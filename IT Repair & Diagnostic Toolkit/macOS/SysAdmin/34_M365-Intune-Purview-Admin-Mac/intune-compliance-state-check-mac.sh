...
# ============================================================
# Script: intune-compliance-state-check-mac.sh | SysAdmin/34_M365-Intune-Purview-Admin-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh intune-compliance-state-check-mac.sh [user@domain.com]
...
export_html_report "intune compliance state check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive