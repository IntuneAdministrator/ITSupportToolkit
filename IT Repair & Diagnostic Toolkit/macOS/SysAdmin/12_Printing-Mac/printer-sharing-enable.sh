#!/bin/zsh
# ============================================================
# Script:      printer-sharing-enable.sh
# Description: Production macOS SysAdmin repair/diagnostic for printer sharing enable.
...
# Requires:    sudo / root
# Usage:       sudo zsh printer-sharing-enable.sh
...
export_html_report "printer sharing enable" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
