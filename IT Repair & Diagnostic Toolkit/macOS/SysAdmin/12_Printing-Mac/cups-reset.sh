#!/bin/zsh
# ============================================================
# Script:      cups-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for cups reset.
...
export_html_report "cups reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
