#!/bin/zsh
# ============================================================
# Script:      scan-to-email-test-mac.sh
# Description: Production macOS SysAdmin repair/diagnostic for scan to email test mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh scan-to-email-test-mac.sh
...
export_html_report "scan to email test mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
