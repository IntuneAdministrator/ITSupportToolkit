#!/bin/zsh
# ============================================================
# Script:      cups-log-analyzer.sh
# Description: Production macOS SysAdmin repair/diagnostic for cups log analyzer.
...
# Requires:    sudo / root
# Usage:       sudo zsh cups-log-analyzer.sh
...
export_html_report "cups log analyzer" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
