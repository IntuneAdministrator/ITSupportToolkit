#!/bin/zsh
# ============================================================
# Script:      print-queue-clear.sh
# Description: Production macOS SysAdmin repair/diagnostic for print queue clear.
...
# Requires:    sudo / root
# Usage:       sudo zsh print-queue-clear.sh
...
export_html_report "print queue clear" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
