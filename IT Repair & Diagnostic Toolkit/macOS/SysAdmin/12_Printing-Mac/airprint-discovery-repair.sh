#!/bin/zsh
# ============================================================
# Script:      airprint-discovery-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for airprint discovery repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh airprint-discovery-repair.sh
...
export_html_report "airprint discovery repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
