#!/bin/zsh
# ============================================================
# Script:      printer-driver-reinstall.sh
# Description: Production macOS SysAdmin repair/diagnostic for printer driver reinstall.
...
# Requires:    sudo / root
# Usage:       sudo zsh printer-driver-reinstall.sh
...
export_html_report "printer driver reinstall" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
