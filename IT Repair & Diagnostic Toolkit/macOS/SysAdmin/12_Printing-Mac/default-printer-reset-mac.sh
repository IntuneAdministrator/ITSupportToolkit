#!/bin/zsh
# ============================================================
# Script:      default-printer-reset-mac.sh
# Description: Production macOS SysAdmin repair/diagnostic for default printer reset mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh default-printer-reset-mac.sh
...
export_html_report "default printer reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
