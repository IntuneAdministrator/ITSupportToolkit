...
# ============================================================
# Script: proxy-pac-validate-mac.sh | SysAdmin/19_Network-Enterprise-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh proxy-pac-validate-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "proxy pac validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive