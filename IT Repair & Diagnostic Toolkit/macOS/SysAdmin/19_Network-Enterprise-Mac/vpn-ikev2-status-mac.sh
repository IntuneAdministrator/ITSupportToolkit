...
# ============================================================
# Script: vpn-ikev2-status-mac.sh | SysAdmin/19_Network-Enterprise-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh vpn-ikev2-status-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "vpn ikev2 status mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive