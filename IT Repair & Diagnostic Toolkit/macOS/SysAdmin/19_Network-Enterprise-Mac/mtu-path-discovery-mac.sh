...
# ============================================================
# Script: mtu-path-discovery-mac.sh | SysAdmin/19_Network-Enterprise-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh mtu-path-discovery-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mtu path discovery mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive