...
# ============================================================
# Script: 8021x-wifi-profile-export-mac.sh | SysAdmin/19_Network-Enterprise-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh 8021x-wifi-profile-export-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='19_Network-Enterprise-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "19_Network-Enterprise-Mac" "INFO" "SysAdmin"
...
show_progress 5 "$TOTAL_STEPS" "Net enterprise done"
show_progress "$TOTAL_STEPS" "$TOTAL_STEPS" "Report"
export_html_report "8021x wifi profile export mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive