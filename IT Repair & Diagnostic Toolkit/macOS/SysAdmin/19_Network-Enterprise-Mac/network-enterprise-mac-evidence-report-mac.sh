...
# ============================================================
# Script: network-enterprise-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/19_Network-Enterprise-Mac
# Requires: sudo | Usage: sudo zsh network-enterprise-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='19_Network-Enterprise-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "19_Network-Enterprise-Mac"
...
export_html_report "network enterprise mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive