...
# ============================================================
# Script: pf-firewall-anchor-audit.sh | SysAdmin/19_Network-Enterprise-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh pf-firewall-anchor-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "pf firewall anchor audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive