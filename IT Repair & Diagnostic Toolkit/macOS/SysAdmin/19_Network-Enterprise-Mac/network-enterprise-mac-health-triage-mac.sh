...
# ============================================================
# Script: network-enterprise-mac-health-triage-mac.sh | Phase 13 common problems | SysAdmin/19_Network-Enterprise-Mac
# Requires: sudo | Usage: sudo zsh network-enterprise-mac-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "network enterprise mac health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive