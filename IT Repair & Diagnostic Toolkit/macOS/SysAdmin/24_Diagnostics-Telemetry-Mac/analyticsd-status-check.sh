...
# ============================================================
# Script: analyticsd-status-check.sh | SysAdmin/24_Diagnostics-Telemetry-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh analyticsd-status-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "analyticsd status check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive