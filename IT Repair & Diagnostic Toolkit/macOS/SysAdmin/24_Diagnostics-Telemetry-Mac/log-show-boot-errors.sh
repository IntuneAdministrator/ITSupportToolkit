...
# ============================================================
# Script: log-show-boot-errors.sh | SysAdmin/24_Diagnostics-Telemetry-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh log-show-boot-errors.sh
# ============================================================
set -euo pipefail
...
export_html_report "log show boot errors" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive