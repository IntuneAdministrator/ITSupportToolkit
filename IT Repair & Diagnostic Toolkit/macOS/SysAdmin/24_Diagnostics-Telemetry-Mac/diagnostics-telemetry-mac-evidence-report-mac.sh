...
# ============================================================
# Script: diagnostics-telemetry-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/24_Diagnostics-Telemetry-Mac
# Requires: sudo | Usage: sudo zsh diagnostics-telemetry-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='24_Diagnostics-Telemetry-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "24_Diagnostics-Telemetry-Mac"
...
export_html_report "diagnostics telemetry mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive