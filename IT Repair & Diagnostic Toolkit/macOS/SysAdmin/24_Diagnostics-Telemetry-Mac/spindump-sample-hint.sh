...
# ============================================================
# Script: spindump-sample-hint.sh | SysAdmin/24_Diagnostics-Telemetry-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh spindump-sample-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "spindump sample hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive