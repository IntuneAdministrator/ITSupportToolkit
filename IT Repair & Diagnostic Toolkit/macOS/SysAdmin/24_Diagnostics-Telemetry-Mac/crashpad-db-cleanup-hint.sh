...
# ============================================================
# Script: crashpad-db-cleanup-hint.sh | SysAdmin/24_Diagnostics-Telemetry-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh crashpad-db-cleanup-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "crashpad db cleanup hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive