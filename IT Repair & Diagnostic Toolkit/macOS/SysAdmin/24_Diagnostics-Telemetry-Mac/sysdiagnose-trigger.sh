...
# ============================================================
# Script: sysdiagnose-trigger.sh | SysAdmin/24_Diagnostics-Telemetry-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh sysdiagnose-trigger.sh
# ============================================================
set -euo pipefail
...
export_html_report "sysdiagnose trigger" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive