...
# ============================================================
# Script: diagnostics-telemetry-mac-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/24_Diagnostics-Telemetry-Mac
# Requires: sudo | Usage: sudo zsh diagnostics-telemetry-mac-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "diagnostics telemetry mac auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive