...
# ============================================================
# Script: disk-storage-mac-quick-fix-mac.sh | Phase 13 common problems | SysAdmin/10_Disk-Storage-Mac
# Requires: sudo | Usage: sudo zsh disk-storage-mac-quick-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "disk storage mac quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive