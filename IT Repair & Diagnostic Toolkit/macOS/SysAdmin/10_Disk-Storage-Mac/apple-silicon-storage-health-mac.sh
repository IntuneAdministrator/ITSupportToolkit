...
# ============================================================
# Script: apple-silicon-storage-health-mac.sh | Phase 13 common problems | SysAdmin/10_Disk-Storage-Mac
# Requires: sudo | Usage: sudo zsh apple-silicon-storage-health-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "apple silicon storage health mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive