#!/bin/zsh
# ============================================================
# Script:      large-file-finder.sh
# Description: Production macOS SysAdmin repair/diagnostic for large file finder.
...
# Requires:    sudo / root
# Usage:       sudo zsh large-file-finder.sh
...
export_html_report "large file finder" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
