...
# ============================================================
# Script: server-mac-mini-storage-audit-mac.sh | Phase 13 common problems | SysAdmin/10_Disk-Storage-Mac
# Requires: sudo | Usage: sudo zsh server-mac-mini-storage-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "server mac mini storage audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive