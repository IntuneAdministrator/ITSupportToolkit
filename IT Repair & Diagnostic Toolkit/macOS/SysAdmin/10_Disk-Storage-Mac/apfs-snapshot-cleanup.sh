#!/bin/zsh
# ============================================================
# Script:      apfs-snapshot-cleanup.sh
# Description: Production macOS SysAdmin repair/diagnostic for apfs snapshot cleanup.
...
# Requires:    sudo / root
# Usage:       sudo zsh apfs-snapshot-cleanup.sh
...
export_html_report "apfs snapshot cleanup" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
