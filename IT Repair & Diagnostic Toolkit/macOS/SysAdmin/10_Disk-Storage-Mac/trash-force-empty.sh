#!/bin/zsh
# ============================================================
# Script:      trash-force-empty.sh
# Description: Production macOS SysAdmin repair/diagnostic for trash force empty.
...
# Requires:    sudo / root
# Usage:       sudo zsh trash-force-empty.sh
...
export_html_report "trash force empty" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
