#!/bin/zsh
# ============================================================
# Script:      orphaned-app-cleanup.sh
# Description: Production macOS SysAdmin repair/diagnostic for orphaned app cleanup.
...
# Requires:    sudo / root
# Usage:       sudo zsh orphaned-app-cleanup.sh
...
export_html_report "orphaned app cleanup" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
