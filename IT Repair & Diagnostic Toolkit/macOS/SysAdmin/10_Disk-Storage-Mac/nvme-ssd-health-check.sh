#!/bin/zsh
# ============================================================
# Script:      nvme-ssd-health-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for nvme ssd health check.
...
# Requires:    sudo / root
# Usage:       sudo zsh nvme-ssd-health-check.sh
...
export_html_report "nvme ssd health check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
