#!/bin/zsh
# ============================================================
# Script:      time-machine-exclusion-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for time machine exclusion audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh time-machine-exclusion-audit.sh
...
export_html_report "time machine exclusion audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
