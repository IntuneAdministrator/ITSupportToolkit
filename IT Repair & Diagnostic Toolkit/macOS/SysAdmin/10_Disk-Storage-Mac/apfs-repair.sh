#!/bin/zsh
# ============================================================
# Script:      apfs-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for apfs repair.
...
export_html_report "apfs repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
