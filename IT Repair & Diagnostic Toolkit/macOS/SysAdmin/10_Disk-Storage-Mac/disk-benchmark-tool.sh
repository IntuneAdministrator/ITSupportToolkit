#!/bin/zsh
# ============================================================
# Script:      disk-benchmark-tool.sh
# Description: Production macOS SysAdmin repair/diagnostic for disk benchmark tool.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-benchmark-tool.sh
...
export_html_report "disk benchmark tool" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
