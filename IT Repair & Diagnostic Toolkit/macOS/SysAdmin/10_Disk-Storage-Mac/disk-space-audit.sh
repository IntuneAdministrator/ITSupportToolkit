#!/bin/zsh
# ============================================================
# Script:      disk-space-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for disk space audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-space-audit.sh
...
export_html_report "disk space audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
