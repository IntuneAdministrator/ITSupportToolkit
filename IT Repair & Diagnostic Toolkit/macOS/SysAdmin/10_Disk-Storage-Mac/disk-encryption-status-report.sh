#!/bin/zsh
# ============================================================
# Script:      disk-encryption-status-report.sh
# Description: Production macOS SysAdmin repair/diagnostic for disk encryption status report.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-encryption-status-report.sh
...
export_html_report "disk encryption status report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
