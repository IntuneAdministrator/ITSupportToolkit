#!/bin/zsh
# ============================================================
# Script:      duplicate-finder.sh
# Description: Production macOS SysAdmin repair/diagnostic for duplicate finder.
...
# Requires:    sudo / root
# Usage:       sudo zsh duplicate-finder.sh
...
export_html_report "duplicate finder" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
