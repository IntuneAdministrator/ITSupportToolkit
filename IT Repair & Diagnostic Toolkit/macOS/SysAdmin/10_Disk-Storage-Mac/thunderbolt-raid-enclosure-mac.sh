...
# ============================================================
# Script: thunderbolt-raid-enclosure-mac.sh | Phase 13 common problems | SysAdmin/10_Disk-Storage-Mac
# Requires: sudo | Usage: sudo zsh thunderbolt-raid-enclosure-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "thunderbolt raid enclosure mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive