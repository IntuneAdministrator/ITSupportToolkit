#!/bin/zsh
# ============================================================
# Script:      fusion-drive-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for fusion drive repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh fusion-drive-repair.sh
...
export_html_report "fusion drive repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
