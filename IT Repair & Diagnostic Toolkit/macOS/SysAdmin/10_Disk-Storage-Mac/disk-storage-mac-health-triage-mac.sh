...
# ============================================================
# Script: disk-storage-mac-health-triage-mac.sh | Phase 13 common problems | SysAdmin/10_Disk-Storage-Mac
# Requires: sudo | Usage: sudo zsh disk-storage-mac-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "disk storage mac health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive