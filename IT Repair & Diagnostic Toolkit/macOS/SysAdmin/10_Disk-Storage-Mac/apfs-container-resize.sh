#!/bin/zsh
# ============================================================
# Script:      apfs-container-resize.sh
# Description: Production macOS SysAdmin repair/diagnostic for apfs container resize.
...
# Requires:    sudo / root
# Usage:       sudo zsh apfs-container-resize.sh
...
export_html_report "apfs container resize" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
