#!/bin/zsh
# ============================================================
# Script:      time-machine-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for time machine repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh time-machine-repair.sh
...
export_html_report "time machine repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
