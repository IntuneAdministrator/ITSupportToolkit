...
# ============================================================
# Script: ipp-printer-probe-mac.sh | SysAdmin/25_Print-CUPS-Enterprise | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh ipp-printer-probe-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "ipp printer probe mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive