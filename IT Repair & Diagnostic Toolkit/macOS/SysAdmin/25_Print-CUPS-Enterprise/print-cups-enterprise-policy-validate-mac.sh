...
# ============================================================
# Script: print-cups-enterprise-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/25_Print-CUPS-Enterprise
# Requires: sudo | Usage: sudo zsh print-cups-enterprise-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='25_Print-CUPS-Enterprise'
...
add_report_row "Module" "25_Print-CUPS-Enterprise" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "25_Print-CUPS-Enterprise"
...
export_html_report "print cups enterprise policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive