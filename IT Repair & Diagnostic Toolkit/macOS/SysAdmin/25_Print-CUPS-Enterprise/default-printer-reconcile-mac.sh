...
# ============================================================
# Script: default-printer-reconcile-mac.sh | SysAdmin/25_Print-CUPS-Enterprise | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh default-printer-reconcile-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='25_Print-CUPS-Enterprise'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
show_progress 5 "$TOTAL_STEPS" "Print done"
show_progress "$TOTAL_STEPS" "$TOTAL_STEPS" "Report"
export_html_report "default printer reconcile mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive