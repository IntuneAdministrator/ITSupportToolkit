...
# ============================================================
# Script: universal-print-mac-status.sh | SysAdmin/25_Print-CUPS-Enterprise | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh universal-print-mac-status.sh
# ============================================================
set -euo pipefail
...
export_html_report "universal print mac status" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive