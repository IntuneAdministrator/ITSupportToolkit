...
# ============================================================
# Script: print-cups-enterprise-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/25_Print-CUPS-Enterprise
# Requires: sudo | Usage: sudo zsh print-cups-enterprise-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "print cups enterprise evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive