...
# ============================================================
# Script: apfs-container-health-audit-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh apfs-container-health-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "apfs container health audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive