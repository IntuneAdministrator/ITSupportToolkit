...
# ============================================================
# Script: apfs-encryption-progress.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh apfs-encryption-progress.sh
# ============================================================
set -euo pipefail
...
export_html_report "apfs encryption progress" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive