...
# ============================================================
# Script: network-attached-storage-mount-audit-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh network-attached-storage-mount-audit-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='22_Storage-APFS-Deep'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "22_Storage-APFS-Deep"
...
export_html_report "network attached storage mount audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive