...
# ============================================================
# Script: secure-token-diskutil-users.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh secure-token-diskutil-users.sh
# ============================================================
set -euo pipefail
...
export_html_report "secure token diskutil users" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive