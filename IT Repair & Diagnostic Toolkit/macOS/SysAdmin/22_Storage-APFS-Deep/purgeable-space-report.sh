...
# ============================================================
# Script: purgeable-space-report.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh purgeable-space-report.sh
# ============================================================
set -euo pipefail
...
export_html_report "purgeable space report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive