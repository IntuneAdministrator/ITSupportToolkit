...
# ============================================================
# Script: soft-raid-status-hint-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh soft-raid-status-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "soft raid status hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive