...
# ============================================================
# Script: external-raid-enclosure-hint-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh external-raid-enclosure-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "external raid enclosure hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive