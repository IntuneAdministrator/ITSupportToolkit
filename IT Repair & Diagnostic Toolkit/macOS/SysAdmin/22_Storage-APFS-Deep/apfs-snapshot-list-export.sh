...
# ============================================================
# Script: apfs-snapshot-list-export.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh apfs-snapshot-list-export.sh
# ============================================================
set -euo pipefail
...
export_html_report "apfs snapshot list export" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive