...
# ============================================================
# Script: apfs-snapshot-storage-audit-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh apfs-snapshot-storage-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "apfs snapshot storage audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive