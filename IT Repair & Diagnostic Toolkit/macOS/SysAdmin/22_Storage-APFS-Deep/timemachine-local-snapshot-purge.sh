...
# ============================================================
# Script: timemachine-local-snapshot-purge.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh timemachine-local-snapshot-purge.sh
# ============================================================
set -euo pipefail
...
export_html_report "timemachine local snapshot purge" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive