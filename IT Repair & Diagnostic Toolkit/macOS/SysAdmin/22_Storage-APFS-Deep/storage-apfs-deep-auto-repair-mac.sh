...
# ============================================================
# Script: storage-apfs-deep-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/22_Storage-APFS-Deep
# Requires: sudo | Usage: sudo zsh storage-apfs-deep-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "storage apfs deep auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive