...
# ============================================================
# Script: external-volume-mount-policy.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh external-volume-mount-policy.sh
# ============================================================
set -euo pipefail
...
export_html_report "external volume mount policy" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive