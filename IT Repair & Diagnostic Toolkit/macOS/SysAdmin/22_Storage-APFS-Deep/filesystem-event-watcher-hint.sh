...
# ============================================================
# Script: filesystem-event-watcher-hint.sh | SysAdmin/22_Storage-APFS-Deep | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh filesystem-event-watcher-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "filesystem event watcher hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive