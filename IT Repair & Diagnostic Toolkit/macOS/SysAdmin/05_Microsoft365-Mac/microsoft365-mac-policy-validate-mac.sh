...
# ============================================================
# Script: microsoft365-mac-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/05_Microsoft365-Mac
# Requires: sudo | Usage: sudo zsh microsoft365-mac-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='05_Microsoft365-Mac'
...
add_report_row "Module" "05_Microsoft365-Mac" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "05_Microsoft365-Mac"
...
export_html_report "microsoft365 mac policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive