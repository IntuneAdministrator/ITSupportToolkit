#!/bin/zsh
# ============================================================
# Script:      outlook-mac-search-rebuild.sh
# Description: Production macOS SysAdmin repair/diagnostic for outlook mac search rebuild.
...
# Requires:    sudo / root
# Usage:       sudo zsh outlook-mac-search-rebuild.sh
...
export_html_report "outlook mac search rebuild" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
