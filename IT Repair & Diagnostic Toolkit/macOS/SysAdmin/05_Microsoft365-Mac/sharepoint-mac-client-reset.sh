#!/bin/zsh
# ============================================================
# Script:      sharepoint-mac-client-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for sharepoint mac client reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh sharepoint-mac-client-reset.sh
...
export_html_report "sharepoint mac client reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
