#!/bin/zsh
# ============================================================
# Script:      office-mau-update-force.sh
# Description: Production macOS SysAdmin repair/diagnostic for office mau update force.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-mau-update-force.sh
...
export_html_report "office mau update force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
