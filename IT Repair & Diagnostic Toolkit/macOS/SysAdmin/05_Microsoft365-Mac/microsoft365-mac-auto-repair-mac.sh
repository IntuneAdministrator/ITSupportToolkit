...
# ============================================================
# Script: microsoft365-mac-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/05_Microsoft365-Mac
# Requires: sudo | Usage: sudo zsh microsoft365-mac-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "microsoft365 mac auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive