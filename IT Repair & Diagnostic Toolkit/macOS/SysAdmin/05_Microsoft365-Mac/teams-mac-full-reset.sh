#!/bin/zsh
# ============================================================
# Script:      teams-mac-full-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for teams mac full reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-mac-full-reset.sh
...
export_html_report "teams mac full reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
