#!/bin/zsh
# ============================================================
# Script:      office-mac-full-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for office mac full repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-mac-full-repair.sh
...
export_html_report "office mac full repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
