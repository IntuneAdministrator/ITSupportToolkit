#!/bin/zsh
# ============================================================
# Script:      teams-mac-microphone-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for teams mac microphone repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-mac-microphone-repair.sh
...
export_html_report "teams mac microphone repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
