#!/bin/zsh
# ============================================================
# Script:      teams-mac-cache-purge.sh
# Description: Production macOS SysAdmin repair/diagnostic for teams mac cache purge.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-mac-cache-purge.sh
...
export_html_report "teams mac cache purge" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
