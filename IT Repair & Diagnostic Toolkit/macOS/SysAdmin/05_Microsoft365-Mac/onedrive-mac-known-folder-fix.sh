#!/bin/zsh
# ============================================================
# Script:      onedrive-mac-known-folder-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for onedrive mac known folder fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh onedrive-mac-known-folder-fix.sh
...
export_html_report "onedrive mac known folder fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
