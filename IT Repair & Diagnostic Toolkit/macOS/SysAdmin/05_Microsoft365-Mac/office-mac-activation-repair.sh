#!/bin/zsh
# ============================================================
# Script:      office-mac-activation-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for office mac activation repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-mac-activation-repair.sh
...
export_html_report "office mac activation repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
