...
# ============================================================
# Script: teams-cache-deep-clean-mac.sh | Phase 13 common problems | SysAdmin/05_Microsoft365-Mac
# Requires: sudo | Usage: sudo zsh teams-cache-deep-clean-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "teams cache deep clean mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive