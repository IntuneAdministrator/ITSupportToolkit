#!/bin/zsh
# ============================================================
# Script:      outlook-mac-profile-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for outlook mac profile repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh outlook-mac-profile-repair.sh
...
export_html_report "outlook mac profile repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
