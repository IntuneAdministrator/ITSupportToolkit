#!/bin/zsh
# ============================================================
# Script:      teams-mac-webcam-permission-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for teams mac webcam permission fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-mac-webcam-permission-fix.sh
...
export_html_report "teams mac webcam permission fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
