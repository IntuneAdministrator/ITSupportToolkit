#!/bin/zsh
# ============================================================
# Script:      m365-mac-license-cache-clear.sh
# Description: Production macOS SysAdmin repair/diagnostic for m365 mac license cache clear.
...
# Requires:    sudo / root
# Usage:       sudo zsh m365-mac-license-cache-clear.sh
...
export_html_report "m365 mac license cache clear" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
