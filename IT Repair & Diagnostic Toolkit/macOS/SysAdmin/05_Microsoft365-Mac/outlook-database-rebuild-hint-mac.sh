...
# ============================================================
# Script: outlook-database-rebuild-hint-mac.sh | Phase 13 common problems | SysAdmin/05_Microsoft365-Mac
# Requires: sudo | Usage: sudo zsh outlook-database-rebuild-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "outlook database rebuild hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive