#!/bin/zsh
# ============================================================
# Script:      office-license-mac-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for office license mac reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-license-mac-reset.sh
...
export_html_report "office license mac reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
