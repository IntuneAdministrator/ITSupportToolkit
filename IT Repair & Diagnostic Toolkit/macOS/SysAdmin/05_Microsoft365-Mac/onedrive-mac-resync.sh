#!/bin/zsh
# ============================================================
# Script:      onedrive-mac-resync.sh
# Description: Production macOS SysAdmin repair/diagnostic for onedrive mac resync.
...
# Requires:    sudo / root
# Usage:       sudo zsh onedrive-mac-resync.sh
...
export_html_report "onedrive mac resync" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
