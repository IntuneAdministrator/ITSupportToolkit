...
# ============================================================
# Script: remote-access-mac-deep-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/28_Remote-Access-Mac-Deep
# Requires: sudo | Usage: sudo zsh remote-access-mac-deep-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "remote access mac deep policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive