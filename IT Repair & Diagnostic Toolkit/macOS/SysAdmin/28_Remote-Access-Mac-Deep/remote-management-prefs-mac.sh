...
# ============================================================
# Script: remote-management-prefs-mac.sh | SysAdmin/28_Remote-Access-Mac-Deep | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh remote-management-prefs-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "remote management prefs mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive