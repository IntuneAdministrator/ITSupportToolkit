#!/bin/zsh
# ============================================================
# Script:      mdm-profile-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm profile audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-profile-audit.sh
...
export_html_report "mdm profile audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
