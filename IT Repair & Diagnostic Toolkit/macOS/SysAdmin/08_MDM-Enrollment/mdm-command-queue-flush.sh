#!/bin/zsh
# ============================================================
# Script:      mdm-command-queue-flush.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm command queue flush.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-command-queue-flush.sh
...
export_html_report "mdm command queue flush" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
