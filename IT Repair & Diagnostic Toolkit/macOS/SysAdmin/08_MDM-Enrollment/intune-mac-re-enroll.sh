#!/bin/zsh
# ============================================================
# Script:      intune-mac-re-enroll.sh
# Description: Production macOS SysAdmin repair/diagnostic for intune mac re enroll.
...
# Requires:    sudo / root
# Usage:       sudo zsh intune-mac-re-enroll.sh
...
export_html_report "intune mac re enroll" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
