...
# ============================================================
# Script: mdm-enrollment-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh mdm-enrollment-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mdm enrollment policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive