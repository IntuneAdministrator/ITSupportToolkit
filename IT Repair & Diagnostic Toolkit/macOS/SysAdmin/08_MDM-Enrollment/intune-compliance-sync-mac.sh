#!/bin/zsh
# ============================================================
# Script:      intune-compliance-sync-mac.sh
# Description: Production macOS SysAdmin repair/diagnostic for intune compliance sync mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh intune-compliance-sync-mac.sh
...
export_html_report "intune compliance sync mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
