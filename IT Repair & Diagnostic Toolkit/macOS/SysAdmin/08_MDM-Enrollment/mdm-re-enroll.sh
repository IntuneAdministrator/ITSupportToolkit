#!/bin/zsh
# ============================================================
# Script:      mdm-re-enroll.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm re enroll.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-re-enroll.sh
...
export_html_report "mdm re enroll" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
