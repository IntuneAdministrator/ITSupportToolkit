#!/bin/zsh
# ============================================================
# Script:      ade-dep-enrollment-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for ade dep enrollment repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh ade-dep-enrollment-repair.sh
...
export_html_report "ade dep enrollment repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
