...
# ============================================================
# Script: dep-enrollment-fail-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh dep-enrollment-fail-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "dep enrollment fail mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive