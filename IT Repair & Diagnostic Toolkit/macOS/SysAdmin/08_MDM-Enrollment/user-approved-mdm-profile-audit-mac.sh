...
# ============================================================
# Script: user-approved-mdm-profile-audit-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh user-approved-mdm-profile-audit-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='08_MDM-Enrollment'
...
add_report_row "Module" "08_MDM-Enrollment" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "08_MDM-Enrollment"
...
export_html_report "user approved mdm profile audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive