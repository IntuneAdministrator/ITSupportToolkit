#!/bin/zsh
# ============================================================
# Script:      supervision-identity-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for supervision identity check.
...
# Requires:    sudo / root
# Usage:       sudo zsh supervision-identity-check.sh
...
export_html_report "supervision identity check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
