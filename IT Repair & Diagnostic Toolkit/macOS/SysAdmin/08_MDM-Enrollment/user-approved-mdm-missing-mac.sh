...
# ============================================================
# Script: user-approved-mdm-missing-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh user-approved-mdm-missing-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "user approved mdm missing mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive