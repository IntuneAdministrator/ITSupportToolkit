#!/bin/zsh
# ============================================================
# Script:      jamf-policy-force-run.sh
# Description: Production macOS SysAdmin repair/diagnostic for jamf policy force run.
...
# Requires:    sudo / root
# Usage:       sudo zsh jamf-policy-force-run.sh
...
export_html_report "jamf policy force run" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
