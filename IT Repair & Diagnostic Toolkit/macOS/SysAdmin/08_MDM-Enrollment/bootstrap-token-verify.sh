#!/bin/zsh
# ============================================================
# Script:      bootstrap-token-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for bootstrap token verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh bootstrap-token-verify.sh
...
export_html_report "bootstrap token verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
