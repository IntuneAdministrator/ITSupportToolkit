#!/bin/zsh
# ============================================================
# Script:      mdm-push-certificate-verify.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm push certificate verify.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-push-certificate-verify.sh
...
export_html_report "mdm push certificate verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
