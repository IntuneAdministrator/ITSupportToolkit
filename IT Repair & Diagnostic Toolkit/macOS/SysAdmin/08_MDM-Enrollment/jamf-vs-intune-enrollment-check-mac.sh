...
# ============================================================
# Script: jamf-vs-intune-enrollment-check-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh jamf-vs-intune-enrollment-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "jamf vs intune enrollment check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive