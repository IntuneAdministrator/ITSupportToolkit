#!/bin/zsh
# ============================================================
# Script:      jamf-re-enroll.sh
# Description: Production macOS SysAdmin repair/diagnostic for jamf re enroll.
...
# Requires:    sudo / root
# Usage:       sudo zsh jamf-re-enroll.sh
...
export_html_report "jamf re enroll" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
