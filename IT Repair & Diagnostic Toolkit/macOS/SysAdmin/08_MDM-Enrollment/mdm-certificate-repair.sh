#!/bin/zsh
# ============================================================
# Script:      mdm-certificate-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdm certificate repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-certificate-repair.sh
...
export_html_report "mdm certificate repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
