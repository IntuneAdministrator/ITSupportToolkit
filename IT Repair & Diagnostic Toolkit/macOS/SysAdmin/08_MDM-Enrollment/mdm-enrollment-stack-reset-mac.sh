...
# ============================================================
# Script: mdm-enrollment-stack-reset-mac.sh | Phase 13 common problems | SysAdmin/08_MDM-Enrollment
# Requires: sudo | Usage: sudo zsh mdm-enrollment-stack-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mdm enrollment stack reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive