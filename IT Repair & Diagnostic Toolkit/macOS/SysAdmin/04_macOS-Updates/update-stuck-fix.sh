#!/bin/zsh
# ============================================================
# Script:      update-stuck-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for update stuck fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh update-stuck-fix.sh
...
export_html_report "update stuck fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
