#!/bin/zsh
# ============================================================
# Script:      macos-update-log-analyzer.sh
# Description: Production macOS SysAdmin repair/diagnostic for macos update log analyzer.
...
# Requires:    sudo / root
# Usage:       sudo zsh macos-update-log-analyzer.sh
...
export_html_report "macos update log analyzer" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
