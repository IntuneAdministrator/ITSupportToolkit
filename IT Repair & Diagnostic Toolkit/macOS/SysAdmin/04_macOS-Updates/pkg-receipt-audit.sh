#!/bin/zsh
# ============================================================
# Script:      pkg-receipt-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for pkg receipt audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh pkg-receipt-audit.sh
...
export_html_report "pkg receipt audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
