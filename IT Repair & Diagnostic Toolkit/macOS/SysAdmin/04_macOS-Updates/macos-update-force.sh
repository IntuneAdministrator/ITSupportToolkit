#!/bin/zsh
# ============================================================
# Script:      macos-update-force.sh
# Description: Production macOS SysAdmin repair/diagnostic for macos update force.
...
# Requires:    sudo / root
# Usage:       sudo zsh macos-update-force.sh
...
export_html_report "macos update force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
