#!/bin/zsh
# ============================================================
# Script:      pending-update-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for pending update audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh pending-update-audit.sh
...
export_html_report "pending update audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
