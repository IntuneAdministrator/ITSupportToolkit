#!/bin/zsh
# ============================================================
# Script:      update-cache-clear.sh
# Description: Production macOS SysAdmin repair/diagnostic for update cache clear.
...
# Requires:    sudo / root
# Usage:       sudo zsh update-cache-clear.sh
...
export_html_report "update cache clear" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
