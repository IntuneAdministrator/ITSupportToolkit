...
# ============================================================
# Script: macos-updates-health-triage-mac.sh | Phase 13 common problems | SysAdmin/04_macOS-Updates
# Requires: sudo | Usage: sudo zsh macos-updates-health-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "macos updates health triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive