...
# ============================================================
# Script: macos-updates-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/04_macOS-Updates
# Requires: sudo | Usage: sudo zsh macos-updates-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='04_macOS-Updates'
...
add_report_row "Module" "04_macOS-Updates" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "04_macOS-Updates"
...
export_html_report "macos updates policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive