#!/bin/zsh
# ============================================================
# Script:      softwareupdate-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for softwareupdate repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh softwareupdate-repair.sh
...
export_html_report "softwareupdate repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
