#!/bin/zsh
# ============================================================
# Script:      delta-update-force.sh
# Description: Production macOS SysAdmin repair/diagnostic for delta update force.
...
# Requires:    sudo / root
# Usage:       sudo zsh delta-update-force.sh
...
export_html_report "delta update force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
