#!/bin/zsh
# ============================================================
# Script:      update-history-export.sh
# Description: Production macOS SysAdmin repair/diagnostic for update history export.
...
# Requires:    sudo / root
# Usage:       sudo zsh update-history-export.sh
...
export_html_report "update history export" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
