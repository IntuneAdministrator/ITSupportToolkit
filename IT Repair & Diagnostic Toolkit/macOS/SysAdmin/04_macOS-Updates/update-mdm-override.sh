#!/bin/zsh
# ============================================================
# Script:      update-mdm-override.sh
# Description: Production macOS SysAdmin repair/diagnostic for update mdm override.
...
# Requires:    sudo / root
# Usage:       sudo zsh update-mdm-override.sh
...
export_html_report "update mdm override" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
