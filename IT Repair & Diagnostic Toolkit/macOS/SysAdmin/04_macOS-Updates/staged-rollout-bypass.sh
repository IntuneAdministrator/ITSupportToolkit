#!/bin/zsh
# ============================================================
# Script:      staged-rollout-bypass.sh
# Description: Production macOS SysAdmin repair/diagnostic for staged rollout bypass.
...
# Requires:    sudo / root
# Usage:       sudo zsh staged-rollout-bypass.sh
...
export_html_report "staged rollout bypass" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
