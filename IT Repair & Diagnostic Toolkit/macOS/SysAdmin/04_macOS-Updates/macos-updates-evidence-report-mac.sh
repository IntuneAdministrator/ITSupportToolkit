...
# ============================================================
# Script: macos-updates-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/04_macOS-Updates
# Requires: sudo | Usage: sudo zsh macos-updates-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "macos updates evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive