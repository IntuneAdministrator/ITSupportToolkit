...
# ============================================================
# Script: encrypted-dns-profile-check-mac.sh | SysAdmin/29_DNS-Network-Services | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh encrypted-dns-profile-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "encrypted dns profile check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive