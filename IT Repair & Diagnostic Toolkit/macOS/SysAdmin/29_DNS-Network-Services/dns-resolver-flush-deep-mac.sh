...
# ============================================================
# Script: dns-resolver-flush-deep-mac.sh | SysAdmin/29_DNS-Network-Services | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh dns-resolver-flush-deep-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "dns resolver flush deep mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive