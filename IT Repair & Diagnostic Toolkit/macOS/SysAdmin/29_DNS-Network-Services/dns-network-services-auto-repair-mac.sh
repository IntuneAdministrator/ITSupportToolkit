...
# ============================================================
# Script: dns-network-services-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/29_DNS-Network-Services
# Requires: sudo | Usage: sudo zsh dns-network-services-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "dns network services auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive