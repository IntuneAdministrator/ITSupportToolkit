...
# ============================================================
# Script: smb-share-performance-hint-mac.sh | Phase 13 common problems | SysAdmin/29_DNS-Network-Services
# Requires: sudo | Usage: sudo zsh smb-share-performance-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "smb share performance hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive