...
# ============================================================
# Script: ip-kvm-network-console-hint-mac.sh | Phase 13 common problems | SysAdmin/29_DNS-Network-Services
# Requires: sudo | Usage: sudo zsh ip-kvm-network-console-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "ip kvm network console hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive