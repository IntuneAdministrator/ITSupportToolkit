#!/bin/zsh
# ============================================================
# Script:      proxy-settings-clear.sh
# Description: Production macOS SysAdmin repair/diagnostic for proxy settings clear.
...
# Requires:    sudo / root
# Usage:       sudo zsh proxy-settings-clear.sh
...
export_html_report "proxy settings clear" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
