...
# ============================================================
# Script: packet-loss-wifi-audit-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh packet-loss-wifi-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "packet loss wifi audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive