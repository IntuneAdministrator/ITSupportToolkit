...
# ============================================================
# Script: corporate-proxy-pac-failure-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh corporate-proxy-pac-failure-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "corporate proxy pac failure mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive