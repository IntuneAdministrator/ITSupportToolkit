#!/bin/zsh
# ============================================================
# Script:      route-table-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for route table fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh route-table-fix.sh
...
export_html_report "route table fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
