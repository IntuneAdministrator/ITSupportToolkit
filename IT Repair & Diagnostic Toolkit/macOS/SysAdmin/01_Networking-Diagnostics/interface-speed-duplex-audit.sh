#!/bin/zsh
# ============================================================
# Script:      interface-speed-duplex-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for interface speed duplex audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh interface-speed-duplex-audit.sh
...
export_html_report "interface speed duplex audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
