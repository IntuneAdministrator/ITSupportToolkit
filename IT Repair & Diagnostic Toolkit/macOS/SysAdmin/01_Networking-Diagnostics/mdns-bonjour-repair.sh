#!/bin/zsh
# ============================================================
# Script:      mdns-bonjour-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for mdns bonjour repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdns-bonjour-repair.sh
...
export_html_report "mdns bonjour repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
