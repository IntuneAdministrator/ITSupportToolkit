#!/bin/zsh
# ============================================================
# Script:      port-connectivity-scanner.sh
# Description: Production macOS SysAdmin repair/diagnostic for port connectivity scanner.
...
# Requires:    sudo / root
# Usage:       sudo zsh port-connectivity-scanner.sh
...
export_html_report "port connectivity scanner" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
