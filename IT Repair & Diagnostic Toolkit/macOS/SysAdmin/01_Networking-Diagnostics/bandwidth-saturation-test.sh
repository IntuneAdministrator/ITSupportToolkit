#!/bin/zsh
# ============================================================
# Script:      bandwidth-saturation-test.sh
# Description: Production macOS SysAdmin repair/diagnostic for bandwidth saturation test.
...
# Requires:    sudo / root
# Usage:       sudo zsh bandwidth-saturation-test.sh
...
export_html_report "bandwidth saturation test" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
