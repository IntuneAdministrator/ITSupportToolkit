#!/bin/zsh
# ============================================================
# Script:      network-interface-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for network interface reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh network-interface-reset.sh
...
export_html_report "network interface reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
