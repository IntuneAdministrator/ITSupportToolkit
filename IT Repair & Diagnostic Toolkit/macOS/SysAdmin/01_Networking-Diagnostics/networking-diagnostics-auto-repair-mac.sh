...
# ============================================================
# Script: networking-diagnostics-auto-repair-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh networking-diagnostics-auto-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "networking diagnostics auto repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive