#!/bin/zsh
# ============================================================
# Script:      wifi-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for wifi reset.
...
export_html_report "wifi reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
