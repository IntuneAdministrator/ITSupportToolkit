#!/bin/zsh
# ============================================================
# Script:      arp-cache-flush.sh
# Description: Production macOS SysAdmin repair/diagnostic for arp cache flush.
...
# Requires:    sudo / root
# Usage:       sudo zsh arp-cache-flush.sh
...
export_html_report "arp cache flush" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
