#!/bin/zsh
# ============================================================
# Script:      dns-flush-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for dns flush repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh dns-flush-repair.sh
...
export_html_report "dns flush repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
