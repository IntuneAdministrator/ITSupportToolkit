#!/bin/zsh
# ============================================================
# Script:      dhcp-lease-renew.sh
# Description: Production macOS SysAdmin repair/diagnostic for dhcp lease renew.
...
# Requires:    sudo / root
# Usage:       sudo zsh dhcp-lease-renew.sh
...
export_html_report "dhcp lease renew" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
