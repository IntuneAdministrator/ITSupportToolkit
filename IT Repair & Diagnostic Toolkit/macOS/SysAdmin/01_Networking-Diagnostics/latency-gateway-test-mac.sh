...
# ============================================================
# Script: latency-gateway-test-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh latency-gateway-test-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "latency gateway test mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive