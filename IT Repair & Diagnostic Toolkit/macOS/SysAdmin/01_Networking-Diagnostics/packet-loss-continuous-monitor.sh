#!/bin/zsh
# ============================================================
# Script:      packet-loss-continuous-monitor.sh
# Description: Production macOS SysAdmin repair/diagnostic for packet loss continuous monitor.
...
# Requires:    sudo / root
# Usage:       sudo zsh packet-loss-continuous-monitor.sh
...
export_html_report "packet loss continuous monitor" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
