#!/bin/zsh
# ============================================================
# Script:      captive-portal-test.sh
# Description: Production macOS SysAdmin repair/diagnostic for captive portal test.
...
# Requires:    sudo / root
# Usage:       sudo zsh captive-portal-test.sh
...
export_html_report "captive portal test" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
