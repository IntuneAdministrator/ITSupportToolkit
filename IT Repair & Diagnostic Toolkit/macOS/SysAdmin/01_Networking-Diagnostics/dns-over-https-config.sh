#!/bin/zsh
# ============================================================
# Script:      dns-over-https-config.sh
# Description: Production macOS SysAdmin repair/diagnostic for dns over https config.
...
# Requires:    sudo / root
# Usage:       sudo zsh dns-over-https-config.sh
...
export_html_report "dns over https config" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
