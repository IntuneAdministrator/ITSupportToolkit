...
# ============================================================
# Script: networking-diagnostics-stack-reset-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh networking-diagnostics-stack-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "networking diagnostics stack reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive