...
# ============================================================
# Script: networking-diagnostics-policy-validate-mac.sh | Phase 13 common problems | SysAdmin/01_Networking-Diagnostics
# Requires: sudo | Usage: sudo zsh networking-diagnostics-policy-validate-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='01_Networking-Diagnostics'
...
add_report_row "Module" "01_Networking-Diagnostics" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "01_Networking-Diagnostics"
...
export_html_report "networking diagnostics policy validate mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive