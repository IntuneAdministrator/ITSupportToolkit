#!/bin/zsh
# ============================================================
# Script:      vpn-connectivity-test.sh
# Description: Production macOS SysAdmin repair/diagnostic for vpn connectivity test.
...
# Requires:    sudo / root
# Usage:       sudo zsh vpn-connectivity-test.sh
...
export_html_report "vpn connectivity test" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
