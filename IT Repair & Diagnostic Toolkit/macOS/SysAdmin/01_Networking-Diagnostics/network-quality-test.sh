#!/bin/zsh
# ============================================================
# Script:      network-quality-test.sh
# Description: Production macOS SysAdmin repair/diagnostic for network quality test.
...
# Requires:    sudo / root
# Usage:       sudo zsh network-quality-test.sh
...
export_html_report "network quality test" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
