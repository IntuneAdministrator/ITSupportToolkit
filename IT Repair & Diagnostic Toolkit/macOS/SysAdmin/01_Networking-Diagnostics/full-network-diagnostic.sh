#!/bin/zsh
# ============================================================
# Script:      full-network-diagnostic.sh
# Description: Production macOS SysAdmin repair/diagnostic for full network diagnostic.
...
# Requires:    sudo / root
# Usage:       sudo zsh full-network-diagnostic.sh
...
export_html_report "full network diagnostic" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
