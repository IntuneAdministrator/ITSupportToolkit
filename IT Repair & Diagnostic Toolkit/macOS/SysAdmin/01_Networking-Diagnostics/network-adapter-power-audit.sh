#!/bin/zsh
# ============================================================
# Script:      network-adapter-power-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for network adapter power audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh network-adapter-power-audit.sh
...
export_html_report "network adapter power audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
