#!/bin/zsh
# ============================================================
# Script:      ssid-roaming-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for ssid roaming audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh ssid-roaming-audit.sh
...
export_html_report "ssid roaming audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
