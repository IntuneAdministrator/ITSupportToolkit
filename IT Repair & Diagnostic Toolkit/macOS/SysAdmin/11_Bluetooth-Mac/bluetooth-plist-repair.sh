#!/bin/zsh
# ============================================================
# Script:      bluetooth-plist-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for bluetooth plist repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh bluetooth-plist-repair.sh
...
export_html_report "bluetooth plist repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
