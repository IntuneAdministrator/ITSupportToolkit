...
# ============================================================
# Script: magic-keyboard-firmware-hint-mac.sh | Phase 13 common problems | SysAdmin/11_Bluetooth-Mac
# Requires: sudo | Usage: sudo zsh magic-keyboard-firmware-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "magic keyboard firmware hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive