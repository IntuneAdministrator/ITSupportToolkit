#!/bin/zsh
# ============================================================
# Script:      airdrop-visibility-fix.sh
# Description: Production macOS SysAdmin repair/diagnostic for airdrop visibility fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh airdrop-visibility-fix.sh
...
export_html_report "airdrop visibility fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
