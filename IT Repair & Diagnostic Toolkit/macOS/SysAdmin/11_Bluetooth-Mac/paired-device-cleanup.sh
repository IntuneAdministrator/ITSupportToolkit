#!/bin/zsh
# ============================================================
# Script:      paired-device-cleanup.sh
# Description: Production macOS SysAdmin repair/diagnostic for paired device cleanup.
...
# Requires:    sudo / root
# Usage:       sudo zsh paired-device-cleanup.sh
...
export_html_report "paired device cleanup" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
