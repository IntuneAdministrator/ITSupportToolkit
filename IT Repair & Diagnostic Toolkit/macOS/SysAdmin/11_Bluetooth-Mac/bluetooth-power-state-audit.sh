#!/bin/zsh
# ============================================================
# Script:      bluetooth-power-state-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for bluetooth power state audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh bluetooth-power-state-audit.sh
...
export_html_report "bluetooth power state audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
