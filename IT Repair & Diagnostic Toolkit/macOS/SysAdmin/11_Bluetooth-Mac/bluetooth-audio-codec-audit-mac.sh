...
# ============================================================
# Script: bluetooth-audio-codec-audit-mac.sh | Phase 13 common problems | SysAdmin/11_Bluetooth-Mac
# Requires: sudo | Usage: sudo zsh bluetooth-audio-codec-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "bluetooth audio codec audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive