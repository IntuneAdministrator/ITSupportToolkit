...
# ============================================================
# Script: bluetooth-mac-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/11_Bluetooth-Mac
# Requires: sudo | Usage: sudo zsh bluetooth-mac-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "bluetooth mac evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive