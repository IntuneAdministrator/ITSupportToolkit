...
# ============================================================
# Script: magic-mouse-tracking-fix-mac.sh | Phase 13 common problems | SysAdmin/11_Bluetooth-Mac
# Requires: sudo | Usage: sudo zsh magic-mouse-tracking-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "magic mouse tracking fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive