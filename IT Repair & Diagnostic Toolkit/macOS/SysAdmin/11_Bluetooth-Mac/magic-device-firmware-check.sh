#!/bin/zsh
# ============================================================
# Script:      magic-device-firmware-check.sh
# Description: Production macOS SysAdmin repair/diagnostic for magic device firmware check.
...
# Requires:    sudo / root
# Usage:       sudo zsh magic-device-firmware-check.sh
...
export_html_report "magic device firmware check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
