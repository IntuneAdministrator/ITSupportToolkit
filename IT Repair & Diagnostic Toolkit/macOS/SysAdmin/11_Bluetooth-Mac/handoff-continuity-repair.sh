#!/bin/zsh
# ============================================================
# Script:      handoff-continuity-repair.sh
# Description: Production macOS SysAdmin repair/diagnostic for handoff continuity repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh handoff-continuity-repair.sh
...
export_html_report "handoff continuity repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
