#!/bin/zsh
# ============================================================
# Script:      bluetooth-stack-reset.sh
# Description: Production macOS SysAdmin repair/diagnostic for bluetooth stack reset.
...
# Requires:    sudo / root
# Usage:       sudo zsh bluetooth-stack-reset.sh
...
export_html_report "bluetooth stack reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
