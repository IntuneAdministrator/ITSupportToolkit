#!/bin/zsh
# ============================================================
# Script:      bluetooth-codec-audit.sh
# Description: Production macOS SysAdmin repair/diagnostic for bluetooth codec audit.
...
# Requires:    sudo / root
# Usage:       sudo zsh bluetooth-codec-audit.sh
...
export_html_report "bluetooth codec audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive
