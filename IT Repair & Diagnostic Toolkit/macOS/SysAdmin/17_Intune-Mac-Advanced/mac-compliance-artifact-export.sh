...
# ============================================================
# Script: mac-compliance-artifact-export.sh | Role: SysAdmin/17_Intune-Mac-Advanced | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh mac-compliance-artifact-export.sh
# ============================================================
set -euo pipefail
...
export_html_report "mac compliance artifact export" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive