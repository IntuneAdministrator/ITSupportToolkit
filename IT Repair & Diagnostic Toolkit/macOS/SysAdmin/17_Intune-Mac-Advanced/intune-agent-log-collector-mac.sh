...
# ============================================================
# Script: intune-agent-log-collector-mac.sh | Role: SysAdmin/17_Intune-Mac-Advanced | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh intune-agent-log-collector-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "intune agent log collector mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive