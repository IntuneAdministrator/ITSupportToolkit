...
# ============================================================
# Script: intune-mac-advanced-evidence-report-mac.sh | Phase 13 common problems | SysAdmin/17_Intune-Mac-Advanced
# Requires: sudo | Usage: sudo zsh intune-mac-advanced-evidence-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "intune mac advanced evidence report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive