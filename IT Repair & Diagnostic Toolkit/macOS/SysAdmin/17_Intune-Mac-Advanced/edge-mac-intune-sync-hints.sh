...
# ============================================================
# Script: edge-mac-intune-sync-hints.sh | Role: SysAdmin/17_Intune-Mac-Advanced | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh edge-mac-intune-sync-hints.sh
# ============================================================
set -euo pipefail
...
export_html_report "edge mac intune sync hints" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive