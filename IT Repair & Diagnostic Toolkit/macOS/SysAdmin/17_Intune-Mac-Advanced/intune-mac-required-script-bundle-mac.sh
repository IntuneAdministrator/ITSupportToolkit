...
# ============================================================
# Script: intune-mac-required-script-bundle-mac.sh | Phase 13 common problems | SysAdmin/17_Intune-Mac-Advanced
# Requires: sudo | Usage: sudo zsh intune-mac-required-script-bundle-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='17_Intune-Mac-Advanced'
...
add_report_row "Module" "17_Intune-Mac-Advanced" "INFO" "SysAdmin"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "17_Intune-Mac-Advanced"
...
export_html_report "intune mac required script bundle mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive