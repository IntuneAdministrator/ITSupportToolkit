...
# ============================================================
# Script: company-portal-crash-mac.sh | Phase 13 common problems | SysAdmin/17_Intune-Mac-Advanced
# Requires: sudo | Usage: sudo zsh company-portal-crash-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "company portal crash mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive