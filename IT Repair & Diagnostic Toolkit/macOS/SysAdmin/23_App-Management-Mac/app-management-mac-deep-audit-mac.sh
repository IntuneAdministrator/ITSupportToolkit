...
# ============================================================
# Script: app-management-mac-deep-audit-mac.sh | Phase 13 common problems | SysAdmin/23_App-Management-Mac
# Requires: sudo | Usage: sudo zsh app-management-mac-deep-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "app management mac deep audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive