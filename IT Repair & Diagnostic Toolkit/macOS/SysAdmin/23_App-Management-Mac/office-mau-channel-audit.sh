...
# ============================================================
# Script: office-mau-channel-audit.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh office-mau-channel-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "office mau channel audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive