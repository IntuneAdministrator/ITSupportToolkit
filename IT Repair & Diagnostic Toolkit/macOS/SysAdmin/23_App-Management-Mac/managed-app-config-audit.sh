...
# ============================================================
# Script: managed-app-config-audit.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh managed-app-config-audit.sh
# ============================================================
set -euo pipefail
...
export_html_report "managed app config audit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive