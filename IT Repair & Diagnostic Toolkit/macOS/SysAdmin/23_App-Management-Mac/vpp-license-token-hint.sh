...
# ============================================================
# Script: vpp-license-token-hint.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh vpp-license-token-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "vpp license token hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive