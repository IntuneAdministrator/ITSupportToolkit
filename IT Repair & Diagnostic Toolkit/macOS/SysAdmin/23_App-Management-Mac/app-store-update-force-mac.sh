...
# ============================================================
# Script: app-store-update-force-mac.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh app-store-update-force-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "app store update force mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive