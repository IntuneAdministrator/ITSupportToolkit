...
# ============================================================
# Script: pkg-bom-integrity-check.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh pkg-bom-integrity-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "pkg bom integrity check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive