...
# ============================================================
# Script: notarization-staple-verify.sh | SysAdmin/23_App-Management-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh notarization-staple-verify.sh
# ============================================================
set -euo pipefail
...
export_html_report "notarization staple verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive