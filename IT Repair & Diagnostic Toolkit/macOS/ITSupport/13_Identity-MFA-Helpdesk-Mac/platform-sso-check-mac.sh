...
# ============================================================
# Script: platform-sso-check-mac.sh | Role: ITSupport/13_Identity-MFA-Helpdesk-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh platform-sso-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "platform sso check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive