...
# ============================================================
# Script: keychain-sso-flush-mac.sh | Role: ITSupport/13_Identity-MFA-Helpdesk-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh keychain-sso-flush-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "keychain sso flush mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive