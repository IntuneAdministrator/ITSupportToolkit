...
# ============================================================
# Script: identity-mfa-helpdesk-mac-quick-repair-mac.sh | Phase 13 common problems | ITSupport/13_Identity-MFA-Helpdesk-Mac
# Requires: sudo | Usage: sudo zsh identity-mfa-helpdesk-mac-quick-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "identity mfa helpdesk mac quick repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive