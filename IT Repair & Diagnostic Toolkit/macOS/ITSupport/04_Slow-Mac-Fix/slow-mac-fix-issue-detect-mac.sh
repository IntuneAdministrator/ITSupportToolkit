...
# ============================================================
# Script: slow-mac-fix-issue-detect-mac.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh slow-mac-fix-issue-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "slow mac fix issue detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive