#!/bin/zsh
# ============================================================
# Script:      disk-space-emergency-free-mac.sh
# Description: macOS IT Support quick repair for disk space emergency free mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh disk-space-emergency-free-mac.sh
...
export_html_report "disk space emergency free mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive