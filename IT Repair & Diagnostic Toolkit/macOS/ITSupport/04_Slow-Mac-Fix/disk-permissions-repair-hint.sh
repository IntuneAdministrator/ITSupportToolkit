...
# ============================================================
# Script: disk-permissions-repair-hint.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh disk-permissions-repair-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "disk permissions repair hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive