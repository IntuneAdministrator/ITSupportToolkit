...
# ============================================================
# Script: icloud-sync-high-cpu.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh icloud-sync-high-cpu.sh
# ============================================================
set -euo pipefail
...
export_html_report "icloud sync high cpu" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive