#!/bin/zsh
# ============================================================
# Script:      ram-pressure-quick-report-mac.sh
# Description: macOS IT Support quick repair for ram pressure quick report mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh ram-pressure-quick-report-mac.sh
...
export_html_report "ram pressure quick report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive