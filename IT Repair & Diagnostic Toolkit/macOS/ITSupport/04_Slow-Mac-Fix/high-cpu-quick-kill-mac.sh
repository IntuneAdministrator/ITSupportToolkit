#!/bin/zsh
# ============================================================
# Script:      high-cpu-quick-kill-mac.sh
# Description: macOS IT Support quick repair for high cpu quick kill mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh high-cpu-quick-kill-mac.sh
...
export_html_report "high cpu quick kill mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive