#!/bin/zsh
# ============================================================
# Script:      spotlight-quick-reindex.sh
# Description: macOS IT Support quick repair for spotlight quick reindex.
...
# Requires:    sudo / root
# Usage:       sudo zsh spotlight-quick-reindex.sh
...
export_html_report "spotlight quick reindex" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive