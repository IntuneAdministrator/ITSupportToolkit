#!/bin/zsh
# ============================================================
# Script:      ssd-health-quick-check-mac.sh
# Description: macOS IT Support quick repair for ssd health quick check mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh ssd-health-quick-check-mac.sh
...
export_html_report "ssd health quick check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive