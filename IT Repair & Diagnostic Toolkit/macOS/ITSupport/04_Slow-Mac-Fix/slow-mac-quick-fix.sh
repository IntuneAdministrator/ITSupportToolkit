#!/bin/zsh
# ============================================================
# Script:      slow-mac-quick-fix.sh
# Description: macOS IT Support quick repair for slow mac quick fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh slow-mac-quick-fix.sh
...
export_html_report "slow mac quick fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive