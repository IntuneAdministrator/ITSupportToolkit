...
# ============================================================
# Script: smc-reset-guide-mac.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh smc-reset-guide-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "smc reset guide mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive