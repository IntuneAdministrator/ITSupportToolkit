#!/bin/zsh
# ============================================================
# Script:      startup-bloat-remover-mac.sh
# Description: macOS IT Support quick repair for startup bloat remover mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh startup-bloat-remover-mac.sh
...
export_html_report "startup bloat remover mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive