...
# ============================================================
# Script: time-machine-local-snapshot-full.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh time-machine-local-snapshot-full.sh
# ============================================================
set -euo pipefail
...
export_html_report "time machine local snapshot full" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive