...
# ============================================================
# Script: memory-compression-heavy.sh | Phase 13 common problems | ITSupport/04_Slow-Mac-Fix
# Requires: sudo | Usage: sudo zsh memory-compression-heavy.sh
# ============================================================
set -euo pipefail
...
export_html_report "memory compression heavy" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive