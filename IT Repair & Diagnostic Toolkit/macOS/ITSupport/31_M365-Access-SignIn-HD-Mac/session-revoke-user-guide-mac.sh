...
# ============================================================
# Script: session-revoke-user-guide-mac.sh | ITSupport/31_M365-Access-SignIn-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh session-revoke-user-guide-mac.sh [user@domain.com]
...
export_html_report "session revoke user guide mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive