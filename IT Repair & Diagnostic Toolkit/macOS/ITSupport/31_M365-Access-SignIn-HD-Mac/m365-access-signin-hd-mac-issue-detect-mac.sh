...
# ============================================================
# Script: m365-access-signin-hd-mac-issue-detect-mac.sh | Phase 13 common problems | ITSupport/31_M365-Access-SignIn-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-access-signin-hd-mac-issue-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 access signin hd mac issue detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive