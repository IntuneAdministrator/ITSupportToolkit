...
# ============================================================
# Script: service-health-user-impact-mac.sh | ITSupport/31_M365-Access-SignIn-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh service-health-user-impact-mac.sh [user@domain.com]
...
export_html_report "service health user impact mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive