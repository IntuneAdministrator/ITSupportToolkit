...
# ============================================================
# Script: legacy-auth-blocked-outlook-mac.sh | ITSupport/31_M365-Access-SignIn-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh legacy-auth-blocked-outlook-mac.sh [user@domain.com]
...
export_html_report "legacy auth blocked outlook mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive