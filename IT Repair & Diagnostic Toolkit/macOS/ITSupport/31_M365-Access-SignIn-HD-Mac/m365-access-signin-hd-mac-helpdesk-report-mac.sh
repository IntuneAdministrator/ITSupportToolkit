...
# ============================================================
# Script: m365-access-signin-hd-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/31_M365-Access-SignIn-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-access-signin-hd-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='31_M365-Access-SignIn-HD-Mac'
...
add_report_row "Module" "31_M365-Access-SignIn-HD-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "31_M365-Access-SignIn-HD-Mac"
...
export_html_report "m365 access signin hd mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive