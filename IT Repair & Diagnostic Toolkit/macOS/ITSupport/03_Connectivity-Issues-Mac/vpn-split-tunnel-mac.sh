...
# ============================================================
# Script: vpn-split-tunnel-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh vpn-split-tunnel-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "vpn split tunnel mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive