...
# ============================================================
# Script: thunderbolt-bridge-down.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh thunderbolt-bridge-down.sh
# ============================================================
set -euo pipefail
...
export_html_report "thunderbolt bridge down" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive