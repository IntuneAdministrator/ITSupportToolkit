...
# ============================================================
# Script: runbook-wifi-ethernet-full-fix-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh runbook-wifi-ethernet-full-fix-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='03_Connectivity-Issues-Mac'
...
add_report_row "Module" "03_Connectivity-Issues-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "03_Connectivity-Issues-Mac"
...
export_html_report "runbook wifi ethernet full fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive