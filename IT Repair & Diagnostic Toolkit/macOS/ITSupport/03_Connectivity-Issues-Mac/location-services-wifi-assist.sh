...
# ============================================================
# Script: location-services-wifi-assist.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh location-services-wifi-assist.sh
# ============================================================
set -euo pipefail
...
export_html_report "location services wifi assist" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive