...
# ============================================================
# Script: network-location-wrong.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh network-location-wrong.sh
# ============================================================
set -euo pipefail
...
export_html_report "network location wrong" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive