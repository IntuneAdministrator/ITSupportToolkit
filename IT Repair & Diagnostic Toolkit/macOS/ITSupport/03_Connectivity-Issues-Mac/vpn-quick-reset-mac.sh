#!/bin/zsh
# ============================================================
# Script:      vpn-quick-reset-mac.sh
# Description: macOS IT Support quick repair for vpn quick reset mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh vpn-quick-reset-mac.sh
...
export_html_report "vpn quick reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive