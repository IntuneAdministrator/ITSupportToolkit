#!/bin/zsh
# ============================================================
# Script:      wifi-reconnect-quick-mac.sh
# Description: macOS IT Support quick repair for wifi reconnect quick mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh wifi-reconnect-quick-mac.sh
...
export_html_report "wifi reconnect quick mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive