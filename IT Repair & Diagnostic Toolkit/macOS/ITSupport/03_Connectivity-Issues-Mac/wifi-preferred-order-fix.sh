...
# ============================================================
# Script: wifi-preferred-order-fix.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh wifi-preferred-order-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "wifi preferred order fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive