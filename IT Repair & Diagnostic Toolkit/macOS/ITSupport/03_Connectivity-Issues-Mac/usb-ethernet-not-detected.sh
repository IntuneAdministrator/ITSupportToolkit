...
# ============================================================
# Script: usb-ethernet-not-detected.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh usb-ethernet-not-detected.sh
# ============================================================
set -euo pipefail
...
export_html_report "usb ethernet not detected" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive