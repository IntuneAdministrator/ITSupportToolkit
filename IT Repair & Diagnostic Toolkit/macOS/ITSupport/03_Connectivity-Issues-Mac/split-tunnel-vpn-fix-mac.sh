#!/bin/zsh
# ============================================================
# Script:      split-tunnel-vpn-fix-mac.sh
# Description: macOS IT Support quick repair for split tunnel vpn fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh split-tunnel-vpn-fix-mac.sh
...
export_html_report "split tunnel vpn fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive