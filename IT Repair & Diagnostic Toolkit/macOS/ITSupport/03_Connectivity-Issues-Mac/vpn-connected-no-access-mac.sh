...
# ============================================================
# Script: vpn-connected-no-access-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh vpn-connected-no-access-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "vpn connected no access mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive