#!/bin/zsh
# ============================================================
# Script:      proxy-settings-quick-clear-mac.sh
# Description: macOS IT Support quick repair for proxy settings quick clear mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh proxy-settings-quick-clear-mac.sh
...
export_html_report "proxy settings quick clear mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive