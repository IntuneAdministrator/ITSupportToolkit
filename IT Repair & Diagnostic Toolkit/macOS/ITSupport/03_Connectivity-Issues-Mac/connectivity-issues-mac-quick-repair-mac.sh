...
# ============================================================
# Script: connectivity-issues-mac-quick-repair-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh connectivity-issues-mac-quick-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "connectivity issues mac quick repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive