...
# ============================================================
# Script: proxy-autoconfig-fail-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh proxy-autoconfig-fail-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "proxy autoconfig fail mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive