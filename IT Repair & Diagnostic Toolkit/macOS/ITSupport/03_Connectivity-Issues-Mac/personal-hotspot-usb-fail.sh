...
# ============================================================
# Script: personal-hotspot-usb-fail.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh personal-hotspot-usb-fail.sh
# ============================================================
set -euo pipefail
...
export_html_report "personal hotspot usb fail" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive