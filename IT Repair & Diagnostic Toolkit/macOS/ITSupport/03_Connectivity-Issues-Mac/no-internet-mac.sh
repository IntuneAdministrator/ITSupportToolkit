#!/bin/zsh
# ============================================================
# Script:      no-internet-mac.sh
# Description: macOS IT Support quick repair for no internet mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh no-internet-mac.sh
...
export_html_report "no internet mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive