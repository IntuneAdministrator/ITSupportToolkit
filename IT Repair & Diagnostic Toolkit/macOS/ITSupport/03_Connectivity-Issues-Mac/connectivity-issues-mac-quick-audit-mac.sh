...
# ============================================================
# Script: connectivity-issues-mac-quick-audit-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh connectivity-issues-mac-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "connectivity issues mac quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive