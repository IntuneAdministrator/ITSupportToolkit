#!/bin/zsh
# ============================================================
# Script:      dns-quick-fix-mac.sh
# Description: macOS IT Support quick repair for dns quick fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh dns-quick-fix-mac.sh
...
export_html_report "dns quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive