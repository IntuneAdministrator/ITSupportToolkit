...
# ============================================================
# Script: wifi-wrong-password-loop.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh wifi-wrong-password-loop.sh
# ============================================================
set -euo pipefail
...
export_html_report "wifi wrong password loop" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive