...
# ============================================================
# Script: wifi-no-internet-connected-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh wifi-no-internet-connected-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "wifi no internet connected mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive