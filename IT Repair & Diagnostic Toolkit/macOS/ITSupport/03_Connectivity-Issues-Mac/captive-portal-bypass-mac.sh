#!/bin/zsh
# ============================================================
# Script:      captive-portal-bypass-mac.sh
# Description: macOS IT Support quick repair for captive portal bypass mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh captive-portal-bypass-mac.sh
...
export_html_report "captive portal bypass mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive