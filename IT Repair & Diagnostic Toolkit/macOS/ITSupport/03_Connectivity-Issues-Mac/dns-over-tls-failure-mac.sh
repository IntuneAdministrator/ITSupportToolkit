...
# ============================================================
# Script: dns-over-tls-failure-mac.sh | Phase 13 common problems | ITSupport/03_Connectivity-Issues-Mac
# Requires: sudo | Usage: sudo zsh dns-over-tls-failure-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "dns over tls failure mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive