...
# ============================================================
# Script: home-wifi-mtu-fix-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh home-wifi-mtu-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "home wifi mtu fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive