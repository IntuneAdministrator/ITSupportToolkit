...
# ============================================================
# Script: remote-work-mac-quick-repair-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh remote-work-mac-quick-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "remote work mac quick repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive