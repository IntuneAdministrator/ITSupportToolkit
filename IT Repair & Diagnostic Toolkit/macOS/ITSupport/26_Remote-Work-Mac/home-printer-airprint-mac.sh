...
# ============================================================
# Script: home-printer-airprint-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh home-printer-airprint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "home printer airprint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive