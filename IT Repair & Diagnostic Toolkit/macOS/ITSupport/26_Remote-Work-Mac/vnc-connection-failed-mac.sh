...
# ============================================================
# Script: vnc-connection-failed-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh vnc-connection-failed-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "vnc connection failed mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive