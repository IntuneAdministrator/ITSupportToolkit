...
# ============================================================
# Script: clamshell-dual-monitor-scaling-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh clamshell-dual-monitor-scaling-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "clamshell dual monitor scaling mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive