...
# ============================================================
# Script: remote-work-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh remote-work-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='26_Remote-Work-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "26_Remote-Work-Mac"
...
export_html_report "remote work mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive