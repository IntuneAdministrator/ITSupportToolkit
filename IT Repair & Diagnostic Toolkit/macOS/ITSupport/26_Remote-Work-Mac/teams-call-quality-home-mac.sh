...
# ============================================================
# Script: teams-call-quality-home-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh teams-call-quality-home-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "teams call quality home mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive