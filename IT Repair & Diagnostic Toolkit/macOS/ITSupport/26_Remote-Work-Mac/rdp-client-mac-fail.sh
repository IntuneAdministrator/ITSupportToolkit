...
# ============================================================
# Script: rdp-client-mac-fail.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh rdp-client-mac-fail.sh
# ============================================================
set -euo pipefail
...
export_html_report "rdp client mac fail" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive