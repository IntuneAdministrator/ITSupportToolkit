...
# ============================================================
# Script: home-wifi-dns-quick-mac.sh | ITSupport/26_Remote-Work-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh home-wifi-dns-quick-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "home wifi dns quick mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive