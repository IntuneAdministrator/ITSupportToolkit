...
# ============================================================
# Script: screen-sharing-not-working-mac.sh | Phase 13 common problems | ITSupport/26_Remote-Work-Mac
# Requires: sudo | Usage: sudo zsh screen-sharing-not-working-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "screen sharing not working mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive