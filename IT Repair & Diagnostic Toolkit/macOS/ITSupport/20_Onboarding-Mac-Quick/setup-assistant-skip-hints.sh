...
# ============================================================
# Script: setup-assistant-skip-hints.sh | ITSupport/20_Onboarding-Mac-Quick | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh setup-assistant-skip-hints.sh
# ============================================================
set -euo pipefail
...
export_html_report "setup assistant skip hints" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive