...
# ============================================================
# Script: migration-assistant-prep-mac.sh | ITSupport/20_Onboarding-Mac-Quick | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh migration-assistant-prep-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "migration assistant prep mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive