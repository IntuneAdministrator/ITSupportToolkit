...
# ============================================================
# Script: onboarding-mac-quick-issue-detect-mac.sh | Phase 13 common problems | ITSupport/20_Onboarding-Mac-Quick
# Requires: sudo | Usage: sudo zsh onboarding-mac-quick-issue-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "onboarding mac quick issue detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive