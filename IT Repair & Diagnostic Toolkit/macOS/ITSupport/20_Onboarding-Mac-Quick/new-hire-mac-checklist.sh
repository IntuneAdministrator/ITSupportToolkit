...
# ============================================================
# Script: new-hire-mac-checklist.sh | ITSupport/20_Onboarding-Mac-Quick | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh new-hire-mac-checklist.sh
# ============================================================
set -euo pipefail
...
export_html_report "new hire mac checklist" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive