...
# ============================================================
# Script: onboarding-mac-quick-reset-stack-mac.sh | Phase 13 common problems | ITSupport/20_Onboarding-Mac-Quick
# Requires: sudo | Usage: sudo zsh onboarding-mac-quick-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "onboarding mac quick reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive