...
# ============================================================
# Script: m365-teams-onedrive-hd-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/30_M365-Teams-OneDrive-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-teams-onedrive-hd-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='30_M365-Teams-OneDrive-HD-Mac'
...
add_report_row "Module" "30_M365-Teams-OneDrive-HD-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "30_M365-Teams-OneDrive-HD-Mac"
...
export_html_report "m365 teams onedrive hd mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive