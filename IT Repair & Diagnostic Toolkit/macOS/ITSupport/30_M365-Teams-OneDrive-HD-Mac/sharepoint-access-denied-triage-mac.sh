...
# ============================================================
# Script: sharepoint-access-denied-triage-mac.sh | ITSupport/30_M365-Teams-OneDrive-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh sharepoint-access-denied-triage-mac.sh [user@domain.com]
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='30_M365-Teams-OneDrive-HD-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "30_M365-Teams-OneDrive-HD-Mac" "INFO" "ITSupport Phase12 M365"
...
export_html_report "sharepoint access denied triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive