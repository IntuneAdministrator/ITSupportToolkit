...
# ============================================================
# Script: m365-teams-onedrive-hd-mac-user-triage-mac.sh | Phase 13 common problems | ITSupport/30_M365-Teams-OneDrive-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-teams-onedrive-hd-mac-user-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 teams onedrive hd mac user triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive