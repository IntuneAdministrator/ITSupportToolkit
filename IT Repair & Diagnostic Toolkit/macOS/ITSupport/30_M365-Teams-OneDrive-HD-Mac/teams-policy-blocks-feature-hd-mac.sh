...
# ============================================================
# Script: teams-policy-blocks-feature-hd-mac.sh | ITSupport/30_M365-Teams-OneDrive-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh teams-policy-blocks-feature-hd-mac.sh [user@domain.com]
...
export_html_report "teams policy blocks feature hd mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive