...
# ============================================================
# Script: clamshell-mode-display-fix.sh | ITSupport/18_Laptop-Travel-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh clamshell-mode-display-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "clamshell mode display fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive