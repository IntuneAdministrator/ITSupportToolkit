...
# ============================================================
# Script: usb-c-hub-overheating-mac.sh | Phase 13 common problems | ITSupport/18_Laptop-Travel-Mac
# Requires: sudo | Usage: sudo zsh usb-c-hub-overheating-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "usb c hub overheating mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive