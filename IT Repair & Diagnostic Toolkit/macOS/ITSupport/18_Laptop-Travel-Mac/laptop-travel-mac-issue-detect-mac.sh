...
# ============================================================
# Script: laptop-travel-mac-issue-detect-mac.sh | Phase 13 common problems | ITSupport/18_Laptop-Travel-Mac
# Requires: sudo | Usage: sudo zsh laptop-travel-mac-issue-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "laptop travel mac issue detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive