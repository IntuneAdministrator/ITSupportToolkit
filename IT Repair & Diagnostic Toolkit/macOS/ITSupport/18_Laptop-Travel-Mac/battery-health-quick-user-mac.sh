...
# ============================================================
# Script: battery-health-quick-user-mac.sh | ITSupport/18_Laptop-Travel-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh battery-health-quick-user-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='18_Laptop-Travel-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "18_Laptop-Travel-Mac" "INFO" "ITSupport"
...
export_html_report "battery health quick user mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive