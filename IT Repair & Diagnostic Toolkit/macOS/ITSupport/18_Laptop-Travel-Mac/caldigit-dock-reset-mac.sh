...
# ============================================================
# Script: caldigit-dock-reset-mac.sh | Phase 13 common problems | ITSupport/18_Laptop-Travel-Mac
# Requires: sudo | Usage: sudo zsh caldigit-dock-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "caldigit dock reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive