...
# ============================================================
# Script: hotspot-personal-quick-mac.sh | ITSupport/18_Laptop-Travel-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh hotspot-personal-quick-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "hotspot personal quick mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive