...
# ============================================================
# Script: laptop-travel-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/18_Laptop-Travel-Mac
# Requires: sudo | Usage: sudo zsh laptop-travel-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='18_Laptop-Travel-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "18_Laptop-Travel-Mac"
...
export_html_report "laptop travel mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive