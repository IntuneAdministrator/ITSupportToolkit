...
# ============================================================
# Script: external-gpu-egpu-mac-hint-mac.sh | Phase 13 common problems | ITSupport/18_Laptop-Travel-Mac
# Requires: sudo | Usage: sudo zsh external-gpu-egpu-mac-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "external gpu egpu mac hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive