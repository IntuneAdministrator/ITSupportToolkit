...
# ============================================================
# Script: security-helpdesk-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/19_Security-Helpdesk-Mac
# Requires: sudo | Usage: sudo zsh security-helpdesk-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='19_Security-Helpdesk-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "19_Security-Helpdesk-Mac"
...
export_html_report "security helpdesk mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive