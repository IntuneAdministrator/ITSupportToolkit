...
# ============================================================
# Script: security-helpdesk-mac-reset-stack-mac.sh | Phase 13 common problems | ITSupport/19_Security-Helpdesk-Mac
# Requires: sudo | Usage: sudo zsh security-helpdesk-mac-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "security helpdesk mac reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive