...
# ============================================================
# Script: firewall-stealth-mode-check.sh | ITSupport/19_Security-Helpdesk-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh firewall-stealth-mode-check.sh
# ============================================================
set -euo pipefail
...
export_html_report "firewall stealth mode check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive