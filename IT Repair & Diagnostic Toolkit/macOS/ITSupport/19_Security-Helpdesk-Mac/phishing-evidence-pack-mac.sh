...
# ============================================================
# Script: phishing-evidence-pack-mac.sh | ITSupport/19_Security-Helpdesk-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh phishing-evidence-pack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "phishing evidence pack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive