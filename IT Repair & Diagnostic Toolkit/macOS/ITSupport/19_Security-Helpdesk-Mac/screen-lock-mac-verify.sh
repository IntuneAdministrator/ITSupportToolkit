...
# ============================================================
# Script: screen-lock-mac-verify.sh | ITSupport/19_Security-Helpdesk-Mac | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh screen-lock-mac-verify.sh
# ============================================================
set -euo pipefail
...
export_html_report "screen lock mac verify" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive