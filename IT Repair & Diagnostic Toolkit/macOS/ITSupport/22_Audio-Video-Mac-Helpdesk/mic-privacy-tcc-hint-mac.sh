...
# ============================================================
# Script: mic-privacy-tcc-hint-mac.sh | ITSupport/22_Audio-Video-Mac-Helpdesk | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh mic-privacy-tcc-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mic privacy tcc hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive