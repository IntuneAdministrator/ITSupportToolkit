...
# ============================================================
# Script: hdmi-display-audio-mac.sh | ITSupport/22_Audio-Video-Mac-Helpdesk | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh hdmi-display-audio-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "hdmi display audio mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive