...
# ============================================================
# Script: teams-zoom-av-quit-relaunch-mac.sh | ITSupport/22_Audio-Video-Mac-Helpdesk | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh teams-zoom-av-quit-relaunch-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='22_Audio-Video-Mac-Helpdesk'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
section_banner "ITSUPPORT MAC PHASE11"
...
export_html_report "teams zoom av quit relaunch mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive