...
# ============================================================
# Script: audio-video-mac-helpdesk-reset-stack-mac.sh | Phase 13 common problems | ITSupport/22_Audio-Video-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh audio-video-mac-helpdesk-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "audio video mac helpdesk reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive