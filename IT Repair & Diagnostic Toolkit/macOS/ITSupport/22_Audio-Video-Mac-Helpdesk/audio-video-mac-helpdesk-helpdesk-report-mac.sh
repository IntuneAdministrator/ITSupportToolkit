...
# ============================================================
# Script: audio-video-mac-helpdesk-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/22_Audio-Video-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh audio-video-mac-helpdesk-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='22_Audio-Video-Mac-Helpdesk'
...
add_report_row "Module" "22_Audio-Video-Mac-Helpdesk" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "22_Audio-Video-Mac-Helpdesk"
...
export_html_report "audio video mac helpdesk helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive