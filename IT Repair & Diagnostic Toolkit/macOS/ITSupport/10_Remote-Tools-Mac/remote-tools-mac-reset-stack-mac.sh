...
# ============================================================
# Script: remote-tools-mac-reset-stack-mac.sh | Phase 13 common problems | ITSupport/10_Remote-Tools-Mac
# Requires: sudo | Usage: sudo zsh remote-tools-mac-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "remote tools mac reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive