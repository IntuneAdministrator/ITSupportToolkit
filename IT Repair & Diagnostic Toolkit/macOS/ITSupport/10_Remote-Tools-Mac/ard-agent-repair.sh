#!/bin/zsh
# ============================================================
# Script:      ard-agent-repair.sh
# Description: macOS IT Support quick repair for ard agent repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh ard-agent-repair.sh
...
export_html_report "ard agent repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive