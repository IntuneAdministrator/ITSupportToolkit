#!/bin/zsh
# ============================================================
# Script:      enable-remote-support-mac.sh
# Description: macOS IT Support quick repair for enable remote support mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh enable-remote-support-mac.sh
...
export_html_report "enable remote support mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive