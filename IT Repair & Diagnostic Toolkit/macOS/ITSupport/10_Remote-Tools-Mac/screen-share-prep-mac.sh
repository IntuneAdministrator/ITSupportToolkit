#!/bin/zsh
# ============================================================
# Script:      screen-share-prep-mac.sh
# Description: macOS IT Support quick repair for screen share prep mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh screen-share-prep-mac.sh
...
export_html_report "screen share prep mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive