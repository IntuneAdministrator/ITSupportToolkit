#!/bin/zsh
# ============================================================
# Script:      remote-login-enable-mac.sh
# Description: macOS IT Support quick repair for remote login enable mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh remote-login-enable-mac.sh
...
export_html_report "remote login enable mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive