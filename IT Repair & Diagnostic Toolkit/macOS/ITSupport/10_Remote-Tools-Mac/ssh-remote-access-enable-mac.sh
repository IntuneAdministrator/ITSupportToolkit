#!/bin/zsh
# ============================================================
# Script:      ssh-remote-access-enable-mac.sh
# Description: macOS IT Support quick repair for ssh remote access enable mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh ssh-remote-access-enable-mac.sh
...
export_html_report "ssh remote access enable mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive