#!/bin/zsh
# ============================================================
# Script:      remote-management-enable-mac.sh
# Description: macOS IT Support quick repair for remote management enable mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh remote-management-enable-mac.sh
...
export_html_report "remote management enable mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive