...
# ============================================================
# Script: dictation-siri-privacy-check-mac.sh | ITSupport/23_Language-Region-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh dictation-siri-privacy-check-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='23_Language-Region-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
export_html_report "dictation siri privacy check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive