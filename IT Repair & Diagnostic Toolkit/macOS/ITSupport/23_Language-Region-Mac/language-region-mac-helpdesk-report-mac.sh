...
# ============================================================
# Script: language-region-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/23_Language-Region-Mac
# Requires: sudo | Usage: sudo zsh language-region-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='23_Language-Region-Mac'
...
add_report_row "Module" "23_Language-Region-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "23_Language-Region-Mac"
...
export_html_report "language region mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive