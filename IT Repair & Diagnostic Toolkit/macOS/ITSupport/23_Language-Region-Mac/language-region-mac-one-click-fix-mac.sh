...
# ============================================================
# Script: language-region-mac-one-click-fix-mac.sh | Phase 13 common problems | ITSupport/23_Language-Region-Mac
# Requires: sudo | Usage: sudo zsh language-region-mac-one-click-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "language region mac one click fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive