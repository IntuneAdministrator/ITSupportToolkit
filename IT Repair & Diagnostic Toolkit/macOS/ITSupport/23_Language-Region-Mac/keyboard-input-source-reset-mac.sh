...
# ============================================================
# Script: keyboard-input-source-reset-mac.sh | ITSupport/23_Language-Region-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh keyboard-input-source-reset-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "keyboard input source reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive