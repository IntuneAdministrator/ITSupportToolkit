#!/bin/zsh
# ============================================================
# Script:      facetime-camera-quick-repair.sh
# Description: macOS IT Support quick repair for facetime camera quick repair.
...
# Requires:    sudo / root
# Usage:       sudo zsh facetime-camera-quick-repair.sh
...
export_html_report "facetime camera quick repair" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive