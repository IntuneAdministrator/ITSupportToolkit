...
# ============================================================
# Script: hdmi-no-audio-output-mac.sh | Phase 13 common problems | ITSupport/07_Audio-Video-Webcam-Mac
# Requires: sudo | Usage: sudo zsh hdmi-no-audio-output-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "hdmi no audio output mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive