#!/bin/zsh
# ============================================================
# Script:      continuity-camera-quick-fix.sh
# Description: macOS IT Support quick repair for continuity camera quick fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh continuity-camera-quick-fix.sh
...
export_html_report "continuity camera quick fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive