...
# ============================================================
# Script: conference-speakerphone-mac.sh | Phase 13 common problems | ITSupport/07_Audio-Video-Webcam-Mac
# Requires: sudo | Usage: sudo zsh conference-speakerphone-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "conference speakerphone mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive