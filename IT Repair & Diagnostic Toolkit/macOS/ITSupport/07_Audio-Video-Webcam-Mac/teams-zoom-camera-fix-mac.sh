#!/bin/zsh
# ============================================================
# Script:      teams-zoom-camera-fix-mac.sh
# Description: macOS IT Support quick repair for teams zoom camera fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-zoom-camera-fix-mac.sh
...
export_html_report "teams zoom camera fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive