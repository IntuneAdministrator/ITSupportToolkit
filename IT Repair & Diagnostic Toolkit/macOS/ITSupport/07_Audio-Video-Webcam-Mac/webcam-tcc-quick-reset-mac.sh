#!/bin/zsh
# ============================================================
# Script:      webcam-tcc-quick-reset-mac.sh
# Description: macOS IT Support quick repair for webcam tcc quick reset mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh webcam-tcc-quick-reset-mac.sh
...
export_html_report "webcam tcc quick reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive