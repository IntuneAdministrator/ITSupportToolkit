#!/bin/zsh
# ============================================================
# Script:      webcam-quick-fix-mac.sh
# Description: macOS IT Support quick repair for webcam quick fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh webcam-quick-fix-mac.sh
...
export_html_report "webcam quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive