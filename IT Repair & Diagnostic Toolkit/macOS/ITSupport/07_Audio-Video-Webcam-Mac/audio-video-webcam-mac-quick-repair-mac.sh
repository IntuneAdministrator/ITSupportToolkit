...
# ============================================================
# Script: audio-video-webcam-mac-quick-repair-mac.sh | Phase 13 common problems | ITSupport/07_Audio-Video-Webcam-Mac
# Requires: sudo | Usage: sudo zsh audio-video-webcam-mac-quick-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "audio video webcam mac quick repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive