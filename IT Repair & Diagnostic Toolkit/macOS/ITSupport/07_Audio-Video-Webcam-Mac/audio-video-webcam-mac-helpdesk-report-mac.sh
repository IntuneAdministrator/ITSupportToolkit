...
# ============================================================
# Script: audio-video-webcam-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/07_Audio-Video-Webcam-Mac
# Requires: sudo | Usage: sudo zsh audio-video-webcam-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='07_Audio-Video-Webcam-Mac'
...
add_report_row "Module" "07_Audio-Video-Webcam-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "07_Audio-Video-Webcam-Mac"
...
export_html_report "audio video webcam mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive