#!/bin/zsh
# ============================================================
# Script:      sound-not-working-mac.sh
# Description: macOS IT Support quick repair for sound not working mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh sound-not-working-mac.sh
...
export_html_report "sound not working mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive