#!/bin/zsh
# ============================================================
# Script:      screen-resolution-mac-fix.sh
# Description: macOS IT Support quick repair for screen resolution mac fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh screen-resolution-mac-fix.sh
...
export_html_report "screen resolution mac fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive