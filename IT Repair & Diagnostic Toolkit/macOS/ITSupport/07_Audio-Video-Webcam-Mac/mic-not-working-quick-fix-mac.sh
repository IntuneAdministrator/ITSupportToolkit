#!/bin/zsh
# ============================================================
# Script:      mic-not-working-quick-fix-mac.sh
# Description: macOS IT Support quick repair for mic not working quick fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh mic-not-working-quick-fix-mac.sh
...
export_html_report "mic not working quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive