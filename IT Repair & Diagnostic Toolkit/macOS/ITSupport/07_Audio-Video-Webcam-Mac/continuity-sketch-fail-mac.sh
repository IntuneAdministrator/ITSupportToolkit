...
# ============================================================
# Script: continuity-sketch-fail-mac.sh | Phase 13 common problems | ITSupport/07_Audio-Video-Webcam-Mac
# Requires: sudo | Usage: sudo zsh continuity-sketch-fail-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "continuity sketch fail mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive