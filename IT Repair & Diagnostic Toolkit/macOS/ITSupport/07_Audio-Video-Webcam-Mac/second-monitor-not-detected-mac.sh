#!/bin/zsh
# ============================================================
# Script:      second-monitor-not-detected-mac.sh
# Description: macOS IT Support quick repair for second monitor not detected mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh second-monitor-not-detected-mac.sh
...
export_html_report "second monitor not detected mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive