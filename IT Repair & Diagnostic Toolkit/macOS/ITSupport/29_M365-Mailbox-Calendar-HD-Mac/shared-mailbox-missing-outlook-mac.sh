...
# ============================================================
# Script: shared-mailbox-missing-outlook-mac.sh | ITSupport/29_M365-Mailbox-Calendar-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh shared-mailbox-missing-outlook-mac.sh [user@domain.com]
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='29_M365-Mailbox-Calendar-HD-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "29_M365-Mailbox-Calendar-HD-Mac" "INFO" "ITSupport Phase12 M365"
...
section_banner "M365 HELPDESK CLOUD MAC"
...
export_html_report "shared mailbox missing outlook mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive