...
# ============================================================
# Script: mail-forwarding-user-confirm-mac.sh | ITSupport/29_M365-Mailbox-Calendar-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh mail-forwarding-user-confirm-mac.sh [user@domain.com]
...
export_html_report "mail forwarding user confirm mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive