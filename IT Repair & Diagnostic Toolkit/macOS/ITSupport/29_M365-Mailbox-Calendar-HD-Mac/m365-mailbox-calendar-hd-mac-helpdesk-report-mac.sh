...
# ============================================================
# Script: m365-mailbox-calendar-hd-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/29_M365-Mailbox-Calendar-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-mailbox-calendar-hd-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='29_M365-Mailbox-Calendar-HD-Mac'
...
add_report_row "Module" "29_M365-Mailbox-Calendar-HD-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "29_M365-Mailbox-Calendar-HD-Mac"
...
export_html_report "m365 mailbox calendar hd mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive