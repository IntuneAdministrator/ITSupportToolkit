...
# ============================================================
# Script: mailbox-full-quota-user-help-mac.sh | ITSupport/29_M365-Mailbox-Calendar-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh mailbox-full-quota-user-help-mac.sh [user@domain.com]
...
export_html_report "mailbox full quota user help mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive