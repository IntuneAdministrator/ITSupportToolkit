...
# ============================================================
# Script: m365-mailbox-calendar-hd-mac-policy-check-mac.sh | Phase 13 common problems | ITSupport/29_M365-Mailbox-Calendar-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-mailbox-calendar-hd-mac-policy-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 mailbox calendar hd mac policy check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive