...
# ============================================================
# Script: runbook-finder-spotlight-helpdesk-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh runbook-finder-spotlight-helpdesk-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='25_Finder-Spotlight-Helpdesk'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "25_Finder-Spotlight-Helpdesk"
...
export_html_report "runbook finder spotlight helpdesk mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive