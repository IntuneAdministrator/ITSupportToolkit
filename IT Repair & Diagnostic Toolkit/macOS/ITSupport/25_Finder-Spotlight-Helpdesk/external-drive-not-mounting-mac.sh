...
# ============================================================
# Script: external-drive-not-mounting-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh external-drive-not-mounting-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "external drive not mounting mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive