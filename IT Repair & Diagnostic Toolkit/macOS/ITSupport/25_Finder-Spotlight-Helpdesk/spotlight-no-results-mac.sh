...
# ============================================================
# Script: spotlight-no-results-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh spotlight-no-results-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "spotlight no results mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive