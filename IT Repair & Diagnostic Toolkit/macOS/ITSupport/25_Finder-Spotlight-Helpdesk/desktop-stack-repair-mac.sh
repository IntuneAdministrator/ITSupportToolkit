...
# ============================================================
# Script: desktop-stack-repair-mac.sh | ITSupport/25_Finder-Spotlight-Helpdesk | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh desktop-stack-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "desktop stack repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive