...
# ============================================================
# Script: disk-not-ejecting-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh disk-not-ejecting-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "disk not ejecting mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive