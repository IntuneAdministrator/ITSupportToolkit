...
# ============================================================
# Script: finder-prefs-reset-quick-mac.sh | ITSupport/25_Finder-Spotlight-Helpdesk | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh finder-prefs-reset-quick-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "finder prefs reset quick mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive