...
# ============================================================
# Script: finder-crash-loop-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh finder-crash-loop-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "finder crash loop mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive