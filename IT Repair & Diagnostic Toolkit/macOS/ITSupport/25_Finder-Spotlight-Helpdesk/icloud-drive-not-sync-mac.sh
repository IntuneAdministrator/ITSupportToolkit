...
# ============================================================
# Script: icloud-drive-not-sync-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh icloud-drive-not-sync-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "icloud drive not sync mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive