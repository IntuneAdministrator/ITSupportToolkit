...
# ============================================================
# Script: finder-spotlight-helpdesk-quick-audit-mac.sh | Phase 13 common problems | ITSupport/25_Finder-Spotlight-Helpdesk
# Requires: sudo | Usage: sudo zsh finder-spotlight-helpdesk-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "finder spotlight helpdesk quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive