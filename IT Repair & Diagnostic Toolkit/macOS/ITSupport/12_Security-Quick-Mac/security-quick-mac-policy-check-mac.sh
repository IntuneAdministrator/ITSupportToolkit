...
# ============================================================
# Script: security-quick-mac-policy-check-mac.sh | Phase 13 common problems | ITSupport/12_Security-Quick-Mac
# Requires: sudo | Usage: sudo zsh security-quick-mac-policy-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "security quick mac policy check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive