#!/bin/zsh
# ============================================================
# Script:      suspicious-login-quick-audit-mac.sh
# Description: macOS IT Support quick repair for suspicious login quick audit mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh suspicious-login-quick-audit-mac.sh
...
export_html_report "suspicious login quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive