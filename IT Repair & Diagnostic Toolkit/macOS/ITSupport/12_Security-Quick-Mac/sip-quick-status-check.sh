#!/bin/zsh
# ============================================================
# Script:      sip-quick-status-check.sh
# Description: macOS IT Support quick repair for sip quick status check.
...
# Requires:    sudo / root
# Usage:       sudo zsh sip-quick-status-check.sh
...
export_html_report "sip quick status check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive