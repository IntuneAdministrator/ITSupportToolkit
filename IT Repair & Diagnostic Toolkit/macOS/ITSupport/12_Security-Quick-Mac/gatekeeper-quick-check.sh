#!/bin/zsh
# ============================================================
# Script:      gatekeeper-quick-check.sh
# Description: macOS IT Support quick repair for gatekeeper quick check.
...
# Requires:    sudo / root
# Usage:       sudo zsh gatekeeper-quick-check.sh
...
export_html_report "gatekeeper quick check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive