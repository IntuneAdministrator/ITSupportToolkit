#!/bin/zsh
# ============================================================
# Script:      firewall-quick-enable-mac.sh
# Description: macOS IT Support quick repair for firewall quick enable mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh firewall-quick-enable-mac.sh
...
export_html_report "firewall quick enable mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive