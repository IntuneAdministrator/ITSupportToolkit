...
# ============================================================
# Script: security-quick-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/12_Security-Quick-Mac
# Requires: sudo | Usage: sudo zsh security-quick-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='12_Security-Quick-Mac'
...
add_report_row "Module" "12_Security-Quick-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "12_Security-Quick-Mac"
...
export_html_report "security quick mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive