#!/bin/zsh
# ============================================================
# Script:      filevault-quick-status.sh
# Description: macOS IT Support quick repair for filevault quick status.
...
# Requires:    sudo / root
# Usage:       sudo zsh filevault-quick-status.sh
...
export_html_report "filevault quick status" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive