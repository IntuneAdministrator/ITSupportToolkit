...
# ============================================================
# Script: serial-warranty-export-mac.sh | Role: ITSupport/14_Hardware-Inventory-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh serial-warranty-export-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "serial warranty export mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive