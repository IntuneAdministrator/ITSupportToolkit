...
# ============================================================
# Script: battery-cycle-report-mac.sh | Role: ITSupport/14_Hardware-Inventory-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh battery-cycle-report-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "battery cycle report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive