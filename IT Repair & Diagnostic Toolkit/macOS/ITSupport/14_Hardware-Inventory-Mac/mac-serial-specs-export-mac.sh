...
# ============================================================
# Script: mac-serial-specs-export-mac.sh | Phase 13 common problems | ITSupport/14_Hardware-Inventory-Mac
# Requires: sudo | Usage: sudo zsh mac-serial-specs-export-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mac serial specs export mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive