...
# ============================================================
# Script: hardware-inventory-mac-one-click-fix-mac.sh | Phase 13 common problems | ITSupport/14_Hardware-Inventory-Mac
# Requires: sudo | Usage: sudo zsh hardware-inventory-mac-one-click-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "hardware inventory mac one click fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive