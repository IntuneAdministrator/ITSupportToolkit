...
# ============================================================
# Script: teams-rooms-mac-log-pack.sh | Role: ITSupport/15_Collaboration-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh teams-rooms-mac-log-pack.sh
# ============================================================
set -euo pipefail
...
export_html_report "teams rooms mac log pack" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive