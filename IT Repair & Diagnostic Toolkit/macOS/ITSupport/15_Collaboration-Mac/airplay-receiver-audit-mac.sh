...
# ============================================================
# Script: airplay-receiver-audit-mac.sh | Role: ITSupport/15_Collaboration-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh airplay-receiver-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "airplay receiver audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive