...
# ============================================================
# Script: collaboration-mac-one-click-fix-mac.sh | Phase 13 common problems | ITSupport/15_Collaboration-Mac
# Requires: sudo | Usage: sudo zsh collaboration-mac-one-click-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "collaboration mac one click fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive