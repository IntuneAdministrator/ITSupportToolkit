...
# ============================================================
# Script: collaboration-mac-policy-check-mac.sh | Phase 13 common problems | ITSupport/15_Collaboration-Mac
# Requires: sudo | Usage: sudo zsh collaboration-mac-policy-check-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "collaboration mac policy check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive