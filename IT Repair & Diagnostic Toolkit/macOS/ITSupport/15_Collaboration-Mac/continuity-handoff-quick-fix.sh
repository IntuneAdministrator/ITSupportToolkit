...
# ============================================================
# Script: continuity-handoff-quick-fix.sh | Role: ITSupport/15_Collaboration-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh continuity-handoff-quick-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "continuity handoff quick fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive