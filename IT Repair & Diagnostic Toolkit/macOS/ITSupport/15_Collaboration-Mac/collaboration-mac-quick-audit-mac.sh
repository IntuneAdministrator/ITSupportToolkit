...
# ============================================================
# Script: collaboration-mac-quick-audit-mac.sh | Phase 13 common problems | ITSupport/15_Collaboration-Mac
# Requires: sudo | Usage: sudo zsh collaboration-mac-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "collaboration mac quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive