...
# ============================================================
# Script: collaboration-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/15_Collaboration-Mac
# Requires: sudo | Usage: sudo zsh collaboration-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "15_Collaboration-Mac"
...
export_html_report "collaboration mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive