...
# ============================================================
# Script: calendar-delegate-client-hints-mac.sh | Role: ITSupport/15_Collaboration-Mac | v1.1.0 expansion
# Requires: sudo | Usage: sudo zsh calendar-delegate-client-hints-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='15_Collaboration-Mac'
...
add_report_row "Module" "15_Collaboration-Mac" "INFO" "ITSupport"
...
export_html_report "calendar delegate client hints mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive