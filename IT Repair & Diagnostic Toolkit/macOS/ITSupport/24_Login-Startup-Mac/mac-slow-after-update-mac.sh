...
# ============================================================
# Script: mac-slow-after-update-mac.sh | Phase 13 common problems | ITSupport/24_Login-Startup-Mac
# Requires: sudo | Usage: sudo zsh mac-slow-after-update-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mac slow after update mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive