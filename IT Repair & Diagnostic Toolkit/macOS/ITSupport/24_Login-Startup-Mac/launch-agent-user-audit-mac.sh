...
# ============================================================
# Script: launch-agent-user-audit-mac.sh | ITSupport/24_Login-Startup-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh launch-agent-user-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "launch agent user audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive