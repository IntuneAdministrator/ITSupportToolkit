...
# ============================================================
# Script: login-keychain-password-mac.sh | Phase 13 common problems | ITSupport/24_Login-Startup-Mac
# Requires: sudo | Usage: sudo zsh login-keychain-password-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "login keychain password mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive