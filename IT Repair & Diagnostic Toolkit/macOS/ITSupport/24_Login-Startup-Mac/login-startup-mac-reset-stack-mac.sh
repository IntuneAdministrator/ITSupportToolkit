...
# ============================================================
# Script: login-startup-mac-reset-stack-mac.sh | Phase 13 common problems | ITSupport/24_Login-Startup-Mac
# Requires: sudo | Usage: sudo zsh login-startup-mac-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "login startup mac reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive