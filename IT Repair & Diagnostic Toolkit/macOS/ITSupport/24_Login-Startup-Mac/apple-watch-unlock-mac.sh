...
# ============================================================
# Script: apple-watch-unlock-mac.sh | Phase 13 common problems | ITSupport/24_Login-Startup-Mac
# Requires: sudo | Usage: sudo zsh apple-watch-unlock-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "apple watch unlock mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive