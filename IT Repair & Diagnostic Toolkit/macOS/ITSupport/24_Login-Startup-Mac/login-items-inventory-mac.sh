...
# ============================================================
# Script: login-items-inventory-mac.sh | ITSupport/24_Login-Startup-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh login-items-inventory-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "login items inventory mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive