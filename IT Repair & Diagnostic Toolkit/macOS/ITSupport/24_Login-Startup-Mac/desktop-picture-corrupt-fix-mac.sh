...
# ============================================================
# Script: desktop-picture-corrupt-fix-mac.sh | ITSupport/24_Login-Startup-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh desktop-picture-corrupt-fix-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='24_Login-Startup-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
export_html_report "desktop picture corrupt fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive