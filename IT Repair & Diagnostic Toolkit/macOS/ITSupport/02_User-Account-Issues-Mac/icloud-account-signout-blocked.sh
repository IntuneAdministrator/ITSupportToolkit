...
# ============================================================
# Script: icloud-account-signout-blocked.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh icloud-account-signout-blocked.sh
# ============================================================
set -euo pipefail
...
export_html_report "icloud account signout blocked" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive