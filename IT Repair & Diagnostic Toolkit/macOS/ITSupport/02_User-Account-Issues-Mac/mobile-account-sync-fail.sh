...
# ============================================================
# Script: mobile-account-sync-fail.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh mobile-account-sync-fail.sh
# ============================================================
set -euo pipefail
...
export_html_report "mobile account sync fail" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive