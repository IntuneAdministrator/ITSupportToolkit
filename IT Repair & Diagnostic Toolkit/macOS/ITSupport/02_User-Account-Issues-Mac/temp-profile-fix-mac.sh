#!/bin/zsh
# ============================================================
# Script:      temp-profile-fix-mac.sh
# Description: macOS IT Support quick repair for temp profile fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh temp-profile-fix-mac.sh
...
export_html_report "temp profile fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive