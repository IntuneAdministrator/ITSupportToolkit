...
# ============================================================
# Script: secure-token-missing-hint.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh secure-token-missing-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "secure token missing hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive