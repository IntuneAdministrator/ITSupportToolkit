#!/bin/zsh
# ============================================================
# Script:      login-loop-quick-fix-mac.sh
# Description: macOS IT Support quick repair for login loop quick fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh login-loop-quick-fix-mac.sh
...
export_html_report "login loop quick fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive