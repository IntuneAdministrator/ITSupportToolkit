#!/bin/zsh
# ============================================================
# Script:      sso-break-repair-mac.sh
# Description: macOS IT Support quick repair for sso break repair mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh sso-break-repair-mac.sh
...
export_html_report "sso break repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive