...
# ============================================================
# Script: sharing-only-user-issue.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh sharing-only-user-issue.sh
# ============================================================
set -euo pipefail
...
export_html_report "sharing only user issue" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive