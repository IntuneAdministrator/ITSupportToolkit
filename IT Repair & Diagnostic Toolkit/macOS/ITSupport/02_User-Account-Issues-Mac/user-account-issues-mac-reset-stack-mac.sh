...
# ============================================================
# Script: user-account-issues-mac-reset-stack-mac.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh user-account-issues-mac-reset-stack-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "user account issues mac reset stack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive