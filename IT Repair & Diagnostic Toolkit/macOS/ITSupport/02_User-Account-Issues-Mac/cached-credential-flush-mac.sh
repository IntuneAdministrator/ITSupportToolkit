#!/bin/zsh
# ============================================================
# Script:      cached-credential-flush-mac.sh
# Description: macOS IT Support quick repair for cached credential flush mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh cached-credential-flush-mac.sh
...
export_html_report "cached credential flush mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive