#!/bin/zsh
# ============================================================
# Script:      account-locked-unlock-mac.sh
# Description: macOS IT Support quick repair for account locked unlock mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh account-locked-unlock-mac.sh
...
export_html_report "account locked unlock mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive