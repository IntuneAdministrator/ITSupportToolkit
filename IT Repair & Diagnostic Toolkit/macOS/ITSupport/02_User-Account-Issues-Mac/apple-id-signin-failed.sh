...
# ============================================================
# Script: apple-id-signin-failed.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh apple-id-signin-failed.sh
# ============================================================
set -euo pipefail
...
export_html_report "apple id signin failed" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive