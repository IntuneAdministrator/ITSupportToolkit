...
# ============================================================
# Script: standard-user-needs-admin.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh standard-user-needs-admin.sh
# ============================================================
set -euo pipefail
...
export_html_report "standard user needs admin" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive