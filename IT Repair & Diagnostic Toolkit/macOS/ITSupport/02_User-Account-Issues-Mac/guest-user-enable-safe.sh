...
# ============================================================
# Script: guest-user-enable-safe.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh guest-user-enable-safe.sh
# ============================================================
set -euo pipefail
...
export_html_report "guest user enable safe" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive