...
# ============================================================
# Script: keychain-password-mismatch.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh keychain-password-mismatch.sh
# ============================================================
set -euo pipefail
...
export_html_report "keychain password mismatch" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive