...
# ============================================================
# Script: profile-corrupt-new-user.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh profile-corrupt-new-user.sh
# ============================================================
set -euo pipefail
...
export_html_report "profile corrupt new user" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive