#!/bin/zsh
# ============================================================
# Script:      mfa-token-reset-guide-mac.sh
# Description: macOS IT Support quick repair for mfa token reset guide mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh mfa-token-reset-guide-mac.sh
...
export_html_report "mfa token reset guide mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive