...
# ============================================================
# Script: admin-password-reset-hint.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh admin-password-reset-hint.sh
# ============================================================
set -euo pipefail
...
export_html_report "admin password reset hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive