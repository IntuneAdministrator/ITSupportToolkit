...
# ============================================================
# Script: local-account-cant-login.sh | Phase 13 common problems | ITSupport/02_User-Account-Issues-Mac
# Requires: sudo | Usage: sudo zsh local-account-cant-login.sh
# ============================================================
set -euo pipefail
...
export_html_report "local account cant login" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive