#!/bin/zsh
# ============================================================
# Script:      mac-password-reset-guide.sh
# Description: macOS IT Support quick repair for mac password reset guide.
...
# Requires:    sudo / root
# Usage:       sudo zsh mac-password-reset-guide.sh
...
export_html_report "mac password reset guide" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive