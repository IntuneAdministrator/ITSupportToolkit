...
# ============================================================
# Script: m365-license-identity-hd-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/28_M365-License-Identity-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-license-identity-hd-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='28_M365-License-Identity-HD-Mac'
...
add_report_row "Module" "28_M365-License-Identity-HD-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "28_M365-License-Identity-HD-Mac"
...
export_html_report "m365 license identity hd mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive