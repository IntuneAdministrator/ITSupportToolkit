...
# ============================================================
# Script: blocked-signin-account-check-mac.sh | ITSupport/28_M365-License-Identity-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh blocked-signin-account-check-mac.sh [user@domain.com]
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='28_M365-License-Identity-HD-Mac'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "28_M365-License-Identity-HD-Mac" "INFO" "ITSupport Phase12 M365"
...
export_html_report "blocked signin account check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive