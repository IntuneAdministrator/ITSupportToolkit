...
# ============================================================
# Script: mfa-methods-graph-quick-mac.sh | ITSupport/28_M365-License-Identity-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh mfa-methods-graph-quick-mac.sh [user@domain.com]
...
export_html_report "mfa methods graph quick mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive