...
# ============================================================
# Script: user-license-missing-triage-mac.sh | ITSupport/28_M365-License-Identity-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh user-license-missing-triage-mac.sh [user@domain.com]
...
export_html_report "user license missing triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive