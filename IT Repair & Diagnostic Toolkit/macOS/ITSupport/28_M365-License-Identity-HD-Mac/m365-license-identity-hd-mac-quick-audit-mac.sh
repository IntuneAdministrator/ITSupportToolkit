...
# ============================================================
# Script: m365-license-identity-hd-mac-quick-audit-mac.sh | Phase 13 common problems | ITSupport/28_M365-License-Identity-HD-Mac
# Requires: sudo | Usage: sudo zsh m365-license-identity-hd-mac-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "m365 license identity hd mac quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive