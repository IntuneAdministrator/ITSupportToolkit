...
# ============================================================
# Script: guest-user-invite-status-mac.sh | ITSupport/28_M365-License-Identity-HD-Mac | v1.4.0 Phase12 M365 cloud
# Usage: zsh guest-user-invite-status-mac.sh [user@domain.com]
...
export_html_report "guest user invite status mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive