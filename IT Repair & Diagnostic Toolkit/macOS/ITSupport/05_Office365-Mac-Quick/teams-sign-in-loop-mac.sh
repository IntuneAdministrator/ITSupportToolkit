...
# ============================================================
# Script: teams-sign-in-loop-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh teams-sign-in-loop-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "teams sign in loop mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive