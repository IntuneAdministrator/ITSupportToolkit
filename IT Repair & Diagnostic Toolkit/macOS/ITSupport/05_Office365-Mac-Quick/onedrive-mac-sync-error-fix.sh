#!/bin/zsh
# ============================================================
# Script:      onedrive-mac-sync-error-fix.sh
# Description: macOS IT Support quick repair for onedrive mac sync error fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh onedrive-mac-sync-error-fix.sh
...
export_html_report "onedrive mac sync error fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive