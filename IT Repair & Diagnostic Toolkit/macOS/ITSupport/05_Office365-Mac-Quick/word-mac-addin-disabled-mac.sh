...
# ============================================================
# Script: word-mac-addin-disabled-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh word-mac-addin-disabled-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "word mac addin disabled mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive