...
# ============================================================
# Script: office365-mac-quick-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh office365-mac-quick-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='05_Office365-Mac-Quick'
...
add_report_row "Module" "05_Office365-Mac-Quick" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "05_Office365-Mac-Quick"
...
export_html_report "office365 mac quick helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive