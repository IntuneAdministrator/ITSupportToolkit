#!/bin/zsh
# ============================================================
# Script:      office-mac-wont-open.sh
# Description: macOS IT Support quick repair for office mac wont open.
...
# Requires:    sudo / root
# Usage:       sudo zsh office-mac-wont-open.sh
...
export_html_report "office mac wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive