#!/bin/zsh
# ============================================================
# Script:      outlook-mac-freezing-fix.sh
# Description: macOS IT Support quick repair for outlook mac freezing fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh outlook-mac-freezing-fix.sh
...
export_html_report "outlook mac freezing fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive