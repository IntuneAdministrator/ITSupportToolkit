#!/bin/zsh
# ============================================================
# Script:      teams-mac-wont-open-fix.sh
# Description: macOS IT Support quick repair for teams mac wont open fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh teams-mac-wont-open-fix.sh
...
export_html_report "teams mac wont open fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive