...
# ============================================================
# Script: teams-notifications-missing-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh teams-notifications-missing-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "teams notifications missing mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive