#!/bin/zsh
# ============================================================
# Script:      m365-mac-license-quick-check.sh
# Description: macOS IT Support quick repair for m365 mac license quick check.
...
# Requires:    sudo / root
# Usage:       sudo zsh m365-mac-license-quick-check.sh
...
export_html_report "m365 mac license quick check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive