#!/bin/zsh
# ============================================================
# Script:      copilot-mac-not-loading-fix.sh
# Description: macOS IT Support quick repair for copilot mac not loading fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh copilot-mac-not-loading-fix.sh
...
export_html_report "copilot mac not loading fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive