#!/bin/zsh
# ============================================================
# Script:      shared-calendar-not-syncing-mac.sh
# Description: macOS IT Support quick repair for shared calendar not syncing mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh shared-calendar-not-syncing-mac.sh
...
export_html_report "shared calendar not syncing mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive