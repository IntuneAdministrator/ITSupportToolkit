...
# ============================================================
# Script: powerpoint-media-fail-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh powerpoint-media-fail-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "powerpoint media fail mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive