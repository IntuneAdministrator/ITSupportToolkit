...
# ============================================================
# Script: outlook-not-receiving-mail-mac.sh | Phase 13 common problems | ITSupport/05_Office365-Mac-Quick
# Requires: sudo | Usage: sudo zsh outlook-not-receiving-mail-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "outlook not receiving mail mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive