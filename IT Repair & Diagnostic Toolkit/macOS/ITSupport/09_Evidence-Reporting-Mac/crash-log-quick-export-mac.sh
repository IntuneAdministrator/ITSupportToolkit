#!/bin/zsh
# ============================================================
# Script:      crash-log-quick-export-mac.sh
# Description: macOS IT Support quick repair for crash log quick export mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh crash-log-quick-export-mac.sh
...
export_html_report "crash log quick export mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive