#!/bin/zsh
# ============================================================
# Script:      ticket-evidence-mac.sh
# Description: macOS IT Support quick repair for ticket evidence mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh ticket-evidence-mac.sh
...
export_html_report "ticket evidence mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive