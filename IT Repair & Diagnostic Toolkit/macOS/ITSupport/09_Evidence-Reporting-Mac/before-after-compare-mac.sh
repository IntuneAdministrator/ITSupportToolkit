#!/bin/zsh
# ============================================================
# Script:      before-after-compare-mac.sh
# Description: macOS IT Support quick repair for before after compare mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh before-after-compare-mac.sh
...
export_html_report "before after compare mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive