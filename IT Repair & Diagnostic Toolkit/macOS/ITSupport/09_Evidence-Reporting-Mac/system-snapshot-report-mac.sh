#!/bin/zsh
# ============================================================
# Script:      system-snapshot-report-mac.sh
# Description: macOS IT Support quick repair for system snapshot report mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh system-snapshot-report-mac.sh
...
export_html_report "system snapshot report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive