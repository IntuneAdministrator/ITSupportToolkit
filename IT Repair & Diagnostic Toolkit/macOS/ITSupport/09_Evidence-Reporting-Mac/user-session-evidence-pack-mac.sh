#!/bin/zsh
# ============================================================
# Script:      user-session-evidence-pack-mac.sh
# Description: macOS IT Support quick repair for user session evidence pack mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh user-session-evidence-pack-mac.sh
...
export_html_report "user session evidence pack mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive