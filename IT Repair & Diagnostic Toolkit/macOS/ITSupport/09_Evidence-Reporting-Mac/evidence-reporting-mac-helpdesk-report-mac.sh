...
# ============================================================
# Script: evidence-reporting-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/09_Evidence-Reporting-Mac
# Requires: sudo | Usage: sudo zsh evidence-reporting-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='09_Evidence-Reporting-Mac'
...
add_report_row "Module" "09_Evidence-Reporting-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "09_Evidence-Reporting-Mac"
...
export_html_report "evidence reporting mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive