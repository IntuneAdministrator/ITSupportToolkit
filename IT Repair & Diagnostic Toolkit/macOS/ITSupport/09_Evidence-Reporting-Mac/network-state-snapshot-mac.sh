#!/bin/zsh
# ============================================================
# Script:      network-state-snapshot-mac.sh
# Description: macOS IT Support quick repair for network state snapshot mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh network-state-snapshot-mac.sh
...
export_html_report "network state snapshot mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive