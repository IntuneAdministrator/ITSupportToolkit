...
# ============================================================
# Script: evidence-reporting-mac-user-triage-mac.sh | Phase 13 common problems | ITSupport/09_Evidence-Reporting-Mac
# Requires: sudo | Usage: sudo zsh evidence-reporting-mac-user-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "evidence reporting mac user triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive