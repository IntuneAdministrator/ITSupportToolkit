...
# ============================================================
# Script: printer-permissions-mac.sh | Phase 13 common problems | ITSupport/06_Printer-Issues-Mac
# Requires: sudo | Usage: sudo zsh printer-permissions-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "printer permissions mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive