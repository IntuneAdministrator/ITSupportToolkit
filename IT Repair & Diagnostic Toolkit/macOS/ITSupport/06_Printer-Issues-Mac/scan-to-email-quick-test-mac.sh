#!/bin/zsh
# ============================================================
# Script:      scan-to-email-quick-test-mac.sh
# Description: macOS IT Support quick repair for scan to email quick test mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh scan-to-email-quick-test-mac.sh
...
export_html_report "scan to email quick test mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive