...
# ============================================================
# Script: default-printer-resets-mac.sh | Phase 13 common problems | ITSupport/06_Printer-Issues-Mac
# Requires: sudo | Usage: sudo zsh default-printer-resets-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "default printer resets mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive