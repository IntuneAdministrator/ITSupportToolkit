#!/bin/zsh
# ============================================================
# Script:      print-queue-emergency-clear-mac.sh
# Description: macOS IT Support quick repair for print queue emergency clear mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh print-queue-emergency-clear-mac.sh
...
export_html_report "print queue emergency clear mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive