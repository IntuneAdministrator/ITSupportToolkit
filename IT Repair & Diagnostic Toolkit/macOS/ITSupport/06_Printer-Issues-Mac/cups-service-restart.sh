#!/bin/zsh
# ============================================================
# Script:      cups-service-restart.sh
# Description: macOS IT Support quick repair for cups service restart.
...
# Requires:    sudo / root
# Usage:       sudo zsh cups-service-restart.sh
...
export_html_report "cups service restart" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive