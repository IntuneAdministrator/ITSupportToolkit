#!/bin/zsh
# ============================================================
# Script:      printer-not-found-fix-mac.sh
# Description: macOS IT Support quick repair for printer not found fix mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh printer-not-found-fix-mac.sh
...
export_html_report "printer not found fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive