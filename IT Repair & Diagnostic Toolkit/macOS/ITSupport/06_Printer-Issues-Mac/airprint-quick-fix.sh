#!/bin/zsh
# ============================================================
# Script:      airprint-quick-fix.sh
# Description: macOS IT Support quick repair for airprint quick fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh airprint-quick-fix.sh
...
export_html_report "airprint quick fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive