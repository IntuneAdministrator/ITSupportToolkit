...
# ============================================================
# Script: chrome-mac-wont-open.sh | ITSupport/17_Browser-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh chrome-mac-wont-open.sh
# ============================================================
set -euo pipefail
...
export_html_report "chrome mac wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive