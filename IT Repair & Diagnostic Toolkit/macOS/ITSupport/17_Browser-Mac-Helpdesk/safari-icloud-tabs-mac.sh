...
# ============================================================
# Script: safari-icloud-tabs-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh safari-icloud-tabs-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "safari icloud tabs mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive