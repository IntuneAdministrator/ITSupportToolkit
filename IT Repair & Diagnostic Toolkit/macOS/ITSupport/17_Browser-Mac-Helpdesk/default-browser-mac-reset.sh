...
# ============================================================
# Script: default-browser-mac-reset.sh | ITSupport/17_Browser-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh default-browser-mac-reset.sh
# ============================================================
set -euo pipefail
...
export_html_report "default browser mac reset" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive