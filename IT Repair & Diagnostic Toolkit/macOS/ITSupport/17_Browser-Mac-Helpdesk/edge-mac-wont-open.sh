...
# ============================================================
# Script: edge-mac-wont-open.sh | ITSupport/17_Browser-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh edge-mac-wont-open.sh
# ============================================================
set -euo pipefail
...
export_html_report "edge mac wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive