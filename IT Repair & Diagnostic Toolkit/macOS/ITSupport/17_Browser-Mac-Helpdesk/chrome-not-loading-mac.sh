...
# ============================================================
# Script: chrome-not-loading-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh chrome-not-loading-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "chrome not loading mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive