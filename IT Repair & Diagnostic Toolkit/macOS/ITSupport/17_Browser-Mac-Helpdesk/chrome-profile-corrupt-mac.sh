...
# ============================================================
# Script: chrome-profile-corrupt-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh chrome-profile-corrupt-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "chrome profile corrupt mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive