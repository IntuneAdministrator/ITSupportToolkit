...
# ============================================================
# Script: browser-mac-helpdesk-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh browser-mac-helpdesk-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='17_Browser-Mac-Helpdesk'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "17_Browser-Mac-Helpdesk"
...
export_html_report "browser mac helpdesk helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive