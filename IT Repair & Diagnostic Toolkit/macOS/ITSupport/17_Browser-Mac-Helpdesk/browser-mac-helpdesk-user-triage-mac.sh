...
# ============================================================
# Script: browser-mac-helpdesk-user-triage-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh browser-mac-helpdesk-user-triage-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "browser mac helpdesk user triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive