...
# ============================================================
# Script: icloud-passwords-sync-hint.sh | ITSupport/17_Browser-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh icloud-passwords-sync-hint.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='17_Browser-Mac-Helpdesk'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "17_Browser-Mac-Helpdesk" "INFO" "ITSupport"
...
export_html_report "icloud passwords sync hint" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive