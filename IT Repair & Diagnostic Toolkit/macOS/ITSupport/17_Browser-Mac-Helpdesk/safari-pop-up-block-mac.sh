...
# ============================================================
# Script: safari-pop-up-block-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh safari-pop-up-block-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "safari pop up block mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive