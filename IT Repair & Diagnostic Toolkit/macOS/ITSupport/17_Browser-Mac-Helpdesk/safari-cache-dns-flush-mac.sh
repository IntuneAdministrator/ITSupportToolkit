...
# ============================================================
# Script: safari-cache-dns-flush-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh safari-cache-dns-flush-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "safari cache dns flush mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive