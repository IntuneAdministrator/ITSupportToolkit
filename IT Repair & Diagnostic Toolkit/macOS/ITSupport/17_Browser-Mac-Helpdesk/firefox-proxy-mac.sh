...
# ============================================================
# Script: firefox-proxy-mac.sh | Phase 13 common problems | ITSupport/17_Browser-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh firefox-proxy-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "firefox proxy mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive