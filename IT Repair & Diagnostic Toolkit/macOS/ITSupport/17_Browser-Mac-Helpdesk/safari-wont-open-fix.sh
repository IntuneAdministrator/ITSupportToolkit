...
# ============================================================
# Script: safari-wont-open-fix.sh | ITSupport/17_Browser-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh safari-wont-open-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "safari wont open fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive