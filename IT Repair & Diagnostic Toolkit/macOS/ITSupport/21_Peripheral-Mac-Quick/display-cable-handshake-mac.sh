...
# ============================================================
# Script: display-cable-handshake-mac.sh | ITSupport/21_Peripheral-Mac-Quick | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh display-cable-handshake-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "display cable handshake mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive