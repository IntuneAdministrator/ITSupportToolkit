...
# ============================================================
# Script: peripheral-mac-quick-quick-repair-mac.sh | Phase 13 common problems | ITSupport/21_Peripheral-Mac-Quick
# Requires: sudo | Usage: sudo zsh peripheral-mac-quick-quick-repair-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "peripheral mac quick quick repair mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive