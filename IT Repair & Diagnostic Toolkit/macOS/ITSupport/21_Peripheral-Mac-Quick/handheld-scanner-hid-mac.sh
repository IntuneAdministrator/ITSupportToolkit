...
# ============================================================
# Script: handheld-scanner-hid-mac.sh | Phase 13 common problems | ITSupport/21_Peripheral-Mac-Quick
# Requires: sudo | Usage: sudo zsh handheld-scanner-hid-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "handheld scanner hid mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive