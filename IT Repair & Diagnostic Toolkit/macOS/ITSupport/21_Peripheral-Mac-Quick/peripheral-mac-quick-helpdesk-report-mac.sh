...
# ============================================================
# Script: peripheral-mac-quick-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/21_Peripheral-Mac-Quick
# Requires: sudo | Usage: sudo zsh peripheral-mac-quick-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='21_Peripheral-Mac-Quick'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "21_Peripheral-Mac-Quick"
...
export_html_report "peripheral mac quick helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive