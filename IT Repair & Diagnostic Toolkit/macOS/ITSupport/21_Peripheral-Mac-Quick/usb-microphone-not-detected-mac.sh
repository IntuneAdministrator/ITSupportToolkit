...
# ============================================================
# Script: usb-microphone-not-detected-mac.sh | Phase 13 common problems | ITSupport/21_Peripheral-Mac-Quick
# Requires: sudo | Usage: sudo zsh usb-microphone-not-detected-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "usb microphone not detected mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive