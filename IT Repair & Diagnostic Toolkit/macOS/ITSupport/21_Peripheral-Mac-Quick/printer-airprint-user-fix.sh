...
# ============================================================
# Script: printer-airprint-user-fix.sh | ITSupport/21_Peripheral-Mac-Quick | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh printer-airprint-user-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "printer airprint user fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive