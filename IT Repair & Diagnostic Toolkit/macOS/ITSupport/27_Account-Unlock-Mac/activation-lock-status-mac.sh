...
# ============================================================
# Script: activation-lock-status-mac.sh | ITSupport/27_Account-Unlock-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh activation-lock-status-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "activation lock status mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive