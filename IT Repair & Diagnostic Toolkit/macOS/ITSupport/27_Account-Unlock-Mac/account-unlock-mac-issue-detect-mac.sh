...
# ============================================================
# Script: account-unlock-mac-issue-detect-mac.sh | Phase 13 common problems | ITSupport/27_Account-Unlock-Mac
# Requires: sudo | Usage: sudo zsh account-unlock-mac-issue-detect-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "account unlock mac issue detect mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive