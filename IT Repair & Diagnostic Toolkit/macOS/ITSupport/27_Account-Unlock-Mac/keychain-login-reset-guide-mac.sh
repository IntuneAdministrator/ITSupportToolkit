...
# ============================================================
# Script: keychain-login-reset-guide-mac.sh | ITSupport/27_Account-Unlock-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh keychain-login-reset-guide-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "keychain login reset guide mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive