...
# ============================================================
# Script: account-unlock-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/27_Account-Unlock-Mac
# Requires: sudo | Usage: sudo zsh account-unlock-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='27_Account-Unlock-Mac'
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "27_Account-Unlock-Mac"
...
export_html_report "account unlock mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive