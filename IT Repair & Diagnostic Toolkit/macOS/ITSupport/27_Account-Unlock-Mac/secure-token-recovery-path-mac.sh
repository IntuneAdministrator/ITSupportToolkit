...
# ============================================================
# Script: secure-token-recovery-path-mac.sh | ITSupport/27_Account-Unlock-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh secure-token-recovery-path-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "secure token recovery path mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive