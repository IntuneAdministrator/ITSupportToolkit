...
# ============================================================
# Script: local-account-unlock-hint-mac.sh | ITSupport/27_Account-Unlock-Mac | v1.3.0 Phase11
# Requires: sudo | Usage: sudo zsh local-account-unlock-hint-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "local account unlock hint mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive