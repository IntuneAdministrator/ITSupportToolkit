...
# ============================================================
# Script: app-store-wont-open.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh app-store-wont-open.sh
# ============================================================
set -euo pipefail
...
export_html_report "app store wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive