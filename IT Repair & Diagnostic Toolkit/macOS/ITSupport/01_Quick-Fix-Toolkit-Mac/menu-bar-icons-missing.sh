...
# ============================================================
# Script: menu-bar-icons-missing.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh menu-bar-icons-missing.sh
# ============================================================
set -euo pipefail
...
export_html_report "menu bar icons missing" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive