...
# ============================================================
# Script: app-not-responding-force-quit.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh app-not-responding-force-quit.sh
# ============================================================
set -euo pipefail
...
export_html_report "app not responding force quit" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive