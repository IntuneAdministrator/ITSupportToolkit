...
# ============================================================
# Script: spaces-not-switching.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh spaces-not-switching.sh
# ============================================================
set -euo pipefail
...
export_html_report "spaces not switching" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive