...
# ============================================================
# Script: date-format-wrong.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh date-format-wrong.sh
# ============================================================
set -euo pipefail
...
export_html_report "date format wrong" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive