#!/bin/zsh
# ============================================================
# Script:      one-click-common-repairs-mac.sh
# Description: macOS IT Support quick repair for one click common repairs mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh one-click-common-repairs-mac.sh
...
export_html_report "one click common repairs mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive