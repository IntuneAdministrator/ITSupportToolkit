...
# ============================================================
# Script: system-preferences-wont-open.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh system-preferences-wont-open.sh
# ============================================================
set -euo pipefail
...
export_html_report "system preferences wont open" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive