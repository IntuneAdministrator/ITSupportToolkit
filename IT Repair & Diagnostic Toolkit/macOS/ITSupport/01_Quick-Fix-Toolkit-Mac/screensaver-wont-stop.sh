...
# ============================================================
# Script: screensaver-wont-stop.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh screensaver-wont-stop.sh
# ============================================================
set -euo pipefail
...
export_html_report "screensaver wont stop" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive