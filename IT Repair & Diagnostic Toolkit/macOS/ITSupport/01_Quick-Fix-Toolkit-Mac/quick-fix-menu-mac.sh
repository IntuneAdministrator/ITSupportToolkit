#!/bin/zsh
# ============================================================
# Script:      quick-fix-menu-mac.sh
# Description: macOS IT Support quick repair for quick fix menu mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh quick-fix-menu-mac.sh
...
export_html_report "quick fix menu mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive