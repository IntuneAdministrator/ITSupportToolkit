...
# ============================================================
# Script: runbook-slow-mac-standard-fix-mac.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh runbook-slow-mac-standard-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "runbook slow mac standard fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive