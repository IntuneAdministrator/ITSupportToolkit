...
# ============================================================
# Script: time-wrong-timezone.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh time-wrong-timezone.sh
# ============================================================
set -euo pipefail
...
export_html_report "time wrong timezone" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive