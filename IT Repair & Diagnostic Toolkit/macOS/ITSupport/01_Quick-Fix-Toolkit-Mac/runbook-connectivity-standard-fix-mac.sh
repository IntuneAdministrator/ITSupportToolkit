...
# ============================================================
# Script: runbook-connectivity-standard-fix-mac.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh runbook-connectivity-standard-fix-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='01_Quick-Fix-Toolkit-Mac'
...
add_report_row "Module" "01_Quick-Fix-Toolkit-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "01_Quick-Fix-Toolkit-Mac"
...
export_html_report "runbook connectivity standard fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive