#!/bin/zsh
# ============================================================
# Script:      escalation-readiness-check-mac.sh
# Description: macOS IT Support quick repair for escalation readiness check mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh escalation-readiness-check-mac.sh
...
export_html_report "escalation readiness check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive