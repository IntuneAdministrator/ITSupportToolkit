...
# ============================================================
# Script: software-update-stuck.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh software-update-stuck.sh
# ============================================================
set -euo pipefail
...
export_html_report "software update stuck" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive