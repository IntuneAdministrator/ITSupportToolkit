...
# ============================================================
# Script: quick-fix-toolkit-mac-quick-audit-mac.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh quick-fix-toolkit-mac-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "quick fix toolkit mac quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive