...
# ============================================================
# Script: mission-control-not-working.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh mission-control-not-working.sh
# ============================================================
set -euo pipefail
...
export_html_report "mission control not working" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive