...
# ============================================================
# Script: spinning-beachball-triage.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh spinning-beachball-triage.sh
# ============================================================
set -euo pipefail
...
export_html_report "spinning beachball triage" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive