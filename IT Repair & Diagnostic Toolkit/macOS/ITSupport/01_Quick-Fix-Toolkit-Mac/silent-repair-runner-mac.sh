#!/bin/zsh
# ============================================================
# Script:      silent-repair-runner-mac.sh
# Description: macOS IT Support quick repair for silent repair runner mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh silent-repair-runner-mac.sh
...
export_html_report "silent repair runner mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive