#!/bin/zsh
# ============================================================
# Script:      mac-health-report.sh
# Description: macOS IT Support quick repair for mac health report.
...
# Requires:    sudo / root
# Usage:       sudo zsh mac-health-report.sh
...
export_html_report "mac health report" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive