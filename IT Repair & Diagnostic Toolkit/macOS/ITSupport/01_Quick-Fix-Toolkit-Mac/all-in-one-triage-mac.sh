#!/bin/zsh
# ============================================================
# Script:      all-in-one-triage-mac.sh
# Description: macOS IT Support quick repair for all in one triage mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh all-in-one-triage-mac.sh
...
export_html_report "all in one triage mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive