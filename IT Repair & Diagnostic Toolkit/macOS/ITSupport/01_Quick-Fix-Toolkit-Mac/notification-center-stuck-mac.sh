...
# ============================================================
# Script: notification-center-stuck-mac.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh notification-center-stuck-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "notification center stuck mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive