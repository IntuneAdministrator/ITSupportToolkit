...
# ============================================================
# Script: screenshot-shortcut-not-working-mac.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh screenshot-shortcut-not-working-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "screenshot shortcut not working mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive