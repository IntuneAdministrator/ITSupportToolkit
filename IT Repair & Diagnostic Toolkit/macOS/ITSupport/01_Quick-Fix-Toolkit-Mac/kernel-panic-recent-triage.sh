...
# ============================================================
# Script: kernel-panic-recent-triage.sh | Phase 13 common problems | ITSupport/01_Quick-Fix-Toolkit-Mac
# Requires: sudo | Usage: sudo zsh kernel-panic-recent-triage.sh
# ============================================================
set -euo pipefail
...
export_html_report "kernel panic recent triage" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive