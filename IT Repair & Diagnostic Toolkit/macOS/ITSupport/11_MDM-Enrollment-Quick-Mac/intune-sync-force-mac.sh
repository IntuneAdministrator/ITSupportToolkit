#!/bin/zsh
# ============================================================
# Script:      intune-sync-force-mac.sh
# Description: macOS IT Support quick repair for intune sync force mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh intune-sync-force-mac.sh
...
export_html_report "intune sync force mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive