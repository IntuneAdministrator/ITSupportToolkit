#!/bin/zsh
# ============================================================
# Script:      jamf-checkin-force.sh
# Description: macOS IT Support quick repair for jamf checkin force.
...
# Requires:    sudo / root
# Usage:       sudo zsh jamf-checkin-force.sh
...
export_html_report "jamf checkin force" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive