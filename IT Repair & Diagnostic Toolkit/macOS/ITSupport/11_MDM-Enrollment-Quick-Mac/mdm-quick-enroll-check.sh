#!/bin/zsh
# ============================================================
# Script:      mdm-quick-enroll-check.sh
# Description: macOS IT Support quick repair for mdm quick enroll check.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-quick-enroll-check.sh
...
export_html_report "mdm quick enroll check" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive