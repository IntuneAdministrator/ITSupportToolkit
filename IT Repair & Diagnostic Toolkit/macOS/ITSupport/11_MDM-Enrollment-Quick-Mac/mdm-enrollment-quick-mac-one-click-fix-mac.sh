...
# ============================================================
# Script: mdm-enrollment-quick-mac-one-click-fix-mac.sh | Phase 13 common problems | ITSupport/11_MDM-Enrollment-Quick-Mac
# Requires: sudo | Usage: sudo zsh mdm-enrollment-quick-mac-one-click-fix-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "mdm enrollment quick mac one click fix mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive