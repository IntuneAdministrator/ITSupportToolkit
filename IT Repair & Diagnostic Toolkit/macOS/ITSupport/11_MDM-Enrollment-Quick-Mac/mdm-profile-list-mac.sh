#!/bin/zsh
# ============================================================
# Script:      mdm-profile-list-mac.sh
# Description: macOS IT Support quick repair for mdm profile list mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-profile-list-mac.sh
...
export_html_report "mdm profile list mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive