#!/bin/zsh
# ============================================================
# Script:      ade-re-enroll-quick.sh
# Description: macOS IT Support quick repair for ade re enroll quick.
...
# Requires:    sudo / root
# Usage:       sudo zsh ade-re-enroll-quick.sh
...
export_html_report "ade re enroll quick" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive