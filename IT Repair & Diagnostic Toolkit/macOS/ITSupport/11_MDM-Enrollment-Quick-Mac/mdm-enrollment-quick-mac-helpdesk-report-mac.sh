...
# ============================================================
# Script: mdm-enrollment-quick-mac-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/11_MDM-Enrollment-Quick-Mac
# Requires: sudo | Usage: sudo zsh mdm-enrollment-quick-mac-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='11_MDM-Enrollment-Quick-Mac'
...
add_report_row "Module" "11_MDM-Enrollment-Quick-Mac" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "11_MDM-Enrollment-Quick-Mac"
...
export_html_report "mdm enrollment quick mac helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive