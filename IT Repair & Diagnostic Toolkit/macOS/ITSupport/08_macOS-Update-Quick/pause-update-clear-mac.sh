#!/bin/zsh
# ============================================================
# Script:      pause-update-clear-mac.sh
# Description: macOS IT Support quick repair for pause update clear mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh pause-update-clear-mac.sh
...
export_html_report "pause update clear mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive