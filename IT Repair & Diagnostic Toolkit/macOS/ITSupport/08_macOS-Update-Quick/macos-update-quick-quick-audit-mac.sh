...
# ============================================================
# Script: macos-update-quick-quick-audit-mac.sh | Phase 13 common problems | ITSupport/08_macOS-Update-Quick
# Requires: sudo | Usage: sudo zsh macos-update-quick-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "macos update quick quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive