...
# ============================================================
# Script: macos-update-quick-helpdesk-report-mac.sh | Phase 13 common problems | ITSupport/08_macOS-Update-Quick
# Requires: sudo | Usage: sudo zsh macos-update-quick-helpdesk-report-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='08_macOS-Update-Quick'
...
add_report_row "Module" "08_macOS-Update-Quick" "INFO" "ITSupport"
...
add_report_row "Script" "$SCRIPT_BASE" "INFO" "08_macOS-Update-Quick"
...
export_html_report "macos update quick helpdesk report mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive