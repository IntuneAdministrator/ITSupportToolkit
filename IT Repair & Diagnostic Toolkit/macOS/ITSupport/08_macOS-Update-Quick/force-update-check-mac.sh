#!/bin/zsh
# ============================================================
# Script:      force-update-check-mac.sh
# Description: macOS IT Support quick repair for force update check mac.
...
# Requires:    sudo / root
# Usage:       sudo zsh force-update-check-mac.sh
...
export_html_report "force update check mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive