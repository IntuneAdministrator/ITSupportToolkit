...
# ============================================================
# Script: update-install-stuck-mac.sh | Phase 13 common problems | ITSupport/08_macOS-Update-Quick
# Requires: sudo | Usage: sudo zsh update-install-stuck-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "update install stuck mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive