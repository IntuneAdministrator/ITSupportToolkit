#!/bin/zsh
# ============================================================
# Script:      mdm-update-override-quick.sh
# Description: macOS IT Support quick repair for mdm update override quick.
...
# Requires:    sudo / root
# Usage:       sudo zsh mdm-update-override-quick.sh
...
export_html_report "mdm update override quick" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive