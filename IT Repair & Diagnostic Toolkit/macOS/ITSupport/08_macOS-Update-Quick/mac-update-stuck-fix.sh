#!/bin/zsh
# ============================================================
# Script:      mac-update-stuck-fix.sh
# Description: macOS IT Support quick repair for mac update stuck fix.
...
# Requires:    sudo / root
# Usage:       sudo zsh mac-update-stuck-fix.sh
...
export_html_report "mac update stuck fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive