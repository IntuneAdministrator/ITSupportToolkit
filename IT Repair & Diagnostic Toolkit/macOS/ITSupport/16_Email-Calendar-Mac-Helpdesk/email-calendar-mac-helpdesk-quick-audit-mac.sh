...
# ============================================================
# Script: email-calendar-mac-helpdesk-quick-audit-mac.sh | Phase 13 common problems | ITSupport/16_Email-Calendar-Mac-Helpdesk
# Requires: sudo | Usage: sudo zsh email-calendar-mac-helpdesk-quick-audit-mac.sh
# ============================================================
set -euo pipefail
...
export_html_report "email calendar mac helpdesk quick audit mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive