...
# ============================================================
# Script: outlook-mac-meeting-fix.sh | ITSupport/16_Email-Calendar-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh outlook-mac-meeting-fix.sh
# ============================================================
set -euo pipefail
...
export_html_report "outlook mac meeting fix" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive