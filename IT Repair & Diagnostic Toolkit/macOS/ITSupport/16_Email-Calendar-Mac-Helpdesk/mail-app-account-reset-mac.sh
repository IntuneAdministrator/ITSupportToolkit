...
# ============================================================
# Script: mail-app-account-reset-mac.sh | ITSupport/16_Email-Calendar-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh mail-app-account-reset-mac.sh
# ============================================================
set -euo pipefail
...
SCRIPT_BASE=$(basename "$0" .sh); FOLDER_NAME='16_Email-Calendar-Mac-Helpdesk'; TIMESTAMP=$(date +%Y%m%d_%H%M%S)
...
add_report_row "Module" "16_Email-Calendar-Mac-Helpdesk" "INFO" "ITSupport"
section_banner "ITSUPPORT MAC PHASE10"
...
export_html_report "mail app account reset mac" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive