...
# ============================================================
# Script: focus-mac-dnd-conflict.sh | ITSupport/16_Email-Calendar-Mac-Helpdesk | v1.2.0 Phase10
# Requires: sudo | Usage: sudo zsh focus-mac-dnd-conflict.sh
# ============================================================
set -euo pipefail
...
export_html_report "focus mac dnd conflict" "$COMPUTER_NAME" "$JOIN_STATE"
print_completion_summary
open_report_if_interactive